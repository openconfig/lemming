...
type PacketInjectRequest struct {
	...
	PortId       *PortId             `protobuf:"bytes,1,opt,name=port_id,json=portId" json:"port_id,omitempty"`                                                       // Port used to process the packet
	ContextId    *ContextId          `protobuf:"bytes,2,opt,name=context_id,json=contextId" json:"context_id,omitempty"`                                              // Context containing the port
	Bytes        []byte              `protobuf:"bytes,3,opt,name=bytes" json:"bytes,omitempty"`                                                                       // Bytes in the L2 frame
	Action       *PortAction         `protobuf:"varint,4,opt,name=action,enum=forwarding.PortAction" json:"action,omitempty"`                                         // Select a set of actions on the port
	Preprocess   []*ActionDesc       `protobuf:"bytes,7,rep,name=preprocess" json:"preprocess,omitempty"`                                                             // Actions used to preprocess the packet
	Ingress      *PortId             `protobuf:"bytes,8,opt,name=ingress" json:"ingress,omitempty"`                                                                   // Identifies the ingress of the packet
	Egress       *PortId             `protobuf:"bytes,9,opt,name=egress" json:"egress,omitempty"`                                                                     // Identifies the egress of the packet
	StartHeader  *PacketHeaderId     `protobuf:"varint,10,opt,name=start_header,json=startHeader,enum=forwarding.PacketHeaderId,def=3" json:"start_header,omitempty"` // Start header of the frame
	ParsedFields []*PacketFieldBytes `protobuf:"bytes,11,rep,name=parsed_fields,json=parsedFields" json:"parsed_fields,omitempty"`                                    // List of fields describing the L2 frame
	Debug        *bool               `protobuf:"varint,12,opt,name=debug,def=0" json:"debug,omitempty"`                                                               // Whether to turn on debug messages.
}

// Default values for PacketInjectRequest fields.
const (
	Default_PacketInjectRequest_StartHeader = PacketHeaderId_ETHERNET
	Default_PacketInjectRequest_Debug       = bool(false)
)
...
func (x *PacketInjectRequest) GetPreprocess() []*ActionDesc {
	if x != nil {
		return x.Preprocess
	}
	return nil
...
func (x *PacketInjectRequest) GetStartHeader() PacketHeaderId {
	...
	return Default_PacketInjectRequest_StartHeader
}
...
func (x *PacketInjectRequest) GetDebug() bool {
	...
	return Default_PacketInjectRequest_Debug
}
...
var file_proto_forwarding_forwarding_packetsink_proto_rawDesc = []byte{
	...
	0x67, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9,
	...
	,
	...
	0x0c, 0x70, 0x61, 0x72, 0x73, 0x65, 0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x12, 0x1b, 0x0a,
	0x05, 0x64, 0x65, 0x62, 0x75, 0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x3a, 0x05, 0x66, 0x61,
	0x6c, 0x73, 0x65, 0x52, 0x05, 0x64, 0x65, 0x62, 0x75, 0x67, 0x22, 0x13, 0x0a, 0x11, 0x50, 0x61,
	0x63, 0x6b, 0x65, 0x74, 0x49, 0x6e, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42,
...
var file_proto_forwarding_forwarding_packetsink_proto_depIdxs = []int32{
	...
	5, // 3: forwarding.PacketInjectRequest.preprocess:type_name -> forwarding.ActionDesc
