...
type PacketInjectRequest struct {
	...
	Ingress      *PortId             `protobuf:"bytes,8,opt,name=ingress,proto3" json:"ingress,omitempty"`
	Egress       *PortId             `protobuf:"bytes,9,opt,name=egress,proto3" json:"egress,omitempty"`
