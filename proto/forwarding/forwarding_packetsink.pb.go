...
type PacketEjectRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PacketEjectRequest) Reset() {
	*x = PacketEjectRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PacketEjectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PacketEjectRequest) ProtoMessage() {}

func (x *PacketEjectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_forwarding_forwarding_packetsink_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PacketEjectRequest.ProtoReflect.Descriptor instead.
func (*PacketEjectRequest) Descriptor() ([]byte, []int) {
	return file_proto_forwarding_forwarding_packetsink_proto_rawDescGZIP(), []int{2}
}

func (x *PacketEjectRequest) GetContextId() *ContextId {
	if x != nil {
		return x.ContextId
	}
	return nil
...
type PacketEjectResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PacketEjectResponse) Reset() {
	*x = PacketEjectResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PacketEjectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PacketEjectResponse) ProtoMessage() {}

func (x *PacketEjectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_forwarding_forwarding_packetsink_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PacketEjectResponse.ProtoReflect.Descriptor instead.
func (*PacketEjectResponse) Descriptor() ([]byte, []int) {
	return file_proto_forwarding_forwarding_packetsink_proto_rawDescGZIP(), []int{3}
}

func (x *PacketEjectResponse) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
func (x *PacketEjectResponse) GetPortId() *PortId {
	if x != nil {
		return x.PortId
	}
	return nil
...
func (x *PacketEjectResponse) GetIngress() *PortId {
	if x != nil {
		return x.Ingress
	}
	return nil
...
func (x *PacketEjectResponse) GetEgress() *PortId {
	if x != nil {
		return x.Egress
	}
	return nil
...
func (x *PacketEjectResponse) GetParsedFields() []*PacketFieldBytes {
	if x != nil {
		return x.ParsedFields
	}
	return nil
...
var file_proto_forwarding_forwarding_packetsink_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4a, 0x0a, 0x12, 0x50,
	0x61, 0x63, 0x6b, 0x65, 0x74, 0x45, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
...
var file_proto_forwarding_forwarding_packetsink_proto_goTypes = []interface{}{
	...
	(*PacketEjectRequest)(nil),   // 2: forwarding.PacketEjectRequest
	(*PacketEjectResponse)(nil),  // 3: forwarding.PacketEjectResponse
...
var file_proto_forwarding_forwarding_packetsink_proto_depIdxs = []int32{
	...
	5,  // 6: forwarding.PacketEjectRequest.context_id:type_name -> forwarding.ContextId
	4,  // 7: forwarding.PacketEjectResponse.port_id:type_name -> forwarding.PortId
	4,  // 8: forwarding.PacketEjectResponse.ingress:type_name -> forwarding.PortId
	4,  // 9: forwarding.PacketEjectResponse.egress:type_name -> forwarding.PortId
	9,  // 10: forwarding.PacketEjectResponse.parsed_fields:type_name -> forwarding.PacketFieldBytes
...
func file_proto_forwarding_forwarding_packetsink_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_forwarding_forwarding_packetsink_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PacketEjectRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_forwarding_forwarding_packetsink_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PacketEjectResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
