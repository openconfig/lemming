...
const file_proto_forwarding_forwarding_table_proto_rawDesc = "" +
	"\n" +
	"'proto/forwarding/forwarding_table.proto\x12\n" +
	"forwarding\x1a(proto/forwarding/forwarding_action.proto\x1a(proto/forwarding/forwarding_common.proto\"\xb6\x03\n" +
	"\tTableDesc\x124\n" +
	"\n" +
	"table_type\x18\x01 \x01(\x0e2\x15.forwarding.TableTypeR\ttableType\x120\n" +
	"\aactions\x18\x02 \x03(\v2\x16.forwarding.ActionDescR\aactions\x12.\n" +
	"\btable_id\x18\x03 \x01(\v2\x13.forwarding.TableIdR\atableId\x122\n" +
	"\x05exact\x18\x04 \x01(\v2\x1a.forwarding.ExactTableDescH\x00R\x05exact\x125\n" +
	"\x06prefix\x18\x05 \x01(\v2\x1b.forwarding.PrefixTableDescH\x00R\x06prefix\x12/\n" +
	"\x04flow\x18\x06 \x01(\v2\x19.forwarding.FlowTableDescH\x00R\x04flow\x125\n" +
	"\x06bridge\x18\a \x01(\v2\x1b.forwarding.BridgeTableDescH\x00R\x06bridge\x125\n" +
	"\x06action\x18\b \x01(\v2\x1b.forwarding.ActionTableDescH\x00R\x06actionB\a\n" +
	"\x05table\"\x9e\x02\n" +
	"\tEntryDesc\x122\n" +
	"\x05exact\x18\x01 \x01(\v2\x1a.forwarding.ExactEntryDescH\x00R\x05exact\x125\n" +
	"\x06prefix\x18\x02 \x01(\v2\x1b.forwarding.PrefixEntryDescH\x00R\x06prefix\x12/\n" +
	"\x04flow\x18\x03 \x01(\v2\x19.forwarding.FlowEntryDescH\x00R\x04flow\x125\n" +
	"\x06bridge\x18\x04 \x01(\v2\x1b.forwarding.BridgeTableDescH\x00R\x06bridge\x125\n" +
	"\x06action\x18\x05 \x01(\v2\x1b.forwarding.ActionEntryDescH\x00R\x06actionB\a\n" +
	"\x05entry\"u\n" +
	"\x0eExactTableDesc\x126\n" +
	"\tfield_ids\x18\x01 \x03(\v2\x19.forwarding.PacketFieldIdR\bfieldIds\x12+\n" +
	"\x11transient_timeout\x18\x02 \x01(\rR\x10transientTimeout\"d\n" +
	"\x0eExactEntryDesc\x124\n" +
	"\x06fields\x18\x01 \x03(\v2\x1c.forwarding.PacketFieldBytesR\x06fields\x12\x1c\n" +
	"\ttransient\x18\x02 \x01(\bR\ttransient\"I\n" +
	"\x0fPrefixTableDesc\x126\n" +
	"\tfield_ids\x18\x01 \x03(\v2\x19.forwarding.PacketFieldIdR\bfieldIds\"M\n" +
	"\x0fPrefixEntryDesc\x12:\n" +
	"\x06fields\x18\x01 \x03(\v2\".forwarding.PacketFieldMaskedBytesR\x06fields\".\n" +
	"\rFlowTableDesc\x12\x1d\n" +
	"\n" +
	"bank_count\x18\x01 \x01(\rR\tbankCount\"\xc7\x01\n" +
	"\rFlowEntryDesc\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\rR\bpriority\x12:\n" +
	"\x06fields\x18\x02 \x03(\v2\".forwarding.PacketFieldMaskedBytesR\x06fields\x12\x12\n" +
	"\x04bank\x18\x03 \x01(\rR\x04bank\x12\x0e\n" +
	"\x02id\x18\x04 \x01(\rR\x02id\x12:\n" +
	"\n" +
	"qualifiers\x18\x05 \x03(\v2\x1a.forwarding.PacketFieldSetR\n" +
	"qualifiers\">\n" +
	"\x0fBridgeTableDesc\x12+\n" +
	"\x11transient_timeout\x18\x01 \x01(\rR\x10transientTimeout\"\x11\n" +
	"\x0fActionTableDesc\"\xd4\x01\n" +
	"\x0fActionEntryDesc\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12M\n" +
	"\rinsert_method\x18\x02 \x01(\x0e2(.forwarding.ActionEntryDesc.InsertMethodR\finsertMethod\"b\n" +
	"\fInsertMethod\x12\x1d\n" +
	"\x19INSERT_METHOD_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15INSERT_METHOD_PREPEND\x10\x01\x12\x18\n" +
	"\x14INSERT_METHOD_APPEND\x10\x02\"u\n" +
	"\x12TableCreateRequest\x12)\n" +
	"\x04desc\x18\x01 \x01(\v2\x15.forwarding.TableDescR\x04desc\x124\n" +
	"\n" +
	"context_id\x18\x02 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"N\n" +
	"\x10TableCreateReply\x12:\n" +
	"\fobject_index\x18\x02 \x01(\v2\x17.forwarding.ObjectIndexR\vobjectIndex\"\xc1\x03\n" +
	"\x14TableEntryAddRequest\x12.\n" +
	"\btable_id\x18\x01 \x01(\v2\x13.forwarding.TableIdR\atableId\x124\n" +
	"\n" +
	"context_id\x18\x04 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x120\n" +
	"\aactions\x18\x02 \x03(\v2\x16.forwarding.ActionDescR\aactions\x124\n" +
	"\n" +
	"entry_desc\x18\x03 \x01(\v2\x15.forwarding.EntryDescR\tentryDesc\x12@\n" +
	"\aentries\x18\x05 \x03(\v2&.forwarding.TableEntryAddRequest.EntryR\aentries\x12(\n" +
	"\x10clear_before_add\x18\x06 \x01(\bR\x0eclearBeforeAdd\x1ao\n" +
	"\x05Entry\x120\n" +
	"\aactions\x18\x01 \x03(\v2\x16.forwarding.ActionDescR\aactions\x124\n" +
	"\n" +
	"entry_desc\x18\x02 \x01(\v2\x15.forwarding.EntryDescR\tentryDesc\"\x14\n" +
	"\x12TableEntryAddReply\"\xe6\x01\n" +
	"\x17TableEntryRemoveRequest\x12.\n" +
	"\btable_id\x18\x01 \x01(\v2\x13.forwarding.TableIdR\atableId\x124\n" +
	"\n" +
	"context_id\x18\x03 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x124\n" +
	"\n" +
	"entry_desc\x18\x02 \x01(\v2\x15.forwarding.EntryDescR\tentryDesc\x12/\n" +
	"\aentries\x18\x04 \x03(\v2\x15.forwarding.EntryDescR\aentries\"\x17\n" +
	"\x15TableEntryRemoveReply\"x\n" +
	"\x10TableListRequest\x12.\n" +
	"\btable_id\x18\x01 \x01(\v2\x13.forwarding.TableIdR\atableId\x124\n" +
	"\n" +
	"context_id\x18\x02 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"*\n" +
	"\x0eTableListReply\x12\x18\n" +
	"\aentries\x18\x01 \x03(\tR\aentries*\x97\x01\n" +
	"\tTableType\x12\x1a\n" +
	"\x16TABLE_TYPE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10TABLE_TYPE_EXACT\x10\x01\x12\x15\n" +
	"\x11TABLE_TYPE_PREFIX\x10\x02\x12\x13\n" +
	"\x0fTABLE_TYPE_FLOW\x10\x03\x12\x15\n" +
	"\x11TABLE_TYPE_BRIDGE\x10\x04\x12\x15\n" +
	"\x11TABLE_TYPE_ACTION\x10\x05B0Z.github.com/openconfig/lemming/proto/forwardingb\x06proto3"
