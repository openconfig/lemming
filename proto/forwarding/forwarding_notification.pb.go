...
func (x *EventDesc) GetDesc() isEventDesc_Desc {
	if x != nil {
		return x.Desc
	}
	return nil
...
func (x *EventDesc) GetPort() *PortEventDesc {
	if x != nil {
		if x, ok := x.Desc.(*EventDesc_Port); ok {
			return x.Port
		}
	}
	return nil
...
var file_proto_forwarding_forwarding_notification_proto_rawDesc = string([]byte{
	...
	,
	...
	0x49, 0x64, 0x12, 0x31, 0x0a, 0x09, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69,
	0x6e, 0x67, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x70, 0x6f, 0x72,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2a, 0x2e, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15,
	0x0a, 0x11, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46,
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x50,
	0x4f, 0x52, 0x54, 0x10, 0x01, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var (
	...
	file_proto_forwarding_forwarding_notification_proto_rawDescData []byte
)
...
func file_proto_forwarding_forwarding_notification_proto_rawDescGZIP() []byte {
	file_proto_forwarding_forwarding_notification_proto_rawDescOnce.Do(func() {
		file_proto_forwarding_forwarding_notification_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_forwarding_forwarding_notification_proto_rawDesc), len(file_proto_forwarding_forwarding_notification_proto_rawDesc)))
	})
...
var file_proto_forwarding_forwarding_notification_proto_depIdxs = []int32{
	...
	4, // 2: forwarding.NotifySubscribeRequest.context:type_name -> forwarding.ContextId
	4, // 3: forwarding.PortEventDesc.context:type_name -> forwarding.ContextId
	5, // 4: forwarding.PortEventDesc.port_id:type_name -> forwarding.PortId
	6, // 5: forwarding.PortEventDesc.port_info:type_name -> forwarding.PortInfo
...
func file_proto_forwarding_forwarding_notification_proto_init() {
	...
	file_proto_forwarding_forwarding_notification_proto_msgTypes[0].OneofWrappers = []any{
		(*EventDesc_Port)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_forwarding_forwarding_notification_proto_rawDesc), len(file_proto_forwarding_forwarding_notification_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
