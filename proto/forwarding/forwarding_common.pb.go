...
const file_proto_forwarding_forwarding_common_proto_rawDesc = "" +
	"\n" +
	"(proto/forwarding/forwarding_common.proto\x12\n" +
	"forwarding\"\x1b\n" +
	"\tContextId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"F\n" +
	"\aCounter\x12%\n" +
	"\x02id\x18\x01 \x01(\x0e2\x15.forwarding.CounterIdR\x02id\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value\"\x1a\n" +
	"\bObjectId\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"#\n" +
	"\vObjectIndex\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x04R\x05index\":\n" +
	"\x05SetId\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\";\n" +
	"\x06PortId\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\"<\n" +
	"\aTableId\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\"\x97\x01\n" +
	"\vPacketBytes\x12@\n" +
	"\fheader_group\x18\x01 \x01(\x0e2\x1d.forwarding.PacketHeaderGroupR\vheaderGroup\x12\x1a\n" +
	"\binstance\x18\x02 \x01(\rR\binstance\x12\x16\n" +
	"\x06offset\x18\x03 \x01(\rR\x06offset\x12\x12\n" +
	"\x04size\x18\x04 \x01(\rR\x04size\"b\n" +
	"\vPacketField\x127\n" +
	"\tfield_num\x18\x01 \x01(\x0e2\x1a.forwarding.PacketFieldNumR\bfieldNum\x12\x1a\n" +
	"\binstance\x18\x02 \x01(\rR\binstance\"m\n" +
	"\rPacketFieldId\x12-\n" +
	"\x05field\x18\x01 \x01(\v2\x17.forwarding.PacketFieldR\x05field\x12-\n" +
	"\x05bytes\x18\x02 \x01(\v2\x17.forwarding.PacketBytesR\x05bytes\"^\n" +
	"\x10PacketFieldBytes\x124\n" +
	"\bfield_id\x18\x01 \x01(\v2\x19.forwarding.PacketFieldIdR\afieldId\x12\x14\n" +
	"\x05bytes\x18\x02 \x01(\fR\x05bytes\"z\n" +
	"\x16PacketFieldMaskedBytes\x124\n" +
	"\bfield_id\x18\x01 \x01(\v2\x19.forwarding.PacketFieldIdR\afieldId\x12\x14\n" +
	"\x05bytes\x18\x02 \x01(\fR\x05bytes\x12\x14\n" +
	"\x05masks\x18\x03 \x01(\fR\x05masks\"p\n" +
	"\x0ePacketFieldSet\x124\n" +
	"\bfield_id\x18\x01 \x01(\v2\x19.forwarding.PacketFieldIdR\afieldId\x12(\n" +
	"\x06set_id\x18\x02 \x01(\v2\x11.forwarding.SetIdR\x05setId\"\x80\x01\n" +
	"\x15ObjectCountersRequest\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\x124\n" +
	"\n" +
	"context_id\x18\x02 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"F\n" +
	"\x13ObjectCountersReply\x12/\n" +
	"\bcounters\x18\x01 \x03(\v2\x13.forwarding.CounterR\bcounters\"~\n" +
	"\x13ObjectDeleteRequest\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\x124\n" +
	"\n" +
	"context_id\x18\x02 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"\x13\n" +
	"\x11ObjectDeleteReply\"I\n" +
	"\x11ObjectListRequest\x124\n" +
	"\n" +
	"context_id\x18\x02 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"A\n" +
	"\x0fObjectListReply\x12.\n" +
	"\aobjects\x18\x01 \x03(\v2\x14.forwarding.ObjectIdR\aobjects\"L\n" +
	"\x14ContextCreateRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"\x14\n" +
	"\x12ContextCreateReply\"L\n" +
	"\x14ContextDeleteRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"\x14\n" +
	"\x12ContextDeleteReply\"C\n" +
	"\vContextAttr\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\"\x14\n" +
	"\x12ContextListRequest\"G\n" +
	"\x10ContextListReply\x123\n" +
	"\bcontexts\x18\x01 \x03(\v2\x17.forwarding.ContextAttrR\bcontexts\"r\n" +
	"\x10SetCreateRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x12(\n" +
	"\x06set_id\x18\x03 \x01(\v2\x11.forwarding.SetIdR\x05setId\"L\n" +
	"\x0eSetCreateReply\x12:\n" +
	"\fobject_index\x18\x02 \x01(\v2\x17.forwarding.ObjectIndexR\vobjectIndex\"\x88\x01\n" +
	"\x10SetUpdateRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x12(\n" +
	"\x06set_id\x18\x02 \x01(\v2\x11.forwarding.SetIdR\x05setId\x12\x14\n" +
	"\x05bytes\x18\x03 \x03(\fR\x05bytes\"\x10\n" +
	"\x0eSetUpdateReply\"B\n" +
	"\rFlowCounterId\x121\n" +
	"\tobject_id\x18\x01 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\"j\n" +
	"\vFlowCounter\x12)\n" +
	"\x02id\x18\x01 \x01(\v2\x19.forwarding.FlowCounterIdR\x02id\x12\x16\n" +
	"\x06octets\x18\x02 \x01(\x04R\x06octets\x12\x18\n" +
	"\apackets\x18\x03 \x01(\x04R\apackets\"{\n" +
	"\x18FlowCounterCreateRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x12)\n" +
	"\x02id\x18\x02 \x01(\v2\x19.forwarding.FlowCounterIdR\x02id\"\x18\n" +
	"\x16FlowCounterCreateReply\"|\n" +
	"\x17FlowCounterQueryRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x12+\n" +
	"\x03ids\x18\x02 \x03(\v2\x19.forwarding.FlowCounterIdR\x03ids\"L\n" +
	"\x15FlowCounterQueryReply\x123\n" +
	"\bcounters\x18\x01 \x03(\v2\x17.forwarding.FlowCounterR\bcounters\"{\n" +
	"\x10ObjectNIDRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x121\n" +
	"\tobject_id\x18\x02 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\"\"\n" +
	"\x0eObjectNIDReply\x12\x10\n" +
	"\x03nid\x18\x01 \x01(\x04R\x03nid*o\n" +
	"\n" +
	"PortAction\x12\x1b\n" +
	"\x17PORT_ACTION_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PORT_ACTION_INPUT\x10\x01\x12\x16\n" +
	"\x12PORT_ACTION_OUTPUT\x10\x02\x12\x15\n" +
	"\x11PORT_ACTION_WRITE\x10\x03*\xa8\x02\n" +
	"\x11PacketHeaderGroup\x12#\n" +
	"\x1fPACKET_HEADER_GROUP_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18PACKET_HEADER_GROUP_NONE\x10\x01\x12\x1e\n" +
	"\x1aPACKET_HEADER_GROUP_PACKET\x10\x02\x12\x1a\n" +
	"\x16PACKET_HEADER_GROUP_L2\x10\x03\x12\x1a\n" +
	"\x16PACKET_HEADER_GROUP_L3\x10\x04\x12\x1a\n" +
	...
	"\x19PACKET_HEADER_ID_METADATA\x10\x02\x12\x1d\n" +
	"\x19PACKET_HEADER_ID_ETHERNET\x10\x03\x12\"\n" +
	"\x1ePACKET_HEADER_ID_ETHERNET_VLAN\x10\x04\x12 \n" +
	"\x1cPACKET_HEADER_ID_ETHERNET_1Q\x10\x05\x12\x18\n" +
	"\x14PACKET_HEADER_ID_IP4\x10\x06\x12\x18\n" +
	"\x14PACKET_HEADER_ID_IP6\x10\a\x12\x18\n" +
	"\x14PACKET_HEADER_ID_GRE\x10\b\x12\x18\n" +
	"\x14PACKET_HEADER_ID_TCP\x10\t\x12\x18\n" +
	"\x14PACKET_HEADER_ID_UDP\x10\n" +
	"\x12\x18\n" +
	"\x14PACKET_HEADER_ID_ARP\x10\v\x12\x1a\n" +
	"\x16PACKET_HEADER_ID_ICMP4\x10\f\x12\x1b\n" +
	"\x17PACKET_HEADER_ID_OPAQUE\x10\r\x12\x1a\n" +
	"\x16PACKET_HEADER_ID_ICMP6\x10\x0e\x12%\n" +
	...
	"\x1ePACKET_FIELD_NUM_ETHER_MAC_SRC\x10\x02\x12\"\n" +
	"\x1ePACKET_FIELD_NUM_ETHER_MAC_DST\x10\x03\x12\x1f\n" +
	"\x1bPACKET_FIELD_NUM_ETHER_TYPE\x10\x04\x12\x1d\n" +
	"\x19PACKET_FIELD_NUM_VLAN_TAG\x10\x05\x12\"\n" +
	"\x1ePACKET_FIELD_NUM_VLAN_PRIORITY\x10\x06\x12\x1f\n" +
	"\x1bPACKET_FIELD_NUM_IP_VERSION\x10\a\x12 \n" +
	"\x1cPACKET_FIELD_NUM_IP_ADDR_SRC\x10\b\x12 \n" +
	"\x1cPACKET_FIELD_NUM_IP_ADDR_DST\x10\t\x12\x1b\n" +
	"\x17PACKET_FIELD_NUM_IP_HOP\x10\n" +
	"\x12\x1d\n" +
	"\x19PACKET_FIELD_NUM_IP_PROTO\x10\v\x12\x1b\n" +
	"\x17PACKET_FIELD_NUM_IP_QOS\x10\f\x12\x1d\n" +
	"\x19PACKET_FIELD_NUM_IP6_FLOW\x10\r\x12&\n" +
	"\"PACKET_FIELD_NUM_PACKET_PORT_INPUT\x10\x0e\x12'\n" +
	"#PACKET_FIELD_NUM_PACKET_PORT_OUTPUT\x10\x0f\x12\"\n" +
	"\x1ePACKET_FIELD_NUM_PACKET_LENGTH\x10\x10\x12\x1e\n" +
	"\x1aPACKET_FIELD_NUM_ICMP_TYPE\x10\x11\x12\x1e\n" +
	"\x1aPACKET_FIELD_NUM_ICMP_CODE\x10\x12\x12 \n" +
	"\x1cPACKET_FIELD_NUM_L4_PORT_SRC\x10\x13\x12 \n" +
	"\x1cPACKET_FIELD_NUM_L4_PORT_DST\x10\x14\x12\x1e\n" +
	"\x1aPACKET_FIELD_NUM_TCP_FLAGS\x10\x15\x12\x1c\n" +
	"\x18PACKET_FIELD_NUM_ARP_TPA\x10\x16\x12\x1c\n" +
	"\x18PACKET_FIELD_NUM_GRE_KEY\x10\x17\x12!\n" +
	"\x1dPACKET_FIELD_NUM_GRE_SEQUENCE\x10\x18\x12\x1f\n" +
	"\x1bPACKET_FIELD_NUM_PACKET_VRF\x10\x19\x12$\n" +
	" PACKET_FIELD_NUM_ICMP6_ND_TARGET\x10\x1a\x12!\n" +
	"\x1dPACKET_FIELD_NUM_ICMP6_ND_SLL\x10\x1b\x12!\n" +
	"\x1dPACKET_FIELD_NUM_ICMP6_ND_TLL\x10\x1c\x12(\n" +
	"$PACKET_FIELD_NUM_PACKET_ATTRIBUTE_32\x10\"\x12(\n" +
	"$PACKET_FIELD_NUM_PACKET_ATTRIBUTE_16\x10.\x12'\n" +
	"#PACKET_FIELD_NUM_PACKET_ATTRIBUTE_8\x101\x12(\n" +
	"$PACKET_FIELD_NUM_PACKET_ATTRIBUTE_24\x102\x12\x1d\n" +
	"\x19PACKET_FIELD_NUM_ARP_TMAC\x104\x12\x1d\n" +
	"\x19PACKET_FIELD_NUM_ARP_SMAC\x105\x12\x1c\n" +
	"\x18PACKET_FIELD_NUM_ARP_SPA\x106\x12 \n" +
	"\x1cPACKET_FIELD_NUM_NEXT_HOP_IP\x108\x12&\n" +
	"\"PACKET_FIELD_NUM_NEXT_HOP_GROUP_ID\x109\x12 \n" +
	"\x1cPACKET_FIELD_NUM_NEXT_HOP_ID\x10:\x12\x1c\n" +
	"\x18PACKET_FIELD_NUM_TRAP_ID\x10;\x12 \n" +
	"\x1cPACKET_FIELD_NUM_INPUT_IFACE\x10<\x12!\n" +
	"\x1dPACKET_FIELD_NUM_OUTPUT_IFACE\x10=\x12\x1e\n" +
	"\x1aPACKET_FIELD_NUM_TUNNEL_ID\x10>\x12!\n" +
	"\x1dPACKET_FIELD_NUM_HOST_PORT_ID\x10?\x12\"\n" +
	"\x1ePACKET_FIELD_NUM_L2MC_GROUP_ID\x10@\x12\x1f\n" +
	"\x1bPACKET_FIELD_NUM_POLICER_ID\x10A\x12\x1f\n" +
	"\x1bPACKET_FIELD_NUM_MPLS_LABEL\x10B\x12\x1c\n" +
	...
	"\x15COUNTER_ID_RX_PACKETS\x10\x01\x12\x18\n" +
	"\x14COUNTER_ID_RX_OCTETS\x10\x02\x12\x1e\n" +
	"\x1aCOUNTER_ID_RX_DROP_PACKETS\x10\x03\x12\x1d\n" +
	"\x19COUNTER_ID_RX_DROP_OCTETS\x10\x04\x12\x1f\n" +
	"\x1bCOUNTER_ID_RX_ERROR_PACKETS\x10\x05\x12\x1e\n" +
	"\x1aCOUNTER_ID_RX_ERROR_OCTETS\x10\x06\x12\x19\n" +
	"\x15COUNTER_ID_TX_PACKETS\x10\a\x12\x18\n" +
	"\x14COUNTER_ID_TX_OCTETS\x10\b\x12\x1e\n" +
	"\x1aCOUNTER_ID_TX_DROP_PACKETS\x10\t\x12\x1d\n" +
	"\x19COUNTER_ID_TX_DROP_OCTETS\x10\n" +
	"\x12\x1f\n" +
	"\x1bCOUNTER_ID_TX_ERROR_PACKETS\x10\v\x12\x1e\n" +
	"\x1aCOUNTER_ID_TX_ERROR_OCTETS\x10\f\x12 \n" +
	"\x1cCOUNTER_ID_RATELIMIT_PACKETS\x10\r\x12\x1f\n" +
	"\x1bCOUNTER_ID_RATELIMIT_OCTETS\x10\x0e\x12\x1b\n" +
	"\x17COUNTER_ID_DROP_PACKETS\x10\x0f\x12\x1a\n" +
	"\x16COUNTER_ID_DROP_OCTETS\x10\x10\x12\x1c\n" +
	"\x18COUNTER_ID_ERROR_PACKETS\x10\x11\x12\x1b\n" +
	"\x17COUNTER_ID_ERROR_OCTETS\x10\x12\x12\x1d\n" +
	"\x19COUNTER_ID_RX_BAD_PACKETS\x10\x13\x12\x1c\n" +
	"\x18COUNTER_ID_RX_BAD_OCTETS\x10\x14\x12$\n" +
	" COUNTER_ID_RX_ADMIN_DROP_PACKETS\x10\x15\x12#\n" +
	"\x1fCOUNTER_ID_RX_ADMIN_DROP_OCTETS\x10\x16\x12$\n" +
	" COUNTER_ID_TX_ADMIN_DROP_PACKETS\x10\x17\x12#\n" +
	"\x1fCOUNTER_ID_TX_ADMIN_DROP_OCTETS\x10\x18\x12\x1d\n" +
	"\x19COUNTER_ID_MIRROR_PACKETS\x10\x19\x12\x1c\n" +
	"\x18COUNTER_ID_MIRROR_OCTETS\x10\x1a\x12#\n" +
	"\x1fCOUNTER_ID_MIRROR_ERROR_PACKETS\x10\x1b\x12\"\n" +
	"\x1eCOUNTER_ID_MIRROR_ERROR_OCTETS\x10\x1c\x12\"\n" +
	"\x1eCOUNTER_ID_ENCAP_ERROR_PACKETS\x10\x1d\x12!\n" +
	"\x1dCOUNTER_ID_ENCAP_ERROR_OCTETS\x10\x1e\x12\"\n" +
	"\x1eCOUNTER_ID_DECAP_ERROR_PACKETS\x10\x1f\x12!\n" +
	"\x1dCOUNTER_ID_DECAP_ERROR_OCTETS\x10 \x12\"\n" +
	"\x1eCOUNTER_ID_FLOW_COUNTER_OCTETS\x10!\x12#\n" +
	"\x1fCOUNTER_ID_FLOW_COUNTER_PACKETS\x10\"\x12\x1f\n" +
	"\x1bCOUNTER_ID_RX_DEBUG_PACKETS\x10#\x12\x1e\n" +
	"\x1aCOUNTER_ID_RX_DEBUG_OCTETS\x10$\x12\x1f\n" +
	"\x1bCOUNTER_ID_RX_UCAST_PACKETS\x10%\x12#\n" +
	"\x1fCOUNTER_ID_RX_NON_UCAST_PACKETS\x10&\x12\x1f\n" +
	"\x1bCOUNTER_ID_TX_UCAST_PACKETS\x10'\x12#\n" +
	"\x1fCOUNTER_ID_TX_NON_UCAST_PACKETS\x10(\x12#\n" +
	"\x1fCOUNTER_ID_TX_BROADCAST_PACKETS\x10)\x12#\n" +
	"\x1fCOUNTER_ID_TX_MULTICAST_PACKETS\x10*\x12#\n" +
	"\x1fCOUNTER_ID_RX_BROADCAST_PACKETS\x10+\x12#\n" +
	"\x1fCOUNTER_ID_RX_MULTICAST_PACKETS\x10,\x12\x1e\n" +
	"\x1aCOUNTER_ID_RX_IPV6_PACKETS\x10-\x12\x1e\n" +
	"\x1aCOUNTER_ID_TX_IPV6_PACKETS\x10.\x12#\n" +
	"\x1fCOUNTER_ID_RX_IPV6_DROP_PACKETS\x10/\x12#\n" +
	"\x1fCOUNTER_ID_TX_IPV6_DROP_PACKETS\x100\x12\x13\n" +
	"\x0eCOUNTER_ID_MAX\x10\xff\x01B0Z.github.com/openconfig/lemming/proto/forwardingb\x06proto3"
