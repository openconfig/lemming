...
const file_proto_forwarding_forwarding_attribute_proto_rawDesc = "" +
	"\n" +
	"+proto/forwarding/forwarding_attribute.proto\x12\n" +
	"forwarding\x1a(proto/forwarding/forwarding_common.proto\"7\n" +
	"\rAttributeDesc\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04help\x18\x02 \x01(\tR\x04help\"\x16\n" +
	"\x14AttributeListRequest\"E\n" +
	"\x12AttributeListReply\x12/\n" +
	"\x05attrs\x18\x01 \x03(\v2\x19.forwarding.AttributeDescR\x05attrs\"\xb9\x01\n" +
	"\x16AttributeUpdateRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x121\n" +
	"\tobject_id\x18\x02 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\x12\x17\n" +
	"\aattr_id\x18\x03 \x01(\tR\x06attrId\x12\x1d\n" +
	"\n" +
	"attr_value\x18\x04 \x01(\tR\tattrValue\"\x16\n" +
	"\x14AttributeUpdateReply\"\x99\x01\n" +
	"\x15AttributeQueryRequest\x124\n" +
	"\n" +
	"context_id\x18\x01 \x01(\v2\x15.forwarding.ContextIdR\tcontextId\x121\n" +
	"\tobject_id\x18\x02 \x01(\v2\x14.forwarding.ObjectIdR\bobjectId\x12\x17\n" +
	"\aattr_id\x18\x03 \x01(\tR\x06attrId\"4\n" +
	"\x13AttributeQueryReply\x12\x1d\n" +
	"\n" +
	"attr_value\x18\x01 \x01(\tR\tattrValueB0Z.github.com/openconfig/lemming/proto/forwardingb\x06proto3"

var (
	file_proto_forwarding_forwarding_attribute_proto_rawDescOnce sync.Once
	file_proto_forwarding_forwarding_attribute_proto_rawDescData []byte
)
...
func file_proto_forwarding_forwarding_attribute_proto_rawDescGZIP() []byte {
	file_proto_forwarding_forwarding_attribute_proto_rawDescOnce.Do(func() {
		file_proto_forwarding_forwarding_attribute_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_forwarding_forwarding_attribute_proto_rawDesc), len(file_proto_forwarding_forwarding_attribute_proto_rawDesc)))
	})
...
var file_proto_forwarding_forwarding_attribute_proto_goTypes = []any{
...
func file_proto_forwarding_forwarding_attribute_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_forwarding_forwarding_attribute_proto_rawDesc), len(file_proto_forwarding_forwarding_attribute_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
