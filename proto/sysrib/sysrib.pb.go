...
var file_proto_sysrib_sysrib_proto_goTypes = []interface{}{
...
func file_proto_sysrib_sysrib_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_sysrib_sysrib_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_sysrib_sysrib_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Prefix); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_sysrib_sysrib_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_sysrib_sysrib_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
