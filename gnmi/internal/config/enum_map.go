...
func initΛEnumTypes() {
	ΛEnumTypes = map[string][]reflect.Type{
		...
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/transport/config/tcp-flags": {
		...
		"/network-instances/network-instance/evpn/ethernet-segments/ethernet-segment/config/esi": {
			reflect.TypeOf((E_EthernetSegment_Esi_Enum)(0)),
		},
		"/network-instances/network-instance/evpn/ethernet-segments/ethernet-segment/config/esi-type": {
			reflect.TypeOf((E_EvpnTypes_EsiType)(0)),
		},
		"/network-instances/network-instance/evpn/ethernet-segments/ethernet-segment/config/redundancy-mode": {
			reflect.TypeOf((E_EvpnTypes_EVPN_REDUNDANCY_MODE)(0)),
		},
		"/network-instances/network-instance/evpn/ethernet-segments/ethernet-segment/df-election/config/df-election-method": {
		...
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/tcp-flags": {
			reflect.TypeOf((E_PacketMatchTypes_TCP_FLAGS)(0)),
		},
