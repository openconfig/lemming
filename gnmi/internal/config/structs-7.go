...
type NetworkInstance_Protocol_Isis_Level_RoutePreference struct {
	ExternalRoutePreference *uint8 `path:"config/external-route-preference" module:"openconfig-network-instance/openconfig-network-instance"`
	InternalRoutePreference *uint8 `path:"config/internal-route-preference" module:"openconfig-network-instance/openconfig-network-instance"`
}
