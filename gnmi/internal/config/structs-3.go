...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_L3VpnIpv6Multicast_PrefixLimit struct {
	...
	RestartTimer        *float64 `path:"config/restart-timer" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Global_GracefulRestart struct {
	...
	StaleRoutesTime *float64 `path:"config/stale-routes-time" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_Timers struct {
	ConnectRetry                 *float64 `path:"config/connect-retry" module:"openconfig-network-instance/openconfig-network-instance"`
	HoldTime                     *float64 `path:"config/hold-time" module:"openconfig-network-instance/openconfig-network-instance"`
	KeepaliveInterval            *float64 `path:"config/keepalive-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	MinimumAdvertisementInterval *float64 `path:"config/minimum-advertisement-interval" module:"openconfig-network-instance/openconfig-network-instance"`
