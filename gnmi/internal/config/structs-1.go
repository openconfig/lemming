...
type LocalRoutes_Aggregate struct {
	Description *string                            `path:"config/description" module:"openconfig-local-routing/openconfig-local-routing"`
	Discard     *bool                              `path:"config/discard" module:"openconfig-local-routing/openconfig-local-routing"`
	Prefix      *string                            `path:"config/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Aggregate_SetTag_Union `path:"config/set-tag" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static struct {
	...
	Prefix      *string                                `path:"config/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Static_SetTag_Union        `path:"config/set-tag" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop struct {
	...
	Index        *string                                  `path:"config/index|index" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	InterfaceRef *LocalRoutes_Static_NextHop_InterfaceRef `path:"interface-ref" module:"openconfig-local-routing"`
	Metric       *uint32                                  `path:"config/metric" module:"openconfig-local-routing/openconfig-local-routing"`
	NextHop      LocalRoutes_Static_NextHop_NextHop_Union `path:"config/next-hop" module:"openconfig-local-routing/openconfig-local-routing"`
	Recurse      *bool                                    `path:"config/recurse" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_EnableBfd struct {
	Enabled *bool `path:"config/enabled" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_InterfaceRef struct {
	Interface    *string `path:"config/interface" module:"openconfig-local-routing/openconfig-local-routing"`
	Subinterface *uint32 `path:"config/subinterface" module:"openconfig-local-routing/openconfig-local-routing"`
}
