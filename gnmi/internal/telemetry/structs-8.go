...
type NetworkInstance_Protocol_Pcep_PathComputationServer struct {
	...
	Id                     *string                                                             `path:"state/id" module:"openconfig-network-instance/openconfig-network-instance"`
	PceInitiatedCapability *bool                                                               `path:"state/pce-initiated-capability" module:"openconfig-network-instance/openconfig-network-instance"`
	PceServerAddress       *string                                                             `path:"state/pce-server-address|pce-server-address" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	PceType                E_Pcep_PceModeType                                                  `path:"state/pce-type" module:"openconfig-network-instance/openconfig-network-instance"`
	Port                   *uint16                                                             `path:"state/port" module:"openconfig-network-instance/openconfig-network-instance"`
	Preference             *uint8                                                              `path:"state/preference" module:"openconfig-network-instance/openconfig-network-instance"`
	ReportLocalLsp         *bool                                                               `path:"state/report-local-lsp" module:"openconfig-network-instance/openconfig-network-instance"`
	SourceAddress          *string                                                             `path:"state/source-address" module:"openconfig-network-instance/openconfig-network-instance"`
	SrSupport              *bool                                                               `path:"state/sr-support" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Pcep_PathComputationServer_Timers struct {
	DeadTimer                   *uint8  `path:"state/dead-timer" module:"openconfig-network-instance/openconfig-network-instance"`
	Keepalive                   *uint8  `path:"state/keepalive" module:"openconfig-network-instance/openconfig-network-instance"`
	RedelegationTimeoutInterval *uint16 `path:"state/redelegation-timeout-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	StateTimeoutInterval        *uint16 `path:"state/state-timeout-interval" module:"openconfig-network-instance/openconfig-network-instance"`
}
