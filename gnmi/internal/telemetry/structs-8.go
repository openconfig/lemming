...
type NetworkInstance_Protocol_Ospfv2_Area_Mpls struct {
	TrafficEngineeringEnabled *bool `path:"state/traffic-engineering-enabled" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Area_VirtualLink struct {
	...
	RemoteRouterId            *string                         `path:"state/remote-router-id|remote-router-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Protocol_Ospfv2_Global struct {
	...
	HideTransitOnlyNetworks    *bool                                                                                                                                        `path:"state/hide-transit-only-networks" module:"openconfig-network-instance/openconfig-network-instance"`
	IgpShortcuts               *bool                                                                                                                                        `path:"state/igp-shortcuts" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	LogAdjacencyChanges        *bool                                                                                                                                        `path:"state/log-adjacency-changes" module:"openconfig-network-instance/openconfig-network-instance"`
	Mpls                       *NetworkInstance_Protocol_Ospfv2_Global_Mpls                                                                                                 `path:"mpls" module:"openconfig-network-instance"`
	RouterId                   *string                                                                                                                                      `path:"state/router-id" module:"openconfig-network-instance/openconfig-network-instance"`
	SummaryRouteCostMode       E_Global_SummaryRouteCostMode                                                                                                                `path:"state/summary-route-cost-mode" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Ospfv2_Global_GracefulRestart struct {
	...
	HelperOnly *bool `path:"state/helper-only" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Global_InterAreaPropagationPolicy struct {
	...
	DstArea             NetworkInstance_Protocol_Ospfv2_Area_Identifier_Union `path:"state/dst-area|dst-area" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	ImportPolicy        []string                                              `path:"state/import-policy" module:"openconfig-network-instance/openconfig-network-instance"`
	SrcArea             NetworkInstance_Protocol_Ospfv2_Area_Identifier_Union `path:"state/src-area|src-area" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Global_Mpls struct {
	...
	TrafficEngineeringExtensions *bool                                                   `path:"state/traffic-engineering-extensions" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Global_Mpls_IgpLdpSync struct {
	Enabled            *bool   `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
	PostSessionUpDelay *uint32 `path:"state/post-session-up-delay" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Ospfv2_Global_Timers_LsaGeneration struct {
	InitialDelay *uint32                   `path:"state/initial-delay" module:"openconfig-network-instance/openconfig-network-instance"`
	MaximumDelay *uint32                   `path:"state/maximum-delay" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Ospfv2_Global_Timers_MaxMetric struct {
	Include []E_OspfTypes_MAX_METRIC_INCLUDE `path:"state/include" module:"openconfig-network-instance/openconfig-network-instance"`
	Set     *bool                            `path:"state/set" module:"openconfig-network-instance/openconfig-network-instance"`
	Timeout *uint64                          `path:"state/timeout" module:"openconfig-network-instance/openconfig-network-instance"`
	Trigger []E_OspfTypes_MAX_METRIC_TRIGGER `path:"state/trigger" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Pim_Global struct {
	...
	MaximumGroups   *uint32                                                         `path:"state/maximum-groups" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Pim_Global_RendezvousPoint struct {
	...
	MulticastGroups *string `path:"state/multicast-groups" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Pim_Global_Ssm struct {
	SsmRanges *string `path:"state/ssm-ranges" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Pim_Interface struct {
	BorderRouter      *bool                                                       `path:"state/border-router" module:"openconfig-network-instance/openconfig-network-instance"`
	BsrBorder         *bool                                                       `path:"state/bsr-border" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	DeadTimer         *uint16                                                     `path:"state/dead-timer" module:"openconfig-network-instance/openconfig-network-instance"`
	DrPriority        *uint32                                                     `path:"state/dr-priority" module:"openconfig-network-instance/openconfig-network-instance"`
	EnableBfd         *NetworkInstance_Protocol_Pim_Interface_EnableBfd           `path:"enable-bfd" module:"openconfig-network-instance"`
	Enabled           *bool                                                       `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval     *uint8                                                      `path:"state/hello-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	JoinPruneInterval *uint8                                                      `path:"state/join-prune-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	MaximumGroups     *uint32                                                     `path:"state/maximum-groups" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Static struct {
	...
	SetTag      NetworkInstance_Protocol_Static_SetTag_Union        `path:"state/set-tag" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Static_NextHop struct {
	...
	Metric       *uint32                                               `path:"state/metric" module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop      NetworkInstance_Protocol_Static_NextHop_NextHop_Union `path:"state/next-hop" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_RouteLimit struct {
	Afi               E_Types_ADDRESS_FAMILY `path:"state/afi|afi" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	AlarmThreshold    *uint32                `path:"state/alarm-threshold" module:"openconfig-network-instance/openconfig-network-instance"`
	InstalledRoutes   *uint32                `path:"state/installed-routes" module:"openconfig-network-instance/openconfig-network-instance"`
	Maximum           *uint32                `path:"state/maximum" module:"openconfig-network-instance/openconfig-network-instance"`
	ThresholdExceeded *bool                  `path:"state/threshold-exceeded" module:"openconfig-network-instance/openconfig-network-instance"`
	WarningOnly       *bool                  `path:"state/warning-only" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_SegmentRouting_Srgb struct {
	DataplaneType   E_SegmentRoutingTypes_SrDataplaneType `path:"state/dataplane-type" module:"openconfig-network-instance/openconfig-network-instance"`
	Ipv6Prefixes    []string                              `path:"state/ipv6-prefixes" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	MplsLabelBlocks []string                              `path:"state/mpls-label-blocks" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_SegmentRouting_Srlb struct {
	DataplaneType  E_SegmentRoutingTypes_SrDataplaneType `path:"state/dataplane-type" module:"openconfig-network-instance/openconfig-network-instance"`
	Ipv6Prefix     *string                               `path:"state/ipv6-prefix" module:"openconfig-network-instance/openconfig-network-instance"`
	LocalId        *string                               `path:"state/local-id|local-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	MplsLabelBlock *string                               `path:"state/mpls-label-block" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Table struct {
	AddressFamily E_Types_ADDRESS_FAMILY              `path:"state/address-family|address-family" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Protocol      E_PolicyTypes_INSTALL_PROTOCOL_TYPE `path:"state/protocol|protocol" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_TableConnection struct {
	AddressFamily            E_Types_ADDRESS_FAMILY              `path:"state/address-family|address-family" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	DefaultImportPolicy      E_RoutingPolicy_DefaultPolicyType   `path:"state/default-import-policy" module:"openconfig-network-instance/openconfig-network-instance"`
	DisableMetricPropagation *bool                               `path:"state/disable-metric-propagation" module:"openconfig-network-instance/openconfig-network-instance"`
	DstProtocol              E_PolicyTypes_INSTALL_PROTOCOL_TYPE `path:"state/dst-protocol|dst-protocol" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	ImportPolicy             []string                            `path:"state/import-policy" module:"openconfig-network-instance/openconfig-network-instance"`
	SrcProtocol              E_PolicyTypes_INSTALL_PROTOCOL_TYPE `path:"state/src-protocol|src-protocol" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Vlan struct {
	...
	Name   *string                        `path:"state/name" module:"openconfig-network-instance/openconfig-network-instance"`
	Status E_Vlan_Status                  `path:"state/status" module:"openconfig-network-instance/openconfig-network-instance"`
	VlanId *uint16                        `path:"state/vlan-id|vlan-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type Qos_BufferAllocationProfile_Queue struct {
	DedicatedBuffer           *uint64                        `path:"state/dedicated-buffer" module:"openconfig-qos/openconfig-qos"`
	DynamicLimitScalingFactor *int32                         `path:"state/dynamic-limit-scaling-factor" module:"openconfig-qos/openconfig-qos"`
	Name                      *string                        `path:"state/name|name" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
	SharedBufferLimitType     E_Qos_SHARED_BUFFER_LIMIT_TYPE `path:"state/shared-buffer-limit-type" module:"openconfig-qos/openconfig-qos"`
	StaticSharedBufferLimit   *uint32                        `path:"state/static-shared-buffer-limit" module:"openconfig-qos/openconfig-qos"`
	UseSharedBuffer           *bool                          `path:"state/use-shared-buffer" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier struct {
	...
	Type E_Qos_Classifier_Type           `path:"state/type" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Actions struct {
	...
	TargetGroup *string                             `path:"state/target-group" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Conditions_Ipv4 struct {
	DestinationAddress *string                                            `path:"state/destination-address" module:"openconfig-qos/openconfig-qos"`
	Dscp               *uint8                                             `path:"state/dscp" module:"openconfig-qos/openconfig-qos"`
	DscpSet            []uint8                                            `path:"state/dscp-set" module:"openconfig-qos/openconfig-qos"`
	HopLimit           *uint8                                             `path:"state/hop-limit" module:"openconfig-qos/openconfig-qos"`
	Protocol           Qos_Classifier_Term_Conditions_Ipv4_Protocol_Union `path:"state/protocol" module:"openconfig-qos/openconfig-qos"`
	SourceAddress      *string                                            `path:"state/source-address" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Conditions_Ipv6 struct {
	DestinationAddress   *string                                            `path:"state/destination-address" module:"openconfig-qos/openconfig-qos"`
	DestinationFlowLabel *uint32                                            `path:"state/destination-flow-label" module:"openconfig-qos/openconfig-qos"`
	Dscp                 *uint8                                             `path:"state/dscp" module:"openconfig-qos/openconfig-qos"`
	DscpSet              []uint8                                            `path:"state/dscp-set" module:"openconfig-qos/openconfig-qos"`
	HopLimit             *uint8                                             `path:"state/hop-limit" module:"openconfig-qos/openconfig-qos"`
	Protocol             Qos_Classifier_Term_Conditions_Ipv6_Protocol_Union `path:"state/protocol" module:"openconfig-qos/openconfig-qos"`
	SourceAddress        *string                                            `path:"state/source-address" module:"openconfig-qos/openconfig-qos"`
	SourceFlowLabel      *uint32                                            `path:"state/source-flow-label" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Conditions_L2 struct {
	DestinationMac     *string                                           `path:"state/destination-mac" module:"openconfig-qos/openconfig-qos"`
	DestinationMacMask *string                                           `path:"state/destination-mac-mask" module:"openconfig-qos/openconfig-qos"`
	Ethertype          Qos_Classifier_Term_Conditions_L2_Ethertype_Union `path:"state/ethertype" module:"openconfig-qos/openconfig-qos"`
	SourceMac          *string                                           `path:"state/source-mac" module:"openconfig-qos/openconfig-qos"`
	SourceMacMask      *string                                           `path:"state/source-mac-mask" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Conditions_Mpls struct {
	EndLabelValue   Qos_Classifier_Term_Conditions_Mpls_EndLabelValue_Union   `path:"state/end-label-value" module:"openconfig-qos/openconfig-qos"`
	StartLabelValue Qos_Classifier_Term_Conditions_Mpls_StartLabelValue_Union `path:"state/start-label-value" module:"openconfig-qos/openconfig-qos"`
	TrafficClass    *uint8                                                    `path:"state/traffic-class" module:"openconfig-qos/openconfig-qos"`
	TtlValue        *uint8                                                    `path:"state/ttl-value" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Classifier_Term_Conditions_Transport struct {
	DestinationPort Qos_Classifier_Term_Conditions_Transport_DestinationPort_Union `path:"state/destination-port" module:"openconfig-qos/openconfig-qos"`
	SourcePort      Qos_Classifier_Term_Conditions_Transport_SourcePort_Union      `path:"state/source-port" module:"openconfig-qos/openconfig-qos"`
	TcpFlags        []E_PacketMatchTypes_TCP_FLAGS                                 `path:"state/tcp-flags" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_ForwardingGroup struct {
	FabricPriority       *uint8  `path:"state/fabric-priority" module:"openconfig-qos/openconfig-qos"`
	MulticastOutputQueue *string `path:"state/multicast-output-queue" module:"openconfig-qos/openconfig-qos"`
	Name                 *string `path:"state/name|name" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
	OutputQueue          *string `path:"state/output-queue" module:"openconfig-qos/openconfig-qos"`
	UnicastOutputQueue   *string `path:"state/unicast-output-queue" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Interface struct {
	...
	InterfaceId  *string                     `path:"state/interface-id|interface-id" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
...
type Qos_Interface_Input struct {
	BufferAllocationProfile          *string                                                     `path:"state/buffer-allocation-profile" module:"openconfig-qos/openconfig-qos"`
	...
	MulticastBufferAllocationProfile *string                                                     `path:"state/multicast-buffer-allocation-profile" module:"openconfig-qos/openconfig-qos"`
	...
	UnicastBufferAllocationProfile   *string                                                     `path:"state/unicast-buffer-allocation-profile" module:"openconfig-qos/openconfig-qos"`
...
type Qos_Interface_Input_Classifier struct {
	...
	Type E_Input_Classifier_Type                         `path:"state/type|type" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
}
