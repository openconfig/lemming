...
This package was generated by /usr/local/google/home/wenbli/gocode/pkg/mod/github.com/openconfig/ygot@v0.15.1/genutil/names.go
...
type LocalRoutes_Aggregate struct {
	Description *string                            `path:"state/description" module:"openconfig-local-routing/openconfig-local-routing"`
	Discard     *bool                              `path:"state/discard" module:"openconfig-local-routing/openconfig-local-routing"`
	Prefix      *string                            `path:"state/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Aggregate_SetTag_Union `path:"state/set-tag" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static struct {
	...
	Prefix      *string                                `path:"state/prefix|prefix" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	SetTag      LocalRoutes_Static_SetTag_Union        `path:"state/set-tag" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop struct {
	...
	Index        *string                                  `path:"state/index|index" module:"openconfig-local-routing/openconfig-local-routing|openconfig-local-routing"`
	InterfaceRef *LocalRoutes_Static_NextHop_InterfaceRef `path:"interface-ref" module:"openconfig-local-routing"`
	Metric       *uint32                                  `path:"state/metric" module:"openconfig-local-routing/openconfig-local-routing"`
	NextHop      LocalRoutes_Static_NextHop_NextHop_Union `path:"state/next-hop" module:"openconfig-local-routing/openconfig-local-routing"`
	Recurse      *bool                                    `path:"state/recurse" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_EnableBfd struct {
	Enabled *bool `path:"state/enabled" module:"openconfig-local-routing/openconfig-local-routing"`
}
...
type LocalRoutes_Static_NextHop_InterfaceRef struct {
	Interface    *string `path:"state/interface" module:"openconfig-local-routing/openconfig-local-routing"`
	Subinterface *uint32 `path:"state/subinterface" module:"openconfig-local-routing/openconfig-local-routing"`
}
