...
type NetworkInstance_Protocol_Bgp_Global_GracefulRestart struct {
	...
	StaleRoutesTime *float64 `path:"state/stale-routes-time" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_Timers struct {
	ConnectRetry                 *float64 `path:"state/connect-retry" module:"openconfig-network-instance/openconfig-network-instance"`
	HoldTime                     *float64 `path:"state/hold-time" module:"openconfig-network-instance/openconfig-network-instance"`
	KeepaliveInterval            *float64 `path:"state/keepalive-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	MinimumAdvertisementInterval *float64 `path:"state/minimum-advertisement-interval" module:"openconfig-network-instance/openconfig-network-instance"`
