...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_RouteSelectionOptions struct {
	AdvertiseInactiveRoutes *bool `path:"state/advertise-inactive-routes" module:"openconfig-network-instance/openconfig-network-instance"`
	AlwaysCompareMed        *bool `path:"state/always-compare-med" module:"openconfig-network-instance/openconfig-network-instance"`
	EnableAigp              *bool `path:"state/enable-aigp" module:"openconfig-network-instance/openconfig-network-instance"`
	ExternalCompareRouterId *bool `path:"state/external-compare-router-id" module:"openconfig-network-instance/openconfig-network-instance"`
	IgnoreAsPathLength      *bool `path:"state/ignore-as-path-length" module:"openconfig-network-instance/openconfig-network-instance"`
	IgnoreNextHopIgpMetric  *bool `path:"state/ignore-next-hop-igp-metric" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_UseMultiplePaths_Ebgp struct {
	AllowMultipleAs *bool   `path:"state/allow-multiple-as" module:"openconfig-network-instance/openconfig-network-instance"`
	MaximumPaths    *uint32 `path:"state/maximum-paths" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_Confederation struct {
	Identifier *uint32  `path:"state/identifier" module:"openconfig-network-instance/openconfig-network-instance"`
	MemberAs   []uint32 `path:"state/member-as" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_DefaultRouteDistance struct {
	ExternalRouteDistance *uint8 `path:"state/external-route-distance" module:"openconfig-network-instance/openconfig-network-instance"`
	InternalRouteDistance *uint8 `path:"state/internal-route-distance" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_DynamicNeighborPrefix struct {
	PeerGroup *string `path:"state/peer-group" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Global_GracefulRestart struct {
	...
	RestartTime     *uint16 `path:"state/restart-time" module:"openconfig-network-instance/openconfig-network-instance"`
	StaleRoutesTime *uint16 `path:"state/stale-routes-time" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor struct {
	...
	LocalAs                 *uint32                                                                     `path:"state/local-as" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	NeighborPort            *uint16                                                                     `path:"state/neighbor-port" module:"openconfig-network-instance/openconfig-network-instance"`
	PeerAs                  *uint32                                                                     `path:"state/peer-as" module:"openconfig-network-instance/openconfig-network-instance"`
	PeerGroup               *string                                                                     `path:"state/peer-group" module:"openconfig-network-instance/openconfig-network-instance"`
	PeerType                E_BgpTypes_PeerType                                                         `path:"state/peer-type" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	RemovePrivateAs         E_BgpTypes_RemovePrivateAsOption                                            `path:"state/remove-private-as" module:"openconfig-network-instance/openconfig-network-instance"`
	RouteFlapDamping        *bool                                                                       `path:"state/route-flap-damping" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	SendCommunity           E_BgpTypes_CommunityType                                                    `path:"state/send-community" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Neighbor_AsPathOptions struct {
	AllowOwnAs          *uint8 `path:"state/allow-own-as" module:"openconfig-network-instance/openconfig-network-instance"`
	DisablePeerAsFilter *bool  `path:"state/disable-peer-as-filter" module:"openconfig-network-instance/openconfig-network-instance"`
	ReplacePeerAs       *bool  `path:"state/replace-peer-as" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_EbgpMultihop struct {
	Enabled     *bool  `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
	MultihopTtl *uint8 `path:"state/multihop-ttl" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_ErrorHandling struct {
	...
	TreatAsWithdraw         *bool   `path:"state/treat-as-withdraw" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_LoggingOptions struct {
	LogNeighborStateChanges *bool `path:"state/log-neighbor-state-changes" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_RouteReflector struct {
	RouteReflectorClient    *bool                                                                              `path:"state/route-reflector-client" module:"openconfig-network-instance/openconfig-network-instance"`
	RouteReflectorClusterId NetworkInstance_Protocol_Bgp_Neighbor_RouteReflector_RouteReflectorClusterId_Union `path:"state/route-reflector-cluster-id" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Neighbor_Timers struct {
	ConnectRetry                 *uint16 `path:"state/connect-retry" module:"openconfig-network-instance/openconfig-network-instance"`
	HoldTime                     *uint16 `path:"state/hold-time" module:"openconfig-network-instance/openconfig-network-instance"`
	KeepaliveInterval            *uint16 `path:"state/keepalive-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	MinimumAdvertisementInterval *uint16 `path:"state/minimum-advertisement-interval" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Protocol_Bgp_Neighbor_Transport struct {
	...
	MtuDiscovery  *bool   `path:"state/mtu-discovery" module:"openconfig-network-instance/openconfig-network-instance"`
	PassiveMode   *bool   `path:"state/passive-mode" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	TcpMss        *uint16 `path:"state/tcp-mss" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_PeerGroup struct {
	...
	PeerAs           *uint32                                                                      `path:"state/peer-as" module:"openconfig-network-instance/openconfig-network-instance"`
	PeerGroupName    *string                                                                      `path:"state/peer-group-name|peer-group-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	PeerType         E_BgpTypes_PeerType                                                          `path:"state/peer-type" module:"openconfig-network-instance/openconfig-network-instance"`
	RemovePrivateAs  E_BgpTypes_RemovePrivateAsOption                                             `path:"state/remove-private-as" module:"openconfig-network-instance/openconfig-network-instance"`
	RouteFlapDamping *bool                                                                        `path:"state/route-flap-damping" module:"openconfig-network-instance/openconfig-network-instance"`
