...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_Tunnel_P2PTunnelAttributes_P2PPrimaryPath_CandidateSecondaryPath struct {
	...
	Priority      *uint16 `path:"state/priority" module:"openconfig-network-instance/openconfig-network-instance"`
	SecondaryPath *string `path:"state/secondary-path|secondary-path" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_ConstrainedPath_Tunnel_P2PTunnelAttributes_P2PPrimaryPath_PathMetricBoundConstraint struct {
	MetricUpperBound *uint64                      `path:"state/metric-upper-bound" module:"openconfig-network-instance/openconfig-network-instance"`
	Type             E_MplsTypes_PATH_METRIC_TYPE `path:"state/type|type" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Egress struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Egress_IncomingLabel_Union `path:"state/incoming-label" module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                        `path:"state/next-hop" module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Egress_PushLabel_Union     `path:"state/push-label" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Ingress struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_IncomingLabel_Union `path:"state/incoming-label" module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                         `path:"state/next-hop" module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_PushLabel_Union     `path:"state/push-label" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_Lsps_StaticLsp_Transit struct {
	IncomingLabel NetworkInstance_Mpls_Lsps_StaticLsp_Transit_IncomingLabel_Union `path:"state/incoming-label" module:"openconfig-network-instance/openconfig-network-instance"`
	NextHop       *string                                                         `path:"state/next-hop" module:"openconfig-network-instance/openconfig-network-instance"`
	PushLabel     NetworkInstance_Mpls_Lsps_StaticLsp_Transit_PushLabel_Union     `path:"state/push-label" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Global struct {
	...
	LsrId           *string                                                             `path:"state/lsr-id" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Global_GracefulRestart struct {
	...
	ForwardingHoldtime *uint16 `path:"state/forwarding-holdtime" module:"openconfig-network-instance/openconfig-network-instance"`
	HelperEnable       *bool   `path:"state/helper-enable" module:"openconfig-network-instance/openconfig-network-instance"`
	ReconnectTime      *uint16 `path:"state/reconnect-time" module:"openconfig-network-instance/openconfig-network-instance"`
	RecoveryTime       *uint16 `path:"state/recovery-time" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_InterfaceAttributes struct {
	HelloHoldtime *uint16                                                                               `path:"state/hello-holdtime" module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval *uint16                                                                               `path:"state/hello-interval" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_InterfaceAttributes_Interface_AddressFamily struct {
	AfiName E_MplsLdp_MplsLdpAfi `path:"state/afi-name|afi-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Enabled *bool                `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Neighbor struct {
	...
	LabelSpaceId   *uint16                                                                                                                                          `path:"state/label-space-id|label-space-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	LsrId          *string                                                                                                                                          `path:"state/lsr-id|lsr-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Targeted struct {
	...
	HelloAccept   *bool                                                                                        `path:"state/hello-accept" module:"openconfig-network-instance/openconfig-network-instance"`
	HelloHoldtime *uint16                                                                                      `path:"state/hello-holdtime" module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval *uint16                                                                                      `path:"state/hello-interval" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_Ldp_Targeted_AddressFamily_Target struct {
	...
	HelloHoldtime *uint16 `path:"state/hello-holdtime" module:"openconfig-network-instance/openconfig-network-instance"`
	HelloInterval *uint16 `path:"state/hello-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	LocalAddress  *string `path:"state/local-address" module:"openconfig-network-instance/openconfig-network-instance"`
	RemoteAddress *string `path:"state/remote-address|remote-address" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Global_GracefulRestart struct {
	Enable       *bool   `path:"state/enable" module:"openconfig-network-instance/openconfig-network-instance"`
	RecoveryTime *uint32 `path:"state/recovery-time" module:"openconfig-network-instance/openconfig-network-instance"`
	RestartTime  *uint32 `path:"state/restart-time" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Global_SoftPreemption struct {
	Enable                *bool   `path:"state/enable" module:"openconfig-network-instance/openconfig-network-instance"`
	SoftPreemptionTimeout *uint16 `path:"state/soft-preemption-timeout" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_Authentication struct {
	AuthenticationKey  *string                    `path:"state/authentication-key" module:"openconfig-network-instance/openconfig-network-instance"`
	AuthenticationType E_MplsTypes_RSVP_AUTH_TYPE `path:"state/authentication-type" module:"openconfig-network-instance/openconfig-network-instance"`
	Enable             *bool                      `path:"state/enable" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_Protection struct {
	BypassOptimizeInterval       *uint16                     `path:"state/bypass-optimize-interval" module:"openconfig-network-instance/openconfig-network-instance"`
	LinkProtectionStyleRequested E_MplsTypes_PROTECTION_TYPE `path:"state/link-protection-style-requested" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_SignalingProtocols_RsvpTe_Interface_Subscription struct {
	...
	Subscription                     *uint8  `path:"state/subscription" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_AdminGroup struct {
	AdminGroupName *string `path:"state/admin-group-name|admin-group-name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	BitPosition    *uint32 `path:"state/bit-position" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_Srlg struct {
	Cost         *uint32                                                              `path:"state/cost" module:"openconfig-network-instance/openconfig-network-instance"`
	FloodingType E_Mpls_MplsSrlgFloodingType                                          `path:"state/flooding-type" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	Name         *string                                                              `path:"state/name|name" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	Value        *uint32                                                              `path:"state/value" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_Srlg_MembersList struct {
	FromAddress *string `path:"state/from-address|from-address" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	ToAddress   *string `path:"state/to-address" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Mpls_TeGlobalAttributes_TeLspTimers struct {
	CleanupDelay    *uint16 `path:"state/cleanup-delay" module:"openconfig-network-instance/openconfig-network-instance"`
	InstallDelay    *uint16 `path:"state/install-delay" module:"openconfig-network-instance/openconfig-network-instance"`
...
type NetworkInstance_PolicyForwarding_PathSelectionGroup struct {
	GroupId *string  `path:"state/group-id|group-id" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
	MplsLsp []string `path:"state/mpls-lsp" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Action struct {
	...
	NextHop              *string                                                             `path:"state/next-hop" module:"openconfig-network-instance/openconfig-network-instance"`
	PathSelectionGroup   *string                                                             `path:"state/path-selection-group" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_PolicyForwarding_Policy_Rule_Transport struct {
	...
	TcpFlags        []E_PacketMatchTypes_TCP_FLAGS                                               `path:"state/tcp-flags" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol struct {
	...
	DefaultMetric *uint32                                        `path:"state/default-metric" module:"openconfig-network-instance/openconfig-network-instance"`
	Enabled       *bool                                          `path:"state/enabled" module:"openconfig-network-instance/openconfig-network-instance"`
	Identifier    E_PolicyTypes_INSTALL_PROTOCOL_TYPE            `path:"state/identifier|identifier" module:"openconfig-network-instance/openconfig-network-instance|openconfig-network-instance"`
...
type NetworkInstance_Protocol_Aggregate struct {
	...
	SetTag      NetworkInstance_Protocol_Aggregate_SetTag_Union `path:"state/set-tag" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_AddPaths struct {
	EligiblePrefixPolicy *string `path:"state/eligible-prefix-policy" module:"openconfig-network-instance/openconfig-network-instance"`
	Receive              *bool   `path:"state/receive" module:"openconfig-network-instance/openconfig-network-instance"`
	Send                 *bool   `path:"state/send" module:"openconfig-network-instance/openconfig-network-instance"`
	SendMax              *uint8  `path:"state/send-max" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_Ipv4LabeledUnicast_PrefixLimit struct {
	MaxPrefixes         *uint32 `path:"state/max-prefixes" module:"openconfig-network-instance/openconfig-network-instance"`
	PrefixLimitExceeded *bool   `path:"state/prefix-limit-exceeded" module:"openconfig-network-instance/openconfig-network-instance"`
	PreventTeardown     *bool   `path:"state/prevent-teardown" module:"openconfig-network-instance/openconfig-network-instance"`
	WarningThresholdPct *uint8  `path:"state/warning-threshold-pct" module:"openconfig-network-instance/openconfig-network-instance"`
}
...
type NetworkInstance_Protocol_Bgp_Global_AfiSafi_Ipv4Unicast struct {
	ExtendedNextHopEncoding *bool                                                                        `path:"state/extended-next-hop-encoding" module:"openconfig-network-instance/openconfig-network-instance"`
	...
	SendDefaultRoute        *bool                                                                        `path:"state/send-default-route" module:"openconfig-network-instance/openconfig-network-instance"`
}
