...
type Qos_Interface_Output_InterfaceRef struct {
	Interface    *string `path:"state/interface" module:"openconfig-qos/openconfig-qos"`
	Subinterface *uint32 `path:"state/subinterface" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_Interface_Output_Queue struct {
	...
	Name                   *string `path:"state/name|name" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
	QueueManagementProfile *string `path:"state/queue-management-profile" module:"openconfig-qos/openconfig-qos"`
...
type Qos_Interface_Output_SchedulerPolicy struct {
	Name      *string                                                    `path:"state/name" module:"openconfig-qos/openconfig-qos"`
...
type Qos_QueueManagementProfile_Red_Uniform struct {
	Drop         *bool   `path:"state/drop" module:"openconfig-qos/openconfig-qos"`
	EnableEcn    *bool   `path:"state/enable-ecn" module:"openconfig-qos/openconfig-qos"`
	MaxThreshold *uint64 `path:"state/max-threshold" module:"openconfig-qos/openconfig-qos"`
	MinThreshold *uint64 `path:"state/min-threshold" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_QueueManagementProfile_Wred_Uniform struct {
	Drop                      *bool   `path:"state/drop" module:"openconfig-qos/openconfig-qos"`
	EnableEcn                 *bool   `path:"state/enable-ecn" module:"openconfig-qos/openconfig-qos"`
	MaxDropProbabilityPercent *uint8  `path:"state/max-drop-probability-percent" module:"openconfig-qos/openconfig-qos"`
	MaxThreshold              *uint64 `path:"state/max-threshold" module:"openconfig-qos/openconfig-qos"`
	MinThreshold              *uint64 `path:"state/min-threshold" module:"openconfig-qos/openconfig-qos"`
	Weight                    *uint32 `path:"state/weight" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler struct {
	...
	Priority          E_Scheduler_Priority                             `path:"state/priority" module:"openconfig-qos/openconfig-qos"`
	Sequence          *uint32                                          `path:"state/sequence|sequence" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
	TwoRateThreeColor *Qos_SchedulerPolicy_Scheduler_TwoRateThreeColor `path:"two-rate-three-color" module:"openconfig-qos"`
	Type              E_QosTypes_QOS_SCHEDULER_TYPE                    `path:"state/type" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler_Input struct {
	Id        *string           `path:"state/id|id" module:"openconfig-qos/openconfig-qos|openconfig-qos"`
	InputType E_Input_InputType `path:"state/input-type" module:"openconfig-qos/openconfig-qos"`
	Queue     *string           `path:"state/queue" module:"openconfig-qos/openconfig-qos"`
	Weight    *uint64           `path:"state/weight" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler_OneRateTwoColor struct {
	Bc                   *uint32                                                      `path:"state/bc" module:"openconfig-qos/openconfig-qos"`
	Cir                  *uint64                                                      `path:"state/cir" module:"openconfig-qos/openconfig-qos"`
	CirPct               *uint8                                                       `path:"state/cir-pct" module:"openconfig-qos/openconfig-qos"`
	CirPctRemaining      *uint8                                                       `path:"state/cir-pct-remaining" module:"openconfig-qos/openconfig-qos"`
	...
	MaxQueueDepthBytes   *uint32                                                      `path:"state/max-queue-depth-bytes" module:"openconfig-qos/openconfig-qos"`
	MaxQueueDepthPackets *uint32                                                      `path:"state/max-queue-depth-packets" module:"openconfig-qos/openconfig-qos"`
	MaxQueueDepthPercent *uint8                                                       `path:"state/max-queue-depth-percent" module:"openconfig-qos/openconfig-qos"`
	QueuingBehavior      E_QosTypes_QueueBehavior                                     `path:"state/queuing-behavior" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler_OneRateTwoColor_ConformAction struct {
	SetDot1P  *uint8 `path:"state/set-dot1p" module:"openconfig-qos/openconfig-qos"`
	SetDscp   *uint8 `path:"state/set-dscp" module:"openconfig-qos/openconfig-qos"`
	SetMplsTc *uint8 `path:"state/set-mpls-tc" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler_Output struct {
	ChildScheduler *string             `path:"state/child-scheduler" module:"openconfig-qos/openconfig-qos"`
	OutputFwdGroup *string             `path:"state/output-fwd-group" module:"openconfig-qos/openconfig-qos"`
	OutputType     E_Output_OutputType `path:"state/output-type" module:"openconfig-qos/openconfig-qos"`
}
...
type Qos_SchedulerPolicy_Scheduler_TwoRateThreeColor struct {
	Bc              *uint32                                                        `path:"state/bc" module:"openconfig-qos/openconfig-qos"`
	Be              *uint32                                                        `path:"state/be" module:"openconfig-qos/openconfig-qos"`
	Cir             *uint64                                                        `path:"state/cir" module:"openconfig-qos/openconfig-qos"`
	CirPct          *uint8                                                         `path:"state/cir-pct" module:"openconfig-qos/openconfig-qos"`
	CirPctRemaining *uint8                                                         `path:"state/cir-pct-remaining" module:"openconfig-qos/openconfig-qos"`
	...
	Pir             *uint64                                                        `path:"state/pir" module:"openconfig-qos/openconfig-qos"`
	PirPct          *uint8                                                         `path:"state/pir-pct" module:"openconfig-qos/openconfig-qos"`
	PirPctRemaining *uint8                                                         `path:"state/pir-pct-remaining" module:"openconfig-qos/openconfig-qos"`
...
type RoutingPolicy_DefinedSets_BgpDefinedSets_AsPathSet struct {
	AsPathSetMember []string `path:"state/as-path-set-member" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	AsPathSetName   *string  `path:"state/as-path-set-name|as-path-set-name" module:"openconfig-bgp-policy/openconfig-bgp-policy|openconfig-bgp-policy"`
}
...
type RoutingPolicy_DefinedSets_BgpDefinedSets_CommunitySet struct {
	CommunityMember  []RoutingPolicy_DefinedSets_BgpDefinedSets_CommunitySet_CommunityMember_Union `path:"state/community-member" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	CommunitySetName *string                                                                       `path:"state/community-set-name|community-set-name" module:"openconfig-bgp-policy/openconfig-bgp-policy|openconfig-bgp-policy"`
	MatchSetOptions  E_PolicyTypes_MatchSetOptionsType                                             `path:"state/match-set-options" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_DefinedSets_BgpDefinedSets_ExtCommunitySet struct {
	ExtCommunityMember  []string                          `path:"state/ext-community-member" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	ExtCommunitySetName *string                           `path:"state/ext-community-set-name|ext-community-set-name" module:"openconfig-bgp-policy/openconfig-bgp-policy|openconfig-bgp-policy"`
	MatchSetOptions     E_PolicyTypes_MatchSetOptionsType `path:"state/match-set-options" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_DefinedSets_NeighborSet struct {
	Address []string `path:"state/address" module:"openconfig-routing-policy/openconfig-routing-policy"`
	Name    *string  `path:"state/name|name" module:"openconfig-routing-policy/openconfig-routing-policy|openconfig-routing-policy"`
}
...
type RoutingPolicy_DefinedSets_PrefixSet struct {
	Mode   E_PrefixSet_Mode                                                                               `path:"state/mode" module:"openconfig-routing-policy/openconfig-routing-policy"`
	Name   *string                                                                                        `path:"state/name|name" module:"openconfig-routing-policy/openconfig-routing-policy|openconfig-routing-policy"`
...
type RoutingPolicy_DefinedSets_PrefixSet_Prefix struct {
	IpPrefix        *string `path:"state/ip-prefix|ip-prefix" module:"openconfig-routing-policy/openconfig-routing-policy|openconfig-routing-policy"`
	MasklengthRange *string `path:"state/masklength-range|masklength-range" module:"openconfig-routing-policy/openconfig-routing-policy|openconfig-routing-policy"`
}
...
type RoutingPolicy_DefinedSets_TagSet struct {
	Name     *string                                           `path:"state/name|name" module:"openconfig-routing-policy/openconfig-routing-policy|openconfig-routing-policy"`
	TagValue []RoutingPolicy_DefinedSets_TagSet_TagValue_Union `path:"state/tag-value" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions struct {
	...
	PolicyResult E_RoutingPolicy_PolicyResultType                             `path:"state/policy-result" module:"openconfig-routing-policy/openconfig-routing-policy"`
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions struct {
	...
	SetLocalPref     *uint32                                                                       `path:"state/set-local-pref" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	SetMed           RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetMed_Union      `path:"state/set-med" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	SetNextHop       RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetNextHop_Union  `path:"state/set-next-hop" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	SetRouteOrigin   E_BgpTypes_BgpOriginAttrType                                                  `path:"state/set-route-origin" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetAsPathPrepend struct {
	Asn     *uint32 `path:"state/asn" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	RepeatN *uint8  `path:"state/repeat-n" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetCommunity struct {
	...
	Method    E_SetCommunity_Method                                                               `path:"state/method" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	Options   E_BgpPolicy_BgpSetCommunityOptionType                                               `path:"state/options" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetCommunity_Inline struct {
	Communities []RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetCommunity_Inline_Communities_Union `path:"state/communities" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetCommunity_Reference struct {
	CommunitySetRef *string `path:"state/community-set-ref" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetExtCommunity_Inline struct {
	Communities []RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetExtCommunity_Inline_Communities_Union `path:"state/communities" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetExtCommunity_Reference struct {
	ExtCommunitySetRef *string `path:"state/ext-community-set-ref" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_SetTag struct {
	...
	Mode      E_SetTag_Mode                                                      `path:"state/mode" module:"openconfig-routing-policy/openconfig-routing-policy"`
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_SetTag_Inline struct {
	Tag []RoutingPolicy_PolicyDefinition_Statement_Actions_SetTag_Inline_Tag_Union `path:"state/tag" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Actions_SetTag_Reference struct {
	TagSet *string `path:"state/tag-set" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions struct {
	...
	CallPolicy        *string                                                               `path:"state/call-policy" module:"openconfig-routing-policy/openconfig-routing-policy"`
	InstallProtocolEq E_PolicyTypes_INSTALL_PROTOCOL_TYPE                                   `path:"state/install-protocol-eq" module:"openconfig-routing-policy/openconfig-routing-policy"`
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_BgpConditions struct {
	AfiSafiIn       []E_BgpTypes_AFI_SAFI_TYPE                                                        `path:"state/afi-safi-in" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	...
	CommunitySet    *string                                                                           `path:"state/community-set" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	ExtCommunitySet *string                                                                           `path:"state/ext-community-set" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	LocalPrefEq     *uint32                                                                           `path:"state/local-pref-eq" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	...
	MedEq           *uint32                                                                           `path:"state/med-eq" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	NextHopIn       []string                                                                          `path:"state/next-hop-in" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	OriginEq        E_BgpTypes_BgpOriginAttrType                                                      `path:"state/origin-eq" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	RouteType       E_BgpConditions_RouteType                                                         `path:"state/route-type" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_BgpConditions_AsPathLength struct {
	Operator E_PolicyTypes_ATTRIBUTE_COMPARISON `path:"state/operator" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	Value    *uint32                            `path:"state/value" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_BgpConditions_MatchAsPathSet struct {
	AsPathSet       *string                           `path:"state/as-path-set" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
	MatchSetOptions E_PolicyTypes_MatchSetOptionsType `path:"state/match-set-options" module:"openconfig-bgp-policy/openconfig-bgp-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_MatchInterface struct {
	Interface    *string `path:"state/interface" module:"openconfig-routing-policy/openconfig-routing-policy"`
	Subinterface *uint32 `path:"state/subinterface" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_MatchNeighborSet struct {
	MatchSetOptions E_PolicyTypes_MatchSetOptionsRestrictedType `path:"state/match-set-options" module:"openconfig-routing-policy/openconfig-routing-policy"`
	NeighborSet     *string                                     `path:"state/neighbor-set" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type RoutingPolicy_PolicyDefinition_Statement_Conditions_MatchPrefixSet struct {
	MatchSetOptions E_PolicyTypes_MatchSetOptionsRestrictedType `path:"state/match-set-options" module:"openconfig-routing-policy/openconfig-routing-policy"`
	PrefixSet       *string                                     `path:"state/prefix-set" module:"openconfig-routing-policy/openconfig-routing-policy"`
}
...
type System struct {
	...
	DomainName      *string                                `path:"state/domain-name" module:"openconfig-system/openconfig-system"`
	Hostname        *string                                `path:"state/hostname" module:"openconfig-system/openconfig-system"`
	License         *System_License                        `path:"license" module:"openconfig-system"`
	Logging         *System_Logging                        `path:"logging" module:"openconfig-system"`
	LoginBanner     *string                                `path:"state/login-banner" module:"openconfig-system/openconfig-system"`
	Memory          *System_Memory                         `path:"memory" module:"openconfig-system"`
	Messages        *System_Messages                       `path:"messages" module:"openconfig-system"`
	MotdBanner      *string                                `path:"state/motd-banner" module:"openconfig-system/openconfig-system"`
...
type System_Aaa_Accounting struct {
	AccountingMethod []System_Aaa_Accounting_AccountingMethod_Union                        `path:"state/accounting-method" module:"openconfig-system/openconfig-system"`
...
type System_Aaa_Accounting_Event struct {
	EventType E_AaaTypes_AAA_ACCOUNTING_EVENT_TYPE `path:"state/event-type|event-type" module:"openconfig-system/openconfig-system|openconfig-system"`
	Record    E_Event_Record                       `path:"state/record" module:"openconfig-system/openconfig-system"`
}
...
type System_Aaa_Authentication struct {
	...
	AuthenticationMethod []System_Aaa_Authentication_AuthenticationMethod_Union `path:"state/authentication-method" module:"openconfig-system/openconfig-system"`
...
type System_Aaa_Authentication_AdminUser struct {
	AdminPassword       *string `path:"state/admin-password" module:"openconfig-system/openconfig-system"`
	AdminPasswordHashed *string `path:"state/admin-password-hashed" module:"openconfig-system/openconfig-system"`
...
type System_Aaa_Authentication_User struct {
	...
	Role           System_Aaa_Authentication_User_Role_Union `path:"state/role" module:"openconfig-system/openconfig-system"`
	SshKey         *string                                   `path:"state/ssh-key" module:"openconfig-system/openconfig-system"`
	Username       *string                                   `path:"state/username|username" module:"openconfig-system/openconfig-system|openconfig-system"`
}
...
type System_Aaa_Authorization struct {
	AuthorizationMethod []System_Aaa_Authorization_AuthorizationMethod_Union                        `path:"state/authorization-method" module:"openconfig-system/openconfig-system"`
...
type System_Aaa_Authorization_Event struct {
	EventType E_AaaTypes_AAA_AUTHORIZATION_EVENT_TYPE `path:"state/event-type|event-type" module:"openconfig-system/openconfig-system|openconfig-system"`
}
...
type System_Aaa_ServerGroup struct {
	...
	Type   E_AaaTypes_AAA_SERVER_TYPE                `path:"state/type" module:"openconfig-system/openconfig-system"`
}
...
type System_Aaa_ServerGroup_Server struct {
	Address            *string                               `path:"state/address|address" module:"openconfig-system/openconfig-system|openconfig-system"`
	...
	Timeout            *uint16                               `path:"state/timeout" module:"openconfig-system/openconfig-system"`
}
...
type System_Aaa_ServerGroup_Server_Radius struct {
	AcctPort           *uint16                                        `path:"state/acct-port" module:"openconfig-system/openconfig-system"`
	AuthPort           *uint16                                        `path:"state/auth-port" module:"openconfig-system/openconfig-system"`
	Counters           *System_Aaa_ServerGroup_Server_Radius_Counters `path:"state/counters" module:"openconfig-system/openconfig-system"`
	RetransmitAttempts *uint8                                         `path:"state/retransmit-attempts" module:"openconfig-system/openconfig-system"`
	SecretKey          *string                                        `path:"state/secret-key" module:"openconfig-system/openconfig-system"`
	SecretKeyHashed    *string                                        `path:"state/secret-key-hashed" module:"openconfig-system/openconfig-system"`
	SourceAddress      *string                                        `path:"state/source-address" module:"openconfig-system/openconfig-system"`
}
...
type System_Aaa_ServerGroup_Server_Tacacs struct {
	Port            *uint16 `path:"state/port" module:"openconfig-system/openconfig-system"`
	SecretKey       *string `path:"state/secret-key" module:"openconfig-system/openconfig-system"`
	SecretKeyHashed *string `path:"state/secret-key-hashed" module:"openconfig-system/openconfig-system"`
	SourceAddress   *string `path:"state/source-address" module:"openconfig-system/openconfig-system"`
}
...
type System_Clock struct {
	TimezoneName *string `path:"state/timezone-name" module:"openconfig-system/openconfig-system"`
}
...
type System_Dns struct {
	...
	Search    []string                         `path:"state/search" module:"openconfig-system/openconfig-system"`
...
type System_Dns_HostEntry struct {
	Alias       []string `path:"state/alias" module:"openconfig-system/openconfig-system"`
	Hostname    *string  `path:"state/hostname|hostname" module:"openconfig-system/openconfig-system|openconfig-system"`
	Ipv4Address []string `path:"state/ipv4-address" module:"openconfig-system/openconfig-system"`
	Ipv6Address []string `path:"state/ipv6-address" module:"openconfig-system/openconfig-system"`
}
...
type System_License_License struct {
	Active         *bool                                    `path:"state/active" module:"openconfig-system/openconfig-system"`
	...
	LicenseData    System_License_License_LicenseData_Union `path:"state/license-data" module:"openconfig-system/openconfig-system"`
	LicenseId      *string                                  `path:"state/license-id|license-id" module:"openconfig-system/openconfig-system|openconfig-system"`
...
type System_Logging_Console_Selector struct {
	Facility E_SystemLogging_SYSLOG_FACILITY `path:"state/facility|facility" module:"openconfig-system/openconfig-system|openconfig-system"`
	Severity E_SystemLogging_SyslogSeverity  `path:"state/severity|severity" module:"openconfig-system/openconfig-system|openconfig-system"`
}
...
type System_Logging_RemoteServer struct {
	Host          *string                                                                            `path:"state/host|host" module:"openconfig-system/openconfig-system|openconfig-system"`
	RemotePort    *uint16                                                                            `path:"state/remote-port" module:"openconfig-system/openconfig-system"`
...
type System_Messages struct {
	...
	Severity     E_SystemLogging_SyslogSeverity                             `path:"state/severity" module:"openconfig-system/openconfig-system"`
}
...
type System_Messages_DebugService struct {
	Enabled *bool                    `path:"state/enabled" module:"openconfig-system/openconfig-system"`
	Service E_Messages_DEBUG_SERVICE `path:"state/service|service" module:"openconfig-system/openconfig-system|openconfig-system"`
}
...
type System_Ntp struct {
	...
	EnableNtpAuth    *bool                         `path:"state/enable-ntp-auth" module:"openconfig-system/openconfig-system"`
	Enabled          *bool                         `path:"state/enabled" module:"openconfig-system/openconfig-system"`
	NtpKey           map[uint16]*System_Ntp_NtpKey `path:"ntp-keys/ntp-key" module:"openconfig-system/openconfig-system"`
	NtpSourceAddress *string                       `path:"state/ntp-source-address" module:"openconfig-system/openconfig-system"`
...
type System_Ntp_NtpKey struct {
	KeyId    *uint16                `path:"state/key-id|key-id" module:"openconfig-system/openconfig-system|openconfig-system"`
	KeyType  E_System_NTP_AUTH_TYPE `path:"state/key-type" module:"openconfig-system/openconfig-system"`
	KeyValue *string                `path:"state/key-value" module:"openconfig-system/openconfig-system"`
}
...
type System_Ntp_Server struct {
	Address         *string                  `path:"state/address|address" module:"openconfig-system/openconfig-system|openconfig-system"`
	AssociationType E_Server_AssociationType `path:"state/association-type" module:"openconfig-system/openconfig-system"`
	Iburst          *bool                    `path:"state/iburst" module:"openconfig-system/openconfig-system"`
	...
	Port            *uint16                  `path:"state/port" module:"openconfig-system/openconfig-system"`
	Prefer          *bool                    `path:"state/prefer" module:"openconfig-system/openconfig-system"`
	...
	Version         *uint8                   `path:"state/version" module:"openconfig-system/openconfig-system"`
}
...
type System_SshServer struct {
	Enable          *bool                       `path:"state/enable" module:"openconfig-system/openconfig-system"`
	ProtocolVersion E_SshServer_ProtocolVersion `path:"state/protocol-version" module:"openconfig-system/openconfig-system"`
	RateLimit       *uint16                     `path:"state/rate-limit" module:"openconfig-system/openconfig-system"`
	SessionLimit    *uint16                     `path:"state/session-limit" module:"openconfig-system/openconfig-system"`
	Timeout         *uint16                     `path:"state/timeout" module:"openconfig-system/openconfig-system"`
}
