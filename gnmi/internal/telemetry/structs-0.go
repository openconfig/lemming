...
type Acl_AclSet struct {
	...
	Description *string                         `path:"state/description" module:"openconfig-acl/openconfig-acl"`
	Name        *string                         `path:"state/name|name" module:"openconfig-acl/openconfig-acl|openconfig-acl"`
	Type        E_Acl_ACL_TYPE                  `path:"state/type|type" module:"openconfig-acl/openconfig-acl|openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_Actions struct {
	ForwardingAction E_Acl_FORWARDING_ACTION `path:"state/forwarding-action" module:"openconfig-acl/openconfig-acl"`
	LogAction        E_Acl_LOG_ACTION        `path:"state/log-action" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_InputInterface_InterfaceRef struct {
	Interface    *string `path:"state/interface" module:"openconfig-acl/openconfig-acl"`
	Subinterface *uint32 `path:"state/subinterface" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_Ipv4 struct {
	DestinationAddress *string                                 `path:"state/destination-address" module:"openconfig-acl/openconfig-acl"`
	Dscp               *uint8                                  `path:"state/dscp" module:"openconfig-acl/openconfig-acl"`
	DscpSet            []uint8                                 `path:"state/dscp-set" module:"openconfig-acl/openconfig-acl"`
	HopLimit           *uint8                                  `path:"state/hop-limit" module:"openconfig-acl/openconfig-acl"`
	Protocol           Acl_AclSet_AclEntry_Ipv4_Protocol_Union `path:"state/protocol" module:"openconfig-acl/openconfig-acl"`
	SourceAddress      *string                                 `path:"state/source-address" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_Ipv6 struct {
	DestinationAddress   *string                                 `path:"state/destination-address" module:"openconfig-acl/openconfig-acl"`
	DestinationFlowLabel *uint32                                 `path:"state/destination-flow-label" module:"openconfig-acl/openconfig-acl"`
	Dscp                 *uint8                                  `path:"state/dscp" module:"openconfig-acl/openconfig-acl"`
	DscpSet              []uint8                                 `path:"state/dscp-set" module:"openconfig-acl/openconfig-acl"`
	HopLimit             *uint8                                  `path:"state/hop-limit" module:"openconfig-acl/openconfig-acl"`
	Protocol             Acl_AclSet_AclEntry_Ipv6_Protocol_Union `path:"state/protocol" module:"openconfig-acl/openconfig-acl"`
	SourceAddress        *string                                 `path:"state/source-address" module:"openconfig-acl/openconfig-acl"`
	SourceFlowLabel      *uint32                                 `path:"state/source-flow-label" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_L2 struct {
	DestinationMac     *string                                `path:"state/destination-mac" module:"openconfig-acl/openconfig-acl"`
	DestinationMacMask *string                                `path:"state/destination-mac-mask" module:"openconfig-acl/openconfig-acl"`
	Ethertype          Acl_AclSet_AclEntry_L2_Ethertype_Union `path:"state/ethertype" module:"openconfig-acl/openconfig-acl"`
	SourceMac          *string                                `path:"state/source-mac" module:"openconfig-acl/openconfig-acl"`
	SourceMacMask      *string                                `path:"state/source-mac-mask" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_Mpls struct {
	EndLabelValue   Acl_AclSet_AclEntry_Mpls_EndLabelValue_Union   `path:"state/end-label-value" module:"openconfig-acl/openconfig-acl"`
	StartLabelValue Acl_AclSet_AclEntry_Mpls_StartLabelValue_Union `path:"state/start-label-value" module:"openconfig-acl/openconfig-acl"`
	TrafficClass    *uint8                                         `path:"state/traffic-class" module:"openconfig-acl/openconfig-acl"`
	TtlValue        *uint8                                         `path:"state/ttl-value" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_AclSet_AclEntry_Transport struct {
	DestinationPort Acl_AclSet_AclEntry_Transport_DestinationPort_Union `path:"state/destination-port" module:"openconfig-acl/openconfig-acl"`
	SourcePort      Acl_AclSet_AclEntry_Transport_SourcePort_Union      `path:"state/source-port" module:"openconfig-acl/openconfig-acl"`
	TcpFlags        []E_PacketMatchTypes_TCP_FLAGS                      `path:"state/tcp-flags" module:"openconfig-acl/openconfig-acl"`
}
...
type Acl_Interface struct {
	...
	Id            *string                                                          `path:"state/id|id" module:"openconfig-acl/openconfig-acl|openconfig-acl"`
...
type Acl_Interface_EgressAclSet struct {
	...
	SetName  *string                                         `path:"state/set-name|set-name" module:"openconfig-acl/openconfig-acl|openconfig-acl"`
	Type     E_Acl_ACL_TYPE                                  `path:"state/type|type" module:"openconfig-acl/openconfig-acl|openconfig-acl"`
}
...
type Component struct {
	...
	Name                 *string                                 `path:"state/name|name" module:"openconfig-platform/openconfig-platform|openconfig-platform"`
...
type Component_Port_BreakoutMode_Group struct {
	BreakoutSpeed       E_IfEthernet_ETHERNET_SPEED `path:"state/breakout-speed" module:"openconfig-platform-port/openconfig-platform-port"`
	Index               *uint8                      `path:"state/index|index" module:"openconfig-platform-port/openconfig-platform-port|openconfig-platform-port"`
	NumBreakouts        *uint8                      `path:"state/num-breakouts" module:"openconfig-platform-port/openconfig-platform-port"`
	NumPhysicalChannels *uint8                      `path:"state/num-physical-channels" module:"openconfig-platform-port/openconfig-platform-port"`
}
...
type Component_Property struct {
	...
	Name         *string                        `path:"state/name|name" module:"openconfig-platform/openconfig-platform|openconfig-platform"`
	Value        Component_Property_Value_Union `path:"state/value" module:"openconfig-platform/openconfig-platform"`
}
...
type Component_Transceiver struct {
	...
	Enabled                *bool                                               `path:"state/enabled" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	...
	EthernetPmdPreconf     E_TransportTypes_ETHERNET_PMD_TYPE                  `path:"state/ethernet-pmd-preconf" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	...
	FecMode                E_PlatformTypes_FEC_MODE_TYPE                       `path:"state/fec-mode" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	...
	FormFactorPreconf      E_TransportTypes_TRANSCEIVER_FORM_FACTOR_TYPE       `path:"state/form-factor-preconf" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	...
	ModuleFunctionalType   E_TransportTypes_TRANSCEIVER_MODULE_FUNCTIONAL_TYPE `path:"state/module-functional-type" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
...
type Component_Transceiver_Channel struct {
	AssociatedOpticalChannel *string                                                 `path:"state/associated-optical-channel" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	Description              *string                                                 `path:"state/description" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	Index                    *uint16                                                 `path:"state/index|index" module:"openconfig-platform-transceiver/openconfig-platform-transceiver|openconfig-platform-transceiver"`
	...
	TargetOutputPower        *float64                                                `path:"state/target-output-power" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
	...
	TxLaser                  *bool                                                   `path:"state/tx-laser" module:"openconfig-platform-transceiver/openconfig-platform-transceiver"`
}
...
type Interface_Subinterface_Ipv6_Autoconf struct {
	CreateGlobalAddresses      *bool   `path:"state/create-global-addresses" module:"openconfig-if-ip-ext/openconfig-if-ip-ext"`
	CreateTemporaryAddresses   *bool   `path:"state/create-temporary-addresses" module:"openconfig-if-ip-ext/openconfig-if-ip-ext"`
	TemporaryPreferredLifetime *uint32 `path:"state/temporary-preferred-lifetime" module:"openconfig-if-ip-ext/openconfig-if-ip-ext"`
	TemporaryValidLifetime     *uint32 `path:"state/temporary-valid-lifetime" module:"openconfig-if-ip-ext/openconfig-if-ip-ext"`
}
