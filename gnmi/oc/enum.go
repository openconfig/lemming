...
const (
	...
	// BgpPolicy_BgpNextHopType_Enum_PEER_ADDRESS corresponds to the value PEER_ADDRESS of BgpPolicy_BgpNextHopType_Enum
	BgpPolicy_BgpNextHopType_Enum_PEER_ADDRESS E_BgpPolicy_BgpNextHopType_Enum = 2
)

// E_BgpPolicy_BgpSetAigpAction is a derived int64 type which is used to represent
// the enumerated node BgpPolicy_BgpSetAigpAction. An additional value named
// BgpPolicy_BgpSetAigpAction_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BgpPolicy_BgpSetAigpAction int64

// IsYANGGoEnum ensures that BgpPolicy_BgpSetAigpAction implements the yang.GoEnum
// interface. This ensures that BgpPolicy_BgpSetAigpAction can be identified as a
// mapped type for a YANG enumeration.
func (E_BgpPolicy_BgpSetAigpAction) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BgpPolicy_BgpSetAigpAction.
func (E_BgpPolicy_BgpSetAigpAction) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_BgpPolicy_BgpSetAigpAction.
func (e E_BgpPolicy_BgpSetAigpAction) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BgpPolicy_BgpSetAigpAction")
}

const (
	// BgpPolicy_BgpSetAigpAction_UNSET corresponds to the value UNSET of BgpPolicy_BgpSetAigpAction
	BgpPolicy_BgpSetAigpAction_UNSET E_BgpPolicy_BgpSetAigpAction = 0
	// BgpPolicy_BgpSetAigpAction_SET corresponds to the value SET of BgpPolicy_BgpSetAigpAction
	BgpPolicy_BgpSetAigpAction_SET E_BgpPolicy_BgpSetAigpAction = 1
)
...
// E_GnsiAcctz_CmdService is a derived int64 type which is used to represent
// the enumerated node GnsiAcctz_CmdService. An additional value named
// GnsiAcctz_CmdService_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_GnsiAcctz_CmdService int64

// IsYANGGoEnum ensures that GnsiAcctz_CmdService implements the yang.GoEnum
// interface. This ensures that GnsiAcctz_CmdService can be identified as a
// mapped type for a YANG enumeration.
func (E_GnsiAcctz_CmdService) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  GnsiAcctz_CmdService.
func (E_GnsiAcctz_CmdService) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_GnsiAcctz_CmdService.
func (e E_GnsiAcctz_CmdService) String() string {
	return ygot.EnumLogString(e, int64(e), "E_GnsiAcctz_CmdService")
}

const (
	// GnsiAcctz_CmdService_UNSET corresponds to the value UNSET of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_UNSET E_GnsiAcctz_CmdService = 0
	// GnsiAcctz_CmdService_UNSPECIFIED corresponds to the value UNSPECIFIED of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_UNSPECIFIED E_GnsiAcctz_CmdService = 1
	// GnsiAcctz_CmdService_SHELL corresponds to the value SHELL of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_SHELL E_GnsiAcctz_CmdService = 2
	// GnsiAcctz_CmdService_CLI corresponds to the value CLI of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_CLI E_GnsiAcctz_CmdService = 3
	// GnsiAcctz_CmdService_WEBUI corresponds to the value WEBUI of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_WEBUI E_GnsiAcctz_CmdService = 4
	// GnsiAcctz_CmdService_RESTCONF corresponds to the value RESTCONF of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_RESTCONF E_GnsiAcctz_CmdService = 5
	// GnsiAcctz_CmdService_NETCONF corresponds to the value NETCONF of GnsiAcctz_CmdService
	GnsiAcctz_CmdService_NETCONF E_GnsiAcctz_CmdService = 6
)

// E_GnsiAcctz_GrpcService is a derived int64 type which is used to represent
// the enumerated node GnsiAcctz_GrpcService. An additional value named
// GnsiAcctz_GrpcService_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_GnsiAcctz_GrpcService int64

// IsYANGGoEnum ensures that GnsiAcctz_GrpcService implements the yang.GoEnum
// interface. This ensures that GnsiAcctz_GrpcService can be identified as a
// mapped type for a YANG enumeration.
func (E_GnsiAcctz_GrpcService) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  GnsiAcctz_GrpcService.
func (E_GnsiAcctz_GrpcService) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_GnsiAcctz_GrpcService.
func (e E_GnsiAcctz_GrpcService) String() string {
	return ygot.EnumLogString(e, int64(e), "E_GnsiAcctz_GrpcService")
}

const (
	// GnsiAcctz_GrpcService_UNSET corresponds to the value UNSET of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_UNSET E_GnsiAcctz_GrpcService = 0
	// GnsiAcctz_GrpcService_UNSPECIFIED corresponds to the value UNSPECIFIED of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_UNSPECIFIED E_GnsiAcctz_GrpcService = 1
	// GnsiAcctz_GrpcService_GNMI corresponds to the value GNMI of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_GNMI E_GnsiAcctz_GrpcService = 2
	// GnsiAcctz_GrpcService_GNOI corresponds to the value GNOI of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_GNOI E_GnsiAcctz_GrpcService = 3
	// GnsiAcctz_GrpcService_GNSI corresponds to the value GNSI of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_GNSI E_GnsiAcctz_GrpcService = 4
	// GnsiAcctz_GrpcService_GRIBI corresponds to the value GRIBI of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_GRIBI E_GnsiAcctz_GrpcService = 5
	// GnsiAcctz_GrpcService_P4RT corresponds to the value P4RT of GnsiAcctz_GrpcService
	GnsiAcctz_GrpcService_P4RT E_GnsiAcctz_GrpcService = 6
)
...
// E_GnsiAcctz_SessionService is a derived int64 type which is used to represent
// the enumerated node GnsiAcctz_SessionService. An additional value named
// GnsiAcctz_SessionService_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_GnsiAcctz_SessionService int64

// IsYANGGoEnum ensures that GnsiAcctz_SessionService implements the yang.GoEnum
// interface. This ensures that GnsiAcctz_SessionService can be identified as a
// mapped type for a YANG enumeration.
func (E_GnsiAcctz_SessionService) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  GnsiAcctz_SessionService.
func (E_GnsiAcctz_SessionService) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_GnsiAcctz_SessionService.
func (e E_GnsiAcctz_SessionService) String() string {
	return ygot.EnumLogString(e, int64(e), "E_GnsiAcctz_SessionService")
}

const (
	// GnsiAcctz_SessionService_UNSET corresponds to the value UNSET of GnsiAcctz_SessionService
	GnsiAcctz_SessionService_UNSET E_GnsiAcctz_SessionService = 0
	// GnsiAcctz_SessionService_UNSPECIFIED corresponds to the value UNSPECIFIED of GnsiAcctz_SessionService
	GnsiAcctz_SessionService_UNSPECIFIED E_GnsiAcctz_SessionService = 1
	// GnsiAcctz_SessionService_LOGIN corresponds to the value LOGIN of GnsiAcctz_SessionService
	GnsiAcctz_SessionService_LOGIN E_GnsiAcctz_SessionService = 2
	// GnsiAcctz_SessionService_LOGOUT corresponds to the value LOGOUT of GnsiAcctz_SessionService
	GnsiAcctz_SessionService_LOGOUT E_GnsiAcctz_SessionService = 3
)
...
const (
	...
	// IfEthernet_INTERFACE_FEC_FEC_RS544_2X_INTERLEAVE_CL172 corresponds to the value FEC_RS544_2X_INTERLEAVE_CL172 of IfEthernet_INTERFACE_FEC
	IfEthernet_INTERFACE_FEC_FEC_RS544_2X_INTERLEAVE_CL172 E_IfEthernet_INTERFACE_FEC = 6
	// IfEthernet_INTERFACE_FEC_FEC_RS544_2X_INTERLEAVE_ETC corresponds to the value FEC_RS544_2X_INTERLEAVE_ETC of IfEthernet_INTERFACE_FEC
	IfEthernet_INTERFACE_FEC_FEC_RS544_2X_INTERLEAVE_ETC E_IfEthernet_INTERFACE_FEC = 7
	// IfEthernet_INTERFACE_FEC_FEC_RS544_LOW_LATENCY corresponds to the value FEC_RS544_LOW_LATENCY of IfEthernet_INTERFACE_FEC
	IfEthernet_INTERFACE_FEC_FEC_RS544_LOW_LATENCY E_IfEthernet_INTERFACE_FEC = 8
)
...
// E_IsisTypes_MetricType is a derived int64 type which is used to represent
// the enumerated node IsisTypes_MetricType. An additional value named
// IsisTypes_MetricType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_IsisTypes_MetricType int64

// IsYANGGoEnum ensures that IsisTypes_MetricType implements the yang.GoEnum
// interface. This ensures that IsisTypes_MetricType can be identified as a
// mapped type for a YANG enumeration.
func (E_IsisTypes_MetricType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  IsisTypes_MetricType.
func (E_IsisTypes_MetricType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_IsisTypes_MetricType.
func (e E_IsisTypes_MetricType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_IsisTypes_MetricType")
}

const (
	// IsisTypes_MetricType_UNSET corresponds to the value UNSET of IsisTypes_MetricType
	IsisTypes_MetricType_UNSET E_IsisTypes_MetricType = 0
	// IsisTypes_MetricType_INTERNAL corresponds to the value INTERNAL of IsisTypes_MetricType
	IsisTypes_MetricType_INTERNAL E_IsisTypes_MetricType = 1
	// IsisTypes_MetricType_EXTERNAL corresponds to the value EXTERNAL of IsisTypes_MetricType
	IsisTypes_MetricType_EXTERNAL E_IsisTypes_MetricType = 2
)
...
// E_IsisTypes_SuppressInterfaceIpMode is a derived int64 type which is used to represent
// the enumerated node IsisTypes_SuppressInterfaceIpMode. An additional value named
// IsisTypes_SuppressInterfaceIpMode_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_IsisTypes_SuppressInterfaceIpMode int64

// IsYANGGoEnum ensures that IsisTypes_SuppressInterfaceIpMode implements the yang.GoEnum
// interface. This ensures that IsisTypes_SuppressInterfaceIpMode can be identified as a
// mapped type for a YANG enumeration.
func (E_IsisTypes_SuppressInterfaceIpMode) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  IsisTypes_SuppressInterfaceIpMode.
func (E_IsisTypes_SuppressInterfaceIpMode) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_IsisTypes_SuppressInterfaceIpMode.
func (e E_IsisTypes_SuppressInterfaceIpMode) String() string {
	return ygot.EnumLogString(e, int64(e), "E_IsisTypes_SuppressInterfaceIpMode")
}

const (
	// IsisTypes_SuppressInterfaceIpMode_UNSET corresponds to the value UNSET of IsisTypes_SuppressInterfaceIpMode
	IsisTypes_SuppressInterfaceIpMode_UNSET E_IsisTypes_SuppressInterfaceIpMode = 0
	// IsisTypes_SuppressInterfaceIpMode_NONE corresponds to the value NONE of IsisTypes_SuppressInterfaceIpMode
	IsisTypes_SuppressInterfaceIpMode_NONE E_IsisTypes_SuppressInterfaceIpMode = 1
	// IsisTypes_SuppressInterfaceIpMode_ALL corresponds to the value ALL of IsisTypes_SuppressInterfaceIpMode
	IsisTypes_SuppressInterfaceIpMode_ALL E_IsisTypes_SuppressInterfaceIpMode = 2
	// IsisTypes_SuppressInterfaceIpMode_NON_PASSIVE corresponds to the value NON_PASSIVE of IsisTypes_SuppressInterfaceIpMode
	IsisTypes_SuppressInterfaceIpMode_NON_PASSIVE E_IsisTypes_SuppressInterfaceIpMode = 3
	// IsisTypes_SuppressInterfaceIpMode_NON_PASSIVE_POINT_TO_POINT corresponds to the value NON_PASSIVE_POINT_TO_POINT of IsisTypes_SuppressInterfaceIpMode
	IsisTypes_SuppressInterfaceIpMode_NON_PASSIVE_POINT_TO_POINT E_IsisTypes_SuppressInterfaceIpMode = 4
)
...
// E_LldpTypes_MgmtInterfaceNumberSubtype is a derived int64 type which is used to represent
// the enumerated node LldpTypes_MgmtInterfaceNumberSubtype. An additional value named
// LldpTypes_MgmtInterfaceNumberSubtype_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_LldpTypes_MgmtInterfaceNumberSubtype int64

// IsYANGGoEnum ensures that LldpTypes_MgmtInterfaceNumberSubtype implements the yang.GoEnum
// interface. This ensures that LldpTypes_MgmtInterfaceNumberSubtype can be identified as a
// mapped type for a YANG enumeration.
func (E_LldpTypes_MgmtInterfaceNumberSubtype) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  LldpTypes_MgmtInterfaceNumberSubtype.
func (E_LldpTypes_MgmtInterfaceNumberSubtype) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_LldpTypes_MgmtInterfaceNumberSubtype.
func (e E_LldpTypes_MgmtInterfaceNumberSubtype) String() string {
	return ygot.EnumLogString(e, int64(e), "E_LldpTypes_MgmtInterfaceNumberSubtype")
}

const (
	// LldpTypes_MgmtInterfaceNumberSubtype_UNSET corresponds to the value UNSET of LldpTypes_MgmtInterfaceNumberSubtype
	LldpTypes_MgmtInterfaceNumberSubtype_UNSET E_LldpTypes_MgmtInterfaceNumberSubtype = 0
	// LldpTypes_MgmtInterfaceNumberSubtype_UNKNOWN corresponds to the value UNKNOWN of LldpTypes_MgmtInterfaceNumberSubtype
	LldpTypes_MgmtInterfaceNumberSubtype_UNKNOWN E_LldpTypes_MgmtInterfaceNumberSubtype = 2
	// LldpTypes_MgmtInterfaceNumberSubtype_IFINDEX corresponds to the value IFINDEX of LldpTypes_MgmtInterfaceNumberSubtype
	LldpTypes_MgmtInterfaceNumberSubtype_IFINDEX E_LldpTypes_MgmtInterfaceNumberSubtype = 3
	// LldpTypes_MgmtInterfaceNumberSubtype_SYSTEM_PORT_NUMBER corresponds to the value SYSTEM_PORT_NUMBER of LldpTypes_MgmtInterfaceNumberSubtype
	LldpTypes_MgmtInterfaceNumberSubtype_SYSTEM_PORT_NUMBER E_LldpTypes_MgmtInterfaceNumberSubtype = 4
)
...
const (
	...
	// MplsTypes_TUNNEL_TYPE_BYPASS_P2P corresponds to the value BYPASS_P2P of MplsTypes_TUNNEL_TYPE
	MplsTypes_TUNNEL_TYPE_BYPASS_P2P E_MplsTypes_TUNNEL_TYPE = 1
	// MplsTypes_TUNNEL_TYPE_P2MP corresponds to the value P2MP of MplsTypes_TUNNEL_TYPE
	MplsTypes_TUNNEL_TYPE_P2MP E_MplsTypes_TUNNEL_TYPE = 2
	// MplsTypes_TUNNEL_TYPE_P2P corresponds to the value P2P of MplsTypes_TUNNEL_TYPE
	MplsTypes_TUNNEL_TYPE_P2P E_MplsTypes_TUNNEL_TYPE = 3
)
...
// E_PacketMatchTypes_FragmentOffsetRange_Enum is a derived int64 type which is used to represent
// the enumerated node PacketMatchTypes_FragmentOffsetRange_Enum. An additional value named
// PacketMatchTypes_FragmentOffsetRange_Enum_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_PacketMatchTypes_FragmentOffsetRange_Enum int64

// IsYANGGoEnum ensures that PacketMatchTypes_FragmentOffsetRange_Enum implements the yang.GoEnum
// interface. This ensures that PacketMatchTypes_FragmentOffsetRange_Enum can be identified as a
// mapped type for a YANG enumeration.
func (E_PacketMatchTypes_FragmentOffsetRange_Enum) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  PacketMatchTypes_FragmentOffsetRange_Enum.
func (E_PacketMatchTypes_FragmentOffsetRange_Enum) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_PacketMatchTypes_FragmentOffsetRange_Enum.
func (e E_PacketMatchTypes_FragmentOffsetRange_Enum) String() string {
	return ygot.EnumLogString(e, int64(e), "E_PacketMatchTypes_FragmentOffsetRange_Enum")
}

const (
	// PacketMatchTypes_FragmentOffsetRange_Enum_UNSET corresponds to the value UNSET of PacketMatchTypes_FragmentOffsetRange_Enum
	PacketMatchTypes_FragmentOffsetRange_Enum_UNSET E_PacketMatchTypes_FragmentOffsetRange_Enum = 0
	// PacketMatchTypes_FragmentOffsetRange_Enum_ANY corresponds to the value ANY of PacketMatchTypes_FragmentOffsetRange_Enum
	PacketMatchTypes_FragmentOffsetRange_Enum_ANY E_PacketMatchTypes_FragmentOffsetRange_Enum = 1
)
...
// E_PlatformTypes_ComponentPowerType is a derived int64 type which is used to represent
// the enumerated node PlatformTypes_ComponentPowerType. An additional value named
// PlatformTypes_ComponentPowerType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_PlatformTypes_ComponentPowerType int64

// IsYANGGoEnum ensures that PlatformTypes_ComponentPowerType implements the yang.GoEnum
// interface. This ensures that PlatformTypes_ComponentPowerType can be identified as a
// mapped type for a YANG enumeration.
func (E_PlatformTypes_ComponentPowerType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  PlatformTypes_ComponentPowerType.
func (E_PlatformTypes_ComponentPowerType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_PlatformTypes_ComponentPowerType.
func (e E_PlatformTypes_ComponentPowerType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_PlatformTypes_ComponentPowerType")
}

const (
	// PlatformTypes_ComponentPowerType_UNSET corresponds to the value UNSET of PlatformTypes_ComponentPowerType
	PlatformTypes_ComponentPowerType_UNSET E_PlatformTypes_ComponentPowerType = 0
	// PlatformTypes_ComponentPowerType_POWER_ENABLED corresponds to the value POWER_ENABLED of PlatformTypes_ComponentPowerType
	PlatformTypes_ComponentPowerType_POWER_ENABLED E_PlatformTypes_ComponentPowerType = 1
	// PlatformTypes_ComponentPowerType_POWER_DISABLED corresponds to the value POWER_DISABLED of PlatformTypes_ComponentPowerType
	PlatformTypes_ComponentPowerType_POWER_DISABLED E_PlatformTypes_ComponentPowerType = 2
)
...
const (
	...
	// PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_MIDPLANE corresponds to the value MIDPLANE of PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_MIDPLANE E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 13
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_OPTICAL_CHANNEL E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 14
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_PORT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 15
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_POWER_SUPPLY E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 16
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_SENSOR E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 17
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_STORAGE E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 18
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_TRANSCEIVER E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 19
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_USB_PORT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 20
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_WIFI_ACCESS_POINT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 21
)
...
// E_PolicyForwarding_FORWARDING_ACTION is a derived int64 type which is used to represent
// the enumerated node PolicyForwarding_FORWARDING_ACTION. An additional value named
// PolicyForwarding_FORWARDING_ACTION_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_PolicyForwarding_FORWARDING_ACTION int64

// IsYANGGoEnum ensures that PolicyForwarding_FORWARDING_ACTION implements the yang.GoEnum
// interface. This ensures that PolicyForwarding_FORWARDING_ACTION can be identified as a
// mapped type for a YANG enumeration.
func (E_PolicyForwarding_FORWARDING_ACTION) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  PolicyForwarding_FORWARDING_ACTION.
func (E_PolicyForwarding_FORWARDING_ACTION) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_PolicyForwarding_FORWARDING_ACTION.
func (e E_PolicyForwarding_FORWARDING_ACTION) String() string {
	return ygot.EnumLogString(e, int64(e), "E_PolicyForwarding_FORWARDING_ACTION")
}

const (
	// PolicyForwarding_FORWARDING_ACTION_UNSET corresponds to the value UNSET of PolicyForwarding_FORWARDING_ACTION
	PolicyForwarding_FORWARDING_ACTION_UNSET E_PolicyForwarding_FORWARDING_ACTION = 0
	// PolicyForwarding_FORWARDING_ACTION_DROP corresponds to the value DROP of PolicyForwarding_FORWARDING_ACTION
	PolicyForwarding_FORWARDING_ACTION_DROP E_PolicyForwarding_FORWARDING_ACTION = 1
	// PolicyForwarding_FORWARDING_ACTION_FORWARD corresponds to the value FORWARD of PolicyForwarding_FORWARDING_ACTION
	PolicyForwarding_FORWARDING_ACTION_FORWARD E_PolicyForwarding_FORWARDING_ACTION = 2
	// PolicyForwarding_FORWARDING_ACTION_REJECT corresponds to the value REJECT of PolicyForwarding_FORWARDING_ACTION
	PolicyForwarding_FORWARDING_ACTION_REJECT E_PolicyForwarding_FORWARDING_ACTION = 3
)
...
// E_Snmp_SNMP_NOTIFICATION_EVENT is a derived int64 type which is used to represent
// the enumerated node Snmp_SNMP_NOTIFICATION_EVENT. An additional value named
// Snmp_SNMP_NOTIFICATION_EVENT_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Snmp_SNMP_NOTIFICATION_EVENT int64

// IsYANGGoEnum ensures that Snmp_SNMP_NOTIFICATION_EVENT implements the yang.GoEnum
// interface. This ensures that Snmp_SNMP_NOTIFICATION_EVENT can be identified as a
// mapped type for a YANG enumeration.
func (E_Snmp_SNMP_NOTIFICATION_EVENT) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Snmp_SNMP_NOTIFICATION_EVENT.
func (E_Snmp_SNMP_NOTIFICATION_EVENT) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Snmp_SNMP_NOTIFICATION_EVENT.
func (e E_Snmp_SNMP_NOTIFICATION_EVENT) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Snmp_SNMP_NOTIFICATION_EVENT")
}

const (
	// Snmp_SNMP_NOTIFICATION_EVENT_UNSET corresponds to the value UNSET of Snmp_SNMP_NOTIFICATION_EVENT
	Snmp_SNMP_NOTIFICATION_EVENT_UNSET E_Snmp_SNMP_NOTIFICATION_EVENT = 0
	// Snmp_SNMP_NOTIFICATION_EVENT_ALL corresponds to the value ALL of Snmp_SNMP_NOTIFICATION_EVENT
	Snmp_SNMP_NOTIFICATION_EVENT_ALL E_Snmp_SNMP_NOTIFICATION_EVENT = 1
	// Snmp_SNMP_NOTIFICATION_EVENT_AUTHENTICATION corresponds to the value AUTHENTICATION of Snmp_SNMP_NOTIFICATION_EVENT
	Snmp_SNMP_NOTIFICATION_EVENT_AUTHENTICATION E_Snmp_SNMP_NOTIFICATION_EVENT = 2
	// Snmp_SNMP_NOTIFICATION_EVENT_LINE_STATUS corresponds to the value LINE_STATUS of Snmp_SNMP_NOTIFICATION_EVENT
	Snmp_SNMP_NOTIFICATION_EVENT_LINE_STATUS E_Snmp_SNMP_NOTIFICATION_EVENT = 3
)

// E_Snmp_SnmpAccessMode is a derived int64 type which is used to represent
// the enumerated node Snmp_SnmpAccessMode. An additional value named
// Snmp_SnmpAccessMode_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Snmp_SnmpAccessMode int64

// IsYANGGoEnum ensures that Snmp_SnmpAccessMode implements the yang.GoEnum
// interface. This ensures that Snmp_SnmpAccessMode can be identified as a
// mapped type for a YANG enumeration.
func (E_Snmp_SnmpAccessMode) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Snmp_SnmpAccessMode.
func (E_Snmp_SnmpAccessMode) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Snmp_SnmpAccessMode.
func (e E_Snmp_SnmpAccessMode) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Snmp_SnmpAccessMode")
}

const (
	// Snmp_SnmpAccessMode_UNSET corresponds to the value UNSET of Snmp_SnmpAccessMode
	Snmp_SnmpAccessMode_UNSET E_Snmp_SnmpAccessMode = 0
	// Snmp_SnmpAccessMode_READ_ONLY corresponds to the value READ_ONLY of Snmp_SnmpAccessMode
	Snmp_SnmpAccessMode_READ_ONLY E_Snmp_SnmpAccessMode = 1
	// Snmp_SnmpAccessMode_READ_WRITE corresponds to the value READ_WRITE of Snmp_SnmpAccessMode
	Snmp_SnmpAccessMode_READ_WRITE E_Snmp_SnmpAccessMode = 2
)

// E_Snmp_SnmpNotificationType is a derived int64 type which is used to represent
// the enumerated node Snmp_SnmpNotificationType. An additional value named
// Snmp_SnmpNotificationType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Snmp_SnmpNotificationType int64

// IsYANGGoEnum ensures that Snmp_SnmpNotificationType implements the yang.GoEnum
// interface. This ensures that Snmp_SnmpNotificationType can be identified as a
// mapped type for a YANG enumeration.
func (E_Snmp_SnmpNotificationType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Snmp_SnmpNotificationType.
func (E_Snmp_SnmpNotificationType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Snmp_SnmpNotificationType.
func (e E_Snmp_SnmpNotificationType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Snmp_SnmpNotificationType")
}

const (
	// Snmp_SnmpNotificationType_UNSET corresponds to the value UNSET of Snmp_SnmpNotificationType
	Snmp_SnmpNotificationType_UNSET E_Snmp_SnmpNotificationType = 0
	// Snmp_SnmpNotificationType_TRAP corresponds to the value TRAP of Snmp_SnmpNotificationType
	Snmp_SnmpNotificationType_TRAP E_Snmp_SnmpNotificationType = 1
	// Snmp_SnmpNotificationType_INFORM corresponds to the value INFORM of Snmp_SnmpNotificationType
	Snmp_SnmpNotificationType_INFORM E_Snmp_SnmpNotificationType = 2
)

// E_Snmp_SnmpVersion is a derived int64 type which is used to represent
// the enumerated node Snmp_SnmpVersion. An additional value named
// Snmp_SnmpVersion_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Snmp_SnmpVersion int64

// IsYANGGoEnum ensures that Snmp_SnmpVersion implements the yang.GoEnum
// interface. This ensures that Snmp_SnmpVersion can be identified as a
// mapped type for a YANG enumeration.
func (E_Snmp_SnmpVersion) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Snmp_SnmpVersion.
func (E_Snmp_SnmpVersion) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Snmp_SnmpVersion.
func (e E_Snmp_SnmpVersion) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Snmp_SnmpVersion")
}

const (
	// Snmp_SnmpVersion_UNSET corresponds to the value UNSET of Snmp_SnmpVersion
	Snmp_SnmpVersion_UNSET E_Snmp_SnmpVersion = 0
	// Snmp_SnmpVersion_V1 corresponds to the value V1 of Snmp_SnmpVersion
	Snmp_SnmpVersion_V1 E_Snmp_SnmpVersion = 1
	// Snmp_SnmpVersion_V2C corresponds to the value V2C of Snmp_SnmpVersion
	Snmp_SnmpVersion_V2C E_Snmp_SnmpVersion = 2
)
...
const (
	...
	// TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_2XFR4 corresponds to the value ETH_800GBASE_2XFR4 of TransportTypes_ETHERNET_PMD_TYPE
	TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_2XFR4 E_TransportTypes_ETHERNET_PMD_TYPE = 35
	// TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_DR8 corresponds to the value ETH_800GBASE_DR8 of TransportTypes_ETHERNET_PMD_TYPE
	TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_DR8 E_TransportTypes_ETHERNET_PMD_TYPE = 36
	...
	TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_ZR E_TransportTypes_ETHERNET_PMD_TYPE = 37
	...
	TransportTypes_ETHERNET_PMD_TYPE_ETH_UNDEFINED E_TransportTypes_ETHERNET_PMD_TYPE = 38
)
