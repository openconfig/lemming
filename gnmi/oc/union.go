...
// Union type can be one of [E_PacketMatchTypes_FragmentOffsetRange_Enum, UnionString, UnionUint16].
...
// Documentation_for_Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union ensures that E_PacketMatchTypes_FragmentOffsetRange_Enum
// implements the Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union interface.
func (E_PacketMatchTypes_FragmentOffsetRange_Enum) Documentation_for_Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union() {
}
...
func (t *Acl_AclSet_AclEntry_Ipv4) To_Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union(i interface{}) (Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to Acl_AclSet_AclEntry_Ipv4_FragmentOffsets_Union, unknown union type, got: %T, want any of [E_PacketMatchTypes_FragmentOffsetRange_Enum, string, uint16]", i, i)
}
...
// Documentation_for_DefinedSets_PortSet_ExcludePort_Union ensures that E_PacketMatchTypes_PortNumRange_Enum
// implements the DefinedSets_PortSet_ExcludePort_Union interface.
func (E_PacketMatchTypes_PortNumRange_Enum) Documentation_for_DefinedSets_PortSet_ExcludePort_Union() {
}
...
func (t *DefinedSets_PortSet) To_DefinedSets_PortSet_ExcludePort_Union(i interface{}) (DefinedSets_PortSet_ExcludePort_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to DefinedSets_PortSet_ExcludePort_Union, unknown union type, got: %T, want any of [E_PacketMatchTypes_PortNumRange_Enum, string, uint16]", i, i)
}
...
// NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-network-instance/network-instances/network-instance/afts/mpls/label-entry/decap-mpls-label-stacks/decap-mpls-label-stack/state/label within the YANG schema.
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32].
type NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union interface {
	// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union()
}

// Documentation_for_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union() {
}

// Documentation_for_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union ensures that UnionUint32
// implements the NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union interface.
func (UnionUint32) Documentation_for_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union() {
}

// To_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union takes an input interface{} and attempts to convert it to a struct
// which implements the NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack) To_NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union(i interface{}) (NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union, error) {
	if v, ok := i.(NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Afts_LabelEntry_DecapMplsLabelStack_Label_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_MplsLabelStack_Union ensures that E_MplsTypes_MplsLabel_Enum
...
func (t *NetworkInstance_Afts_NextHop_EncapHeader_Mpls) To_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_MplsLabelStack_Union(i interface{}) (NetworkInstance_Afts_NextHop_EncapHeader_Mpls_MplsLabelStack_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Afts_NextHop_EncapHeader_Mpls_MplsLabelStack_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}

// NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-network-instance/network-instances/network-instance/afts/next-hops/next-hop/encap-headers/encap-header/mpls/encap-mpls-label-stacks/encap-mpls-label-stack/state/label within the YANG schema.
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32].
type NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union interface {
	// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union()
}

// Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union() {
}

// Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union ensures that UnionUint32
// implements the NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union interface.
func (UnionUint32) Documentation_for_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union() {
}

// To_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union takes an input interface{} and attempts to convert it to a struct
// which implements the NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack) To_NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union(i interface{}) (NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union, error) {
	if v, ok := i.(NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Afts_NextHop_EncapHeader_Mpls_EncapMplsLabelStack_Label_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union() {
}
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop) To_NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Egress_LspNextHop_PushLabel_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union() {
}
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop) To_NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Ingress_LspNextHop_PushLabel_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union() {
}
...
func (t *NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop) To_NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union(i interface{}) (NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Mpls_Lsps_StaticLsp_Transit_LspNextHop_PushLabel_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union ensures that E_PacketMatchTypes_FragmentOffsetRange_Enum
// implements the NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union interface.
func (E_PacketMatchTypes_FragmentOffsetRange_Enum) Documentation_for_NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union() {
}
...
func (t *NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4) To_NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union(i interface{}) (NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_PolicyForwarding_Policy_Rule_Ipv4_FragmentOffsets_Union, unknown union type, got: %T, want any of [E_PacketMatchTypes_FragmentOffsetRange_Enum, string, uint16]", i, i)
}
...
// NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union is an interface that is implemented by valid types for the union
// for the leaf /openconfig-network-instance/network-instances/network-instance/segment-routing/te-policies/te-policy/candidate-paths/candidate-path/segment-lists/segment-list/next-hops/next-hop/encap-mpls-label-stacks/encap-mpls-label-stack/state/label within the YANG schema.
// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32].
type NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union interface {
	// Union type can be one of [E_MplsTypes_MplsLabel_Enum, UnionUint32]
	Documentation_for_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union()
}

// Documentation_for_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union() {
}

// Documentation_for_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union ensures that UnionUint32
// implements the NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union interface.
func (UnionUint32) Documentation_for_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union() {
}

// To_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union takes an input interface{} and attempts to convert it to a struct
// which implements the NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack) To_NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union(i interface{}) (NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union, error) {
	if v, ok := i.(NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union); ok {
		return v, nil
	}
	switch v := i.(type) {
	case uint32:
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_SegmentRouting_TePolicy_CandidatePath_SegmentList_NextHop_EncapMplsLabelStack_Label_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union ensures that E_MplsTypes_MplsLabel_Enum
// implements the NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union interface.
func (E_MplsTypes_MplsLabel_Enum) Documentation_for_NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union() {
}
...
func (t *NetworkInstance_Static_NextHop_EncapHeader_Mpls) To_NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union(i interface{}) (NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to NetworkInstance_Static_NextHop_EncapHeader_Mpls_Label_Union, unknown union type, got: %T, want any of [E_MplsTypes_MplsLabel_Enum, uint32]", i, i)
}
...
// Documentation_for_Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union ensures that E_PacketMatchTypes_FragmentOffsetRange_Enum
// implements the Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union interface.
func (E_PacketMatchTypes_FragmentOffsetRange_Enum) Documentation_for_Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union() {
}
...
func (t *Qos_Classifier_Term_Conditions_Ipv4) To_Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union(i interface{}) (Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to Qos_Classifier_Term_Conditions_Ipv4_FragmentOffsets_Union, unknown union type, got: %T, want any of [E_PacketMatchTypes_FragmentOffsetRange_Enum, string, uint16]", i, i)
}
...
// Union type can be one of [E_BgpPolicy_BgpSetMedType_Enum, UnionUint32].
...
func (t *RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions) To_RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetMed_Union(i interface{}) (RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetMed_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to RoutingPolicy_PolicyDefinition_Statement_Actions_BgpActions_SetMed_Union, unknown union type, got: %T, want any of [E_BgpPolicy_BgpSetMedType_Enum, uint32]", i, i)
}
...
// Union type can be one of [E_GnsiAcctz_CmdService, E_GnsiAcctz_GrpcService, E_GnsiAcctz_SessionService].
...
// Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union ensures that E_GnsiAcctz_CmdService
// implements the System_Aaa_Accounting_Acctz_SourceRecord_Type_Union interface.
func (E_GnsiAcctz_CmdService) Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union() {
}

// Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union ensures that E_GnsiAcctz_GrpcService
// implements the System_Aaa_Accounting_Acctz_SourceRecord_Type_Union interface.
func (E_GnsiAcctz_GrpcService) Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union() {
}

// Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union ensures that E_GnsiAcctz_SessionService
// implements the System_Aaa_Accounting_Acctz_SourceRecord_Type_Union interface.
func (E_GnsiAcctz_SessionService) Documentation_for_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union() {
}
...
func (t *System_Aaa_Accounting_Acctz_SourceRecord) To_System_Aaa_Accounting_Acctz_SourceRecord_Type_Union(i interface{}) (System_Aaa_Accounting_Acctz_SourceRecord_Type_Union, error) {
	...
	return nil, fmt.Errorf("cannot convert %v to System_Aaa_Accounting_Acctz_SourceRecord_Type_Union, unknown union type, got: %T, want any of [E_GnsiAcctz_CmdService, E_GnsiAcctz_GrpcService, E_GnsiAcctz_SessionService]", i, i)
}
