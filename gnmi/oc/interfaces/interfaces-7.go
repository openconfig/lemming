...
// Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath represents the /openconfig-interfaces/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/state/lookup-network-instance YANG schema element.
type Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath struct {
	*ygnmi.NodePath
	parent ygnmi.PathStruct
}

// Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny represents the wildcard version of the /openconfig-interfaces/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/state/lookup-network-instance YANG schema element.
type Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny struct {
	*ygnmi.NodePath
	parent ygnmi.PathStruct
}
...
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/state/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath) State() ygnmi.SingletonQuery[string] {
	return ygnmi.NewSingletonQuery[string](
		"Interface_Subinterface_Ipv6_Urpf",
		true,
		false,
		...
		func(gs ygot.ValidatedGoStruct) (string, bool) {
			ret := gs.(*oc.Interface_Subinterface_Ipv6_Urpf).LookupNetworkInstance
			if ret == nil {
				var zero string
				return zero, false
			}
...
//	Path from parent:     "state/lookup-network-instance"
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/state/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny) State() ygnmi.WildcardQuery[string] {
	return ygnmi.NewWildcardQuery[string](
		"Interface_Subinterface_Ipv6_Urpf",
		true,
		false,
...
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/config/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath) Config() ygnmi.ConfigQuery[string] {
	return ygnmi.NewConfigQuery[string](
		"Interface_Subinterface_Ipv6_Urpf",
		false,
		true,
...
//	Path from parent:     "config/lookup-network-instance"
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/config/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny) Config() ygnmi.WildcardQuery[string] {
	return ygnmi.NewWildcardQuery[string](
		"Interface_Subinterface_Ipv6_Urpf",
		false,
		true,
...
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/*/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_UrpfPath) LookupNetworkInstance() *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath {
	ps := &Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePath{
		NodePath: ygnmi.NewNodePath(
...
//	Path from parent:     "*/lookup-network-instance"
//	Path from root:       "/interfaces/interface/subinterfaces/subinterface/ipv6/urpf/*/lookup-network-instance"
func (n *Interface_Subinterface_Ipv6_UrpfPathAny) LookupNetworkInstance() *Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny {
	ps := &Interface_Subinterface_Ipv6_Urpf_LookupNetworkInstancePathAny{
		NodePath: ygnmi.NewNodePath(
			[]string{"*", "lookup-network-instance"},
			map[string]interface{}{},
			n,
