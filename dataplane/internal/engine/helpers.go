...
func createFIBSelector(ctx context.Context, id string, c fwdpb.ServiceClient) error {
...
func createLayer2PuntTable(ctx context.Context, id string, c fwdpb.ServiceClient) error {
...
func addLayer2PuntRule(ctx context.Context, id string, c fwdpb.ServiceClient, portID uint64, mac, macMask []byte) error {
...
func createLayer3PuntTable(ctx context.Context, id string, c fwdpb.ServiceClient) error {
...
func createKernelPort(ctx context.Context, id string, c fwdpb.ServiceClient, name string) (uint64, error) {
...
func createTapPort(ctx context.Context, id string, c fwdpb.ServiceClient, name string, fd int) (uint64, error) {
	port := &fwdpb.PortCreateRequest{
		ContextId: &fwdpb.ContextId{Id: id},
		Port: &fwdpb.PortDesc{
