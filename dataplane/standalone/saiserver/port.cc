...
grpc::Status Port::RemovePort(
  ...
  auto status = api->remove_port(req->oid());
...
grpc::Status Port::RemovePortPool(
  ...
  auto status = api->remove_port_pool(req->oid());
...
grpc::Status Port::RemovePortConnector(
  ...
  auto status = api->remove_port_connector(req->oid());
...
grpc::Status Port::RemovePortSerdes(
  ...
  auto status = api->remove_port_serdes(req->oid());
