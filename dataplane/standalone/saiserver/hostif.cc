...
grpc::Status Hostif::RemoveHostif(
  ...
  auto status = api->remove_hostif(req->oid());
...
grpc::Status Hostif::RemoveHostifTableEntry(
  ...
  auto status = api->remove_hostif_table_entry(req->oid());
...
grpc::Status Hostif::RemoveHostifTrapGroup(
  ...
  auto status = api->remove_hostif_trap_group(req->oid());
...
grpc::Status Hostif::RemoveHostifTrap(
  ...
  auto status = api->remove_hostif_trap(req->oid());
...
grpc::Status Hostif::RemoveHostifUserDefinedTrap(
  ...
  auto status = api->remove_hostif_user_defined_trap(req->oid());
