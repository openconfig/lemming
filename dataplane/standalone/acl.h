...
#ifndef DATAPLANE_STANDALONE_ACL_H_
#define DATAPLANE_STANDALONE_ACL_H_
...
class ACLTable : public APIBase {
 public:
  ACLTable(std::string id, std::shared_ptr<AttributeManager> mgr,
...
#endif  // DATAPLANE_STANDALONE_ACL_H_
