...
#ifndef DATAPLANE_STANDALONE_ROUTER_INTERFACE_H_
#define DATAPLANE_STANDALONE_ROUTER_INTERFACE_H_
...
class RouterInterface : public APIBase {
 public:
  RouterInterface(std::string id, std::shared_ptr<AttributeManager> mgr,
...
#endif  // DATAPLANE_STANDALONE_ROUTER_INTERFACE_H_
