...
const sai_buffer_api_t l_buffer = {
    ...
    .set_ingress_priority_groups_attribute =
        l_set_ingress_priority_groups_attribute,
    .get_ingress_priority_groups_attribute =
        l_get_ingress_priority_groups_attribute,
};
...
sai_status_t l_set_ingress_priority_groups_attribute(
...
sai_status_t l_get_ingress_priority_groups_attribute(
    uint32_t object_count, const sai_object_id_t* object_id,
