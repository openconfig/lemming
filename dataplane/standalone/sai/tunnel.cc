...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_MAP_ATTR_TYPE:
	req.set_type(static_cast<lemming::dataplane::sai::TunnelMapType>(attr_list[i].value.s32 + 1));
	break;
}
...
sai_status_t l_get_tunnel_map_attribute(sai_object_id_t tunnel_map_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::TunnelMapAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_ATTR_TYPE:
	req.set_type(static_cast<lemming::dataplane::sai::TunnelType>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_PEER_MODE:
	req.set_peer_mode(static_cast<lemming::dataplane::sai::TunnelPeerMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_SRC_IP:
	req.set_encap_src_ip(convert_from_ip_address(attr_list[i].value.ipaddr));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DST_IP:
	req.set_encap_dst_ip(convert_from_ip_address(attr_list[i].value.ipaddr));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_TTL_MODE:
	req.set_encap_ttl_mode(static_cast<lemming::dataplane::sai::TunnelTtlMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_TTL_VAL:
	req.set_encap_ttl_val(attr_list[i].value.u8);
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DSCP_MODE:
	req.set_encap_dscp_mode(static_cast<lemming::dataplane::sai::TunnelDscpMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_ENCAP_ECN_MODE:
	req.set_encap_ecn_mode(static_cast<lemming::dataplane::sai::TunnelEncapEcnMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_DECAP_ECN_MODE:
	req.set_decap_ecn_mode(static_cast<lemming::dataplane::sai::TunnelDecapEcnMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_DECAP_TTL_MODE:
	req.set_decap_ttl_mode(static_cast<lemming::dataplane::sai::TunnelTtlMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_DECAP_DSCP_MODE:
	req.set_decap_dscp_mode(static_cast<lemming::dataplane::sai::TunnelDscpMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE:
	req.set_vxlan_udp_sport_mode(static_cast<lemming::dataplane::sai::TunnelVxlanUdpSportMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_TUNNEL_ATTR_IPSEC_SA_PORT_LIST:
	req.mutable_ipsec_sa_port_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
}
...
switch (attr->id) {
  ...
  case SAI_TUNNEL_ATTR_ENCAP_TTL_MODE:
	req.set_encap_ttl_mode(static_cast<lemming::dataplane::sai::TunnelTtlMode>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_TTL_VAL:
	req.set_encap_ttl_val(attr->value.u8);
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DSCP_MODE:
	req.set_encap_dscp_mode(static_cast<lemming::dataplane::sai::TunnelDscpMode>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DSCP_VAL:
  ...
  case SAI_TUNNEL_ATTR_ENCAP_GRE_KEY:
	...
	break;
  case SAI_TUNNEL_ATTR_DECAP_TTL_MODE:
	req.set_decap_ttl_mode(static_cast<lemming::dataplane::sai::TunnelTtlMode>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_DECAP_DSCP_MODE:
	req.set_decap_dscp_mode(static_cast<lemming::dataplane::sai::TunnelDscpMode>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION:
	req.set_loopback_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE:
	req.set_vxlan_udp_sport_mode(static_cast<lemming::dataplane::sai::TunnelVxlanUdpSportMode>(attr->value.s32 + 1));
	break;
  case SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT:
...
sai_status_t l_get_tunnel_attribute(sai_object_id_t tunnel_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::TunnelAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_ATTR_ENCAP_DST_IP:
	...
	break;
  case SAI_TUNNEL_ATTR_ENCAP_TTL_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().encap_ttl_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_ENCAP_TTL_VAL:
	 attr_list[i].value.u8 =   resp.attr().encap_ttl_val();
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DSCP_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().encap_dscp_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_ENCAP_DSCP_VAL:
  ...
  case SAI_TUNNEL_ATTR_ENCAP_GRE_KEY:
	...
	break;
  case SAI_TUNNEL_ATTR_ENCAP_ECN_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().encap_ecn_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_ENCAP_MAPPERS:
	copy_list(attr_list[i].value.objlist.list, resp.attr().encap_mappers(), &attr_list[i].value.objlist.count);
	break;
  case SAI_TUNNEL_ATTR_DECAP_ECN_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().decap_ecn_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_DECAP_MAPPERS:
	copy_list(attr_list[i].value.objlist.list, resp.attr().decap_mappers(), &attr_list[i].value.objlist.count);
	break;
  case SAI_TUNNEL_ATTR_DECAP_TTL_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().decap_ttl_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_DECAP_DSCP_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().decap_dscp_mode() - 1);
	break;
  ...
  case SAI_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION:
	...
	break;
  case SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().vxlan_udp_sport_mode() - 1);
	break;
  case SAI_TUNNEL_ATTR_VXLAN_UDP_SPORT:
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_TERM_TABLE_ENTRY_ATTR_TYPE:
	req.set_type(static_cast<lemming::dataplane::sai::TunnelTermTableEntryType>(attr_list[i].value.s32 + 1));
	break;
...
sai_status_t l_get_tunnel_term_table_entry_attribute(sai_object_id_t tunnel_term_table_entry_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::TunnelTermTableEntryAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_TERM_TABLE_ENTRY_ATTR_IP_ADDR_FAMILY:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().ip_addr_family() - 1);
	break;
  case SAI_TUNNEL_TERM_TABLE_ENTRY_ATTR_IPSEC_VERIFIED:
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_MAP_ENTRY_ATTR_TUNNEL_MAP_TYPE:
	req.set_tunnel_map_type(static_cast<lemming::dataplane::sai::TunnelMapType>(attr_list[i].value.s32 + 1));
	break;
...
sai_status_t l_get_tunnel_map_entry_attribute(sai_object_id_t tunnel_map_entry_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::TunnelMapEntryAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_TUNNEL_MAP_ENTRY_ATTR_TUNNEL_MAP_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().tunnel_map_type() - 1);
	break;
  case SAI_TUNNEL_MAP_ENTRY_ATTR_TUNNEL_MAP:
