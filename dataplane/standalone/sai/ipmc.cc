...
lemming::dataplane::sai::CreateIpmcEntryRequest convert_create_ipmc_entry(uint32_t attr_count, const sai_attribute_t *attr_list) {
...
sai_status_t l_create_ipmc_entry(const sai_ipmc_entry_t *ipmc_entry, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateIpmcEntryRequest req = convert_create_ipmc_entry(attr_count, attr_list);
