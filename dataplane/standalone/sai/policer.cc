...
switch (attr_list[i].id) {
  ...
  case SAI_POLICER_ATTR_METER_TYPE:
	req.set_meter_type(static_cast<lemming::dataplane::sai::MeterType>(attr_list[i].value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_MODE:
	req.set_mode(static_cast<lemming::dataplane::sai::PolicerMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_COLOR_SOURCE:
	req.set_color_source(static_cast<lemming::dataplane::sai::PolicerColorSource>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_POLICER_ATTR_GREEN_PACKET_ACTION:
	req.set_green_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_YELLOW_PACKET_ACTION:
	req.set_yellow_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_RED_PACKET_ACTION:
	req.set_red_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
}
...
switch (attr->id) {
  ...
  case SAI_POLICER_ATTR_PIR:
	...
	break;
  case SAI_POLICER_ATTR_GREEN_PACKET_ACTION:
	req.set_green_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_YELLOW_PACKET_ACTION:
	req.set_yellow_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_POLICER_ATTR_RED_PACKET_ACTION:
	req.set_red_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
}
...
sai_status_t l_get_policer_attribute(sai_object_id_t policer_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::PolicerAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_POLICER_ATTR_MODE:
	...
	break;
  case SAI_POLICER_ATTR_COLOR_SOURCE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().color_source() - 1);
	break;
  case SAI_POLICER_ATTR_CBS:
  ...
  case SAI_POLICER_ATTR_PIR:
	...
	break;
  case SAI_POLICER_ATTR_GREEN_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().green_packet_action() - 1);
	break;
  case SAI_POLICER_ATTR_YELLOW_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().yellow_packet_action() - 1);
	break;
  case SAI_POLICER_ATTR_RED_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().red_packet_action() - 1);
	break;
}
