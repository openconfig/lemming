...
lemming::dataplane::sai::CreateL2mcEntryRequest convert_create_l2mc_entry(uint32_t attr_count, const sai_attribute_t *attr_list) {
...
sai_status_t l_create_l2mc_entry(const sai_l2mc_entry_t *l2mc_entry, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateL2mcEntryRequest req = convert_create_l2mc_entry(attr_count, attr_list);
