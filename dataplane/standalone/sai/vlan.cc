...
lemming::dataplane::sai::CreateVlanRequest convert_create_vlan(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	msg.set_ipv4_mcast_lookup_key_type(convert_sai_vlan_mcast_lookup_key_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	msg.set_ipv6_mcast_lookup_key_type(convert_sai_vlan_mcast_lookup_key_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	msg.set_unknown_unicast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	msg.set_unknown_multicast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	msg.set_broadcast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
...
lemming::dataplane::sai::CreateVlanMemberRequest convert_create_vlan_member(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	msg.set_vlan_tagging_mode(convert_sai_vlan_tagging_mode_t_to_proto(attr_list[i].value.s32));
	break;
}
...
sai_status_t l_create_vlan(sai_object_id_t *vlan_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateVlanRequest req = convert_create_vlan(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_VLAN_ATTR_LEARN_DISABLE:
	...
	break;
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv4_mcast_lookup_key_type(convert_sai_vlan_mcast_lookup_key_type_t_to_proto(attr->value.s32));
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv6_mcast_lookup_key_type(convert_sai_vlan_mcast_lookup_key_type_t_to_proto(attr->value.s32));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID:
  ...
  case SAI_VLAN_ATTR_META_DATA:
	...
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_unicast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	req.set_unknown_unicast_flood_group(attr->value.oid);
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_multicast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	req.set_unknown_multicast_flood_group(attr->value.oid);
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	req.set_broadcast_flood_control_type(convert_sai_vlan_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP:
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	...
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	 attr_list[i].value.s32 =  convert_sai_vlan_mcast_lookup_key_type_t_to_sai(resp.attr().ipv6_mcast_lookup_key_type());
	break;
  case SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID:
	 attr_list[i].value.oid =   resp.attr().unknown_non_ip_mcast_output_group_id();
	break;
  case SAI_VLAN_ATTR_UNKNOWN_IPV4_MCAST_OUTPUT_GROUP_ID:
	 attr_list[i].value.oid =   resp.attr().unknown_ipv4_mcast_output_group_id();
	break;
  case SAI_VLAN_ATTR_UNKNOWN_IPV6_MCAST_OUTPUT_GROUP_ID:
	 attr_list[i].value.oid =   resp.attr().unknown_ipv6_mcast_output_group_id();
	break;
  case SAI_VLAN_ATTR_UNKNOWN_LINKLOCAL_MCAST_OUTPUT_GROUP_ID:
	 attr_list[i].value.oid =   resp.attr().unknown_linklocal_mcast_output_group_id();
	break;
  case SAI_VLAN_ATTR_INGRESS_ACL:
  ...
  case SAI_VLAN_ATTR_META_DATA:
	...
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_vlan_flood_control_type_t_to_sai(resp.attr().unknown_unicast_flood_control_type());
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_unicast_flood_group();
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_vlan_flood_control_type_t_to_sai(resp.attr().unknown_multicast_flood_control_type());
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_multicast_flood_group();
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_vlan_flood_control_type_t_to_sai(resp.attr().broadcast_flood_control_type());
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP:
...
sai_status_t l_create_vlan_member(sai_object_id_t *vlan_member_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateVlanMemberRequest req = convert_create_vlan_member(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	req.set_vlan_tagging_mode(convert_sai_vlan_tagging_mode_t_to_proto(attr->value.s32));
	break;
}
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_BRIDGE_PORT_ID:
	...
	break;
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	 attr_list[i].value.s32 =  convert_sai_vlan_tagging_mode_t_to_sai(resp.attr().vlan_tagging_mode());
	break;
}
