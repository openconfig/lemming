...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv4_mcast_lookup_key_type(static_cast<lemming::dataplane::sai::VlanMcastLookupKeyType>(attr_list[i].value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv6_mcast_lookup_key_type(static_cast<lemming::dataplane::sai::VlanMcastLookupKeyType>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_unicast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_multicast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	req.set_broadcast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr_list[i].value.s32 + 1));
	break;
...
switch (attr->id) {
  ...
  case SAI_VLAN_ATTR_LEARN_DISABLE:
	...
	break;
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv4_mcast_lookup_key_type(static_cast<lemming::dataplane::sai::VlanMcastLookupKeyType>(attr->value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	req.set_ipv6_mcast_lookup_key_type(static_cast<lemming::dataplane::sai::VlanMcastLookupKeyType>(attr->value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID:
  ...
  case SAI_VLAN_ATTR_META_DATA:
	...
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_unicast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr->value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	req.set_unknown_unicast_flood_group(attr->value.oid);
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_multicast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr->value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	req.set_unknown_multicast_flood_group(attr->value.oid);
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	req.set_broadcast_flood_control_type(static_cast<lemming::dataplane::sai::VlanFloodControlType>(attr->value.s32 + 1));
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP:
...
sai_status_t l_get_vlan_attribute(sai_object_id_t vlan_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::VlanAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_ATTR_LEARN_DISABLE:
	...
	break;
  case SAI_VLAN_ATTR_IPV4_MCAST_LOOKUP_KEY_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().ipv4_mcast_lookup_key_type() - 1);
	break;
  case SAI_VLAN_ATTR_IPV6_MCAST_LOOKUP_KEY_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().ipv6_mcast_lookup_key_type() - 1);
	break;
  case SAI_VLAN_ATTR_UNKNOWN_NON_IP_MCAST_OUTPUT_GROUP_ID:
  ...
  case SAI_VLAN_ATTR_META_DATA:
	...
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().unknown_unicast_flood_control_type() - 1);
	break;
  case SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_unicast_flood_group();
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().unknown_multicast_flood_control_type() - 1);
	break;
  case SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_multicast_flood_group();
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().broadcast_flood_control_type() - 1);
	break;
  case SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP:
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	req.set_vlan_tagging_mode(static_cast<lemming::dataplane::sai::VlanTaggingMode>(attr_list[i].value.s32 + 1));
	break;
}
...
switch (attr->id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	req.set_vlan_tagging_mode(static_cast<lemming::dataplane::sai::VlanTaggingMode>(attr->value.s32 + 1));
	break;
}
...
sai_status_t l_get_vlan_member_attribute(sai_object_id_t vlan_member_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::VlanMemberAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_VLAN_MEMBER_ATTR_BRIDGE_PORT_ID:
	...
	break;
  case SAI_VLAN_MEMBER_ATTR_VLAN_TAGGING_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().vlan_tagging_mode() - 1);
	break;
}
