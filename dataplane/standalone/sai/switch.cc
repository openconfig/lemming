...
switch (attr_list[i].id) {
  ...
  case SAI_SWITCH_ATTR_SWITCHING_MODE:
	req.set_switching_mode(static_cast<lemming::dataplane::sai::SwitchSwitchingMode>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_SRC_MAC_ADDRESS:
	req.set_src_mac_address(attr_list[i].value.mac, sizeof(attr_list[i].value.mac));
	break;
  ...
  case SAI_SWITCH_ATTR_FDB_UNICAST_MISS_PACKET_ACTION:
	req.set_fdb_unicast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION:
	req.set_fdb_broadcast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION:
	req.set_fdb_multicast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM:
	req.set_ecmp_default_hash_algorithm(static_cast<lemming::dataplane::sai::HashAlgorithm>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_ALGORITHM:
	req.set_lag_default_hash_algorithm(static_cast<lemming::dataplane::sai::HashAlgorithm>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_SWITCH_HARDWARE_INFO:
	req.mutable_switch_hardware_info()->Add(attr_list[i].value.s8list.list, attr_list[i].value.s8list.list + attr_list[i].value.s8list.count);
	break;
  case SAI_SWITCH_ATTR_FIRMWARE_PATH_NAME:
	req.mutable_firmware_path_name()->Add(attr_list[i].value.s8list.list, attr_list[i].value.s8list.list + attr_list[i].value.s8list.count);
	break;
  ...
  case SAI_SWITCH_ATTR_PFC_DLR_PACKET_ACTION:
	req.set_pfc_dlr_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_VXLAN_DEFAULT_ROUTER_MAC:
	req.set_vxlan_default_router_mac(attr_list[i].value.mac, sizeof(attr_list[i].value.mac));
	break;
  ...
  case SAI_SWITCH_ATTR_TAM_OBJECT_ID:
	req.mutable_tam_object_id()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_SWITCH_ATTR_HARDWARE_ACCESS_BUS:
	req.set_hardware_access_bus(static_cast<lemming::dataplane::sai::SwitchHardwareAccessBus>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_FIRMWARE_LOAD_METHOD:
	req.set_firmware_load_method(static_cast<lemming::dataplane::sai::SwitchFirmwareLoadMethod>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_FIRMWARE_LOAD_TYPE:
	req.set_firmware_load_type(static_cast<lemming::dataplane::sai::SwitchFirmwareLoadType>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_SWITCH_ATTR_TYPE:
	req.set_type(static_cast<lemming::dataplane::sai::SwitchType>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_MACSEC_OBJECT_LIST:
	req.mutable_macsec_object_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_SWITCH_ATTR_FAILOVER_CONFIG_MODE:
	req.set_failover_config_mode(static_cast<lemming::dataplane::sai::SwitchFailoverConfigMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_TUNNEL_OBJECTS_LIST:
	req.mutable_tunnel_objects_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_SWITCH_ATTR_SLAVE_MDIO_ADDR_LIST:
	req.mutable_slave_mdio_addr_list()->Add(attr_list[i].value.u8list.list, attr_list[i].value.u8list.list + attr_list[i].value.u8list.count);
	break;
...
switch (attr->id) {
  ...
  case SAI_SWITCH_ATTR_WARM_RECOVER:
	...
	break;
  case SAI_SWITCH_ATTR_SWITCHING_MODE:
	req.set_switching_mode(static_cast<lemming::dataplane::sai::SwitchSwitchingMode>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_BCAST_CPU_FLOOD_ENABLE:
  ...
  case SAI_SWITCH_ATTR_FDB_AGING_TIME:
	...
	break;
  case SAI_SWITCH_ATTR_FDB_UNICAST_MISS_PACKET_ACTION:
	req.set_fdb_unicast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION:
	req.set_fdb_broadcast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION:
	req.set_fdb_multicast_miss_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM:
	req.set_ecmp_default_hash_algorithm(static_cast<lemming::dataplane::sai::HashAlgorithm>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_SEED:
  ...
  case SAI_SWITCH_ATTR_ECMP_HASH_IPV6:
	...
	break;
  case SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_ALGORITHM:
	req.set_lag_default_hash_algorithm(static_cast<lemming::dataplane::sai::HashAlgorithm>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_SEED:
  ...
  case SAI_SWITCH_ATTR_MIRROR_TC:
	...
	break;
  case SAI_SWITCH_ATTR_PFC_DLR_PACKET_ACTION:
	req.set_pfc_dlr_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_TPID_OUTER_VLAN:
  ...
  case SAI_SWITCH_ATTR_QOS_TC_AND_COLOR_TO_MPLS_EXP_MAP:
	...
	break;
  case SAI_SWITCH_ATTR_FAILOVER_CONFIG_MODE:
	req.set_failover_config_mode(static_cast<lemming::dataplane::sai::SwitchFailoverConfigMode>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_ATTR_TUNNEL_OBJECTS_LIST:
...
sai_status_t l_get_switch_attribute(sai_object_id_t switch_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::SwitchAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_SWITCH_ATTR_RESTART_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().restart_type() - 1);
	break;
  ...
  case SAI_SWITCH_ATTR_MCAST_SNOOPING_CAPABILITY:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().mcast_snooping_capability() - 1);
	break;
  case SAI_SWITCH_ATTR_SWITCHING_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().switching_mode() - 1);
	break;
  case SAI_SWITCH_ATTR_BCAST_CPU_FLOOD_ENABLE:
  ...
  case SAI_SWITCH_ATTR_FDB_AGING_TIME:
	...
	break;
  case SAI_SWITCH_ATTR_FDB_UNICAST_MISS_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().fdb_unicast_miss_packet_action() - 1);
	break;
  case SAI_SWITCH_ATTR_FDB_BROADCAST_MISS_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().fdb_broadcast_miss_packet_action() - 1);
	break;
  case SAI_SWITCH_ATTR_FDB_MULTICAST_MISS_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().fdb_multicast_miss_packet_action() - 1);
	break;
  case SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_ALGORITHM:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().ecmp_default_hash_algorithm() - 1);
	break;
  case SAI_SWITCH_ATTR_ECMP_DEFAULT_HASH_SEED:
  ...
  case SAI_SWITCH_ATTR_ECMP_HASH_IPV6:
	...
	break;
  case SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_ALGORITHM:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().lag_default_hash_algorithm() - 1);
	break;
  case SAI_SWITCH_ATTR_LAG_DEFAULT_HASH_SEED:
  ...
  case SAI_SWITCH_ATTR_QOS_NUM_LOSSLESS_QUEUES:
	...
	break;
  case SAI_SWITCH_ATTR_PFC_DLR_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().pfc_dlr_packet_action() - 1);
	break;
  case SAI_SWITCH_ATTR_TPID_OUTER_VLAN:
  ...
  case SAI_SWITCH_ATTR_NAT_ENABLE:
	...
	break;
  case SAI_SWITCH_ATTR_HARDWARE_ACCESS_BUS:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().hardware_access_bus() - 1);
	break;
  case SAI_SWITCH_ATTR_PLATFROM_CONTEXT:
  ...
  case SAI_SWITCH_ATTR_FIRMWARE_DOWNLOAD_BROADCAST:
	...
	break;
  case SAI_SWITCH_ATTR_FIRMWARE_LOAD_METHOD:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().firmware_load_method() - 1);
	break;
  case SAI_SWITCH_ATTR_FIRMWARE_LOAD_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().firmware_load_type() - 1);
	break;
  case SAI_SWITCH_ATTR_FIRMWARE_DOWNLOAD_EXECUTE:
  ...
  case SAI_SWITCH_ATTR_PACKET_DMA_MEMORY_POOL_SIZE:
	...
	break;
  case SAI_SWITCH_ATTR_FAILOVER_CONFIG_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().failover_config_mode() - 1);
	break;
...
switch (attr_list[i].id) {
  ...
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_TYPE:
	req.set_tunnel_type(static_cast<lemming::dataplane::sai::TunnelType>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION:
	req.set_loopback_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_ENCAP_ECN_MODE:
	req.set_tunnel_encap_ecn_mode(static_cast<lemming::dataplane::sai::TunnelEncapEcnMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_ENCAP_MAPPERS:
	req.mutable_encap_mappers()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_DECAP_ECN_MODE:
	req.set_tunnel_decap_ecn_mode(static_cast<lemming::dataplane::sai::TunnelDecapEcnMode>(attr_list[i].value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_DECAP_MAPPERS:
	req.mutable_decap_mappers()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_VXLAN_UDP_SPORT_MODE:
	req.set_tunnel_vxlan_udp_sport_mode(static_cast<lemming::dataplane::sai::TunnelVxlanUdpSportMode>(attr_list[i].value.s32 + 1));
	break;
...
switch (attr->id) {
  ...
  case SAI_SWITCH_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION:
	req.set_loopback_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_VXLAN_UDP_SPORT_MODE:
	req.set_tunnel_vxlan_udp_sport_mode(static_cast<lemming::dataplane::sai::TunnelVxlanUdpSportMode>(attr->value.s32 + 1));
	break;
  case SAI_SWITCH_TUNNEL_ATTR_VXLAN_UDP_SPORT:
...
sai_status_t l_get_switch_tunnel_attribute(sai_object_id_t switch_tunnel_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::SwitchTunnelAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_TYPE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().tunnel_type() - 1);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_LOOPBACK_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().loopback_packet_action() - 1);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_ENCAP_ECN_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().tunnel_encap_ecn_mode() - 1);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_ENCAP_MAPPERS:
	copy_list(attr_list[i].value.objlist.list, resp.attr().encap_mappers(), &attr_list[i].value.objlist.count);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_DECAP_ECN_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().tunnel_decap_ecn_mode() - 1);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_DECAP_MAPPERS:
	copy_list(attr_list[i].value.objlist.list, resp.attr().decap_mappers(), &attr_list[i].value.objlist.count);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_TUNNEL_VXLAN_UDP_SPORT_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().tunnel_vxlan_udp_sport_mode() - 1);
	break;
  case SAI_SWITCH_TUNNEL_ATTR_VXLAN_UDP_SPORT:
