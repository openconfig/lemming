...
lemming::dataplane::sai::AclEntryAttr convert_sai_acl_entry_attr_t_to_proto(
  ...
  switch (val) {
    ...
    case SAI_ACL_ENTRY_ATTR_USER_DEFINED_FIELD_GROUP_MAX:
      return lemming::dataplane::sai::
          ACL_ENTRY_ATTR_USER_DEFINED_FIELD_GROUP_MAX;
...
sai_acl_entry_attr_t convert_sai_acl_entry_attr_t_to_sai(
  ...
  switch (val) {
    ...
    case lemming::dataplane::sai::ACL_ENTRY_ATTR_USER_DEFINED_FIELD_GROUP_MAX:
      return SAI_ACL_ENTRY_ATTR_USER_DEFINED_FIELD_GROUP_MAX;
...
lemming::dataplane::sai::AclTableAttr convert_sai_acl_table_attr_t_to_proto(
  ...
  switch (val) {
    ...
    case SAI_ACL_TABLE_ATTR_USER_DEFINED_FIELD_GROUP_MAX:
      return lemming::dataplane::sai::
          ACL_TABLE_ATTR_USER_DEFINED_FIELD_GROUP_MAX;
...
sai_acl_table_attr_t convert_sai_acl_table_attr_t_to_sai(
  ...
  switch (val) {
    ...
    case lemming::dataplane::sai::ACL_TABLE_ATTR_USER_DEFINED_FIELD_GROUP_MAX:
