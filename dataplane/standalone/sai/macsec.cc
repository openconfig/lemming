...
switch (attr_list[i].id) {
  ...
  case SAI_MACSEC_ATTR_DIRECTION:
	req.set_direction(static_cast<lemming::dataplane::sai::MacsecDirection>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_MACSEC_ATTR_STATS_MODE:
	req.set_stats_mode(static_cast<lemming::dataplane::sai::StatsMode>(attr_list[i].value.s32 + 1));
	break;
...
switch (attr->id) {
  ...
  case SAI_MACSEC_ATTR_MAX_VLAN_TAGS_PARSED:
	...
	break;
  case SAI_MACSEC_ATTR_STATS_MODE:
	req.set_stats_mode(static_cast<lemming::dataplane::sai::StatsMode>(attr->value.s32 + 1));
	break;
  case SAI_MACSEC_ATTR_PHYSICAL_BYPASS_ENABLE:
...
sai_status_t l_get_macsec_attribute(sai_object_id_t macsec_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::MacsecAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_MACSEC_PORT_ATTR_MACSEC_DIRECTION:
	req.set_macsec_direction(static_cast<lemming::dataplane::sai::MacsecDirection>(attr_list[i].value.s32 + 1));
	break;
  ...
  case SAI_MACSEC_PORT_ATTR_SWITCH_SWITCHING_MODE:
	req.set_switch_switching_mode(static_cast<lemming::dataplane::sai::SwitchSwitchingMode>(attr_list[i].value.s32 + 1));
	break;
}
...
switch (attr->id) {
  ...
  case SAI_MACSEC_PORT_ATTR_STAG_ENABLE:
	...
	break;
  case SAI_MACSEC_PORT_ATTR_SWITCH_SWITCHING_MODE:
	req.set_switch_switching_mode(static_cast<lemming::dataplane::sai::SwitchSwitchingMode>(attr->value.s32 + 1));
	break;
}
...
sai_status_t l_get_macsec_port_attribute(sai_object_id_t macsec_port_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::MacsecPortAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_MACSEC_PORT_ATTR_MACSEC_DIRECTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().macsec_direction() - 1);
	break;
  case SAI_MACSEC_PORT_ATTR_PORT_ID:
  ...
  case SAI_MACSEC_PORT_ATTR_STAG_ENABLE:
	...
	break;
  case SAI_MACSEC_PORT_ATTR_SWITCH_SWITCHING_MODE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().switch_switching_mode() - 1);
	break;
}
...
sai_status_t l_get_macsec_flow_attribute(sai_object_id_t macsec_flow_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::MacsecFlowAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_MACSEC_SC_ATTR_MACSEC_CIPHER_SUITE:
	req.set_macsec_cipher_suite(static_cast<lemming::dataplane::sai::MacsecCipherSuite>(attr_list[i].value.s32 + 1));
	break;
...
switch (attr->id) {
  ...
  case SAI_MACSEC_SC_ATTR_MACSEC_REPLAY_PROTECTION_WINDOW:
	...
	break;
  case SAI_MACSEC_SC_ATTR_MACSEC_CIPHER_SUITE:
	req.set_macsec_cipher_suite(static_cast<lemming::dataplane::sai::MacsecCipherSuite>(attr->value.s32 + 1));
	break;
  case SAI_MACSEC_SC_ATTR_ENCRYPTION_ENABLE:
...
sai_status_t l_get_macsec_sc_attribute(sai_object_id_t macsec_sc_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::MacsecScAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_MACSEC_SC_ATTR_SA_LIST:
	...
	break;
  case SAI_MACSEC_SC_ATTR_MACSEC_CIPHER_SUITE:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().macsec_cipher_suite() - 1);
	break;
  case SAI_MACSEC_SC_ATTR_ENCRYPTION_ENABLE:
...
sai_status_t l_get_macsec_sa_attribute(sai_object_id_t macsec_sa_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::MacsecSaAttr>(attr_list[i].id + 1));
	}
