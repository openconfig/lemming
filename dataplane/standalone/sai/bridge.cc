...
lemming::dataplane::sai::CreateBridgeRequest convert_create_bridge(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_BRIDGE_ATTR_TYPE:
	msg.set_type(convert_sai_bridge_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_BRIDGE_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	msg.set_unknown_unicast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_BRIDGE_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	msg.set_unknown_multicast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_BRIDGE_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	msg.set_broadcast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr_list[i].value.s32));
	break;
...
lemming::dataplane::sai::CreateBridgePortRequest convert_create_bridge_port(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_BRIDGE_PORT_ATTR_TYPE:
	msg.set_type(convert_sai_bridge_port_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_BRIDGE_PORT_ATTR_PORT_ID:
	msg.set_port_id(attr_list[i].value.oid);
	break;
  case SAI_BRIDGE_PORT_ATTR_TAGGING_MODE:
	msg.set_tagging_mode(convert_sai_bridge_port_tagging_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_MODE:
	msg.set_fdb_learning_mode(convert_sai_bridge_port_fdb_learning_mode_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_BRIDGE_PORT_ATTR_MAX_LEARNED_ADDRESSES:
	msg.set_max_learned_addresses(attr_list[i].value.u32);
	break;
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_LIMIT_VIOLATION_PACKET_ACTION:
	msg.set_fdb_learning_limit_violation_packet_action(convert_sai_packet_action_t_to_proto(attr_list[i].value.s32));
	break;
...
sai_status_t l_create_bridge(sai_object_id_t *bridge_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateBridgeRequest req = convert_create_bridge(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_BRIDGE_ATTR_LEARN_DISABLE:
	...
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_unicast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	req.set_unknown_unicast_flood_group(attr->value.oid);
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	req.set_unknown_multicast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	req.set_unknown_multicast_flood_group(attr->value.oid);
	break;
  case SAI_BRIDGE_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	req.set_broadcast_flood_control_type(convert_sai_bridge_flood_control_type_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_ATTR_BROADCAST_FLOOD_GROUP:
...
switch (attr_list[i].id) {
  ...
  case SAI_BRIDGE_ATTR_TYPE:
	 attr_list[i].value.s32 =  convert_sai_bridge_type_t_to_sai(resp.attr().type());
	break;
  ...
  case SAI_BRIDGE_ATTR_LEARN_DISABLE:
	...
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_UNICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_bridge_flood_control_type_t_to_sai(resp.attr().unknown_unicast_flood_control_type());
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_unicast_flood_group();
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_MULTICAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_bridge_flood_control_type_t_to_sai(resp.attr().unknown_multicast_flood_control_type());
	break;
  case SAI_BRIDGE_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP:
	 attr_list[i].value.oid =   resp.attr().unknown_multicast_flood_group();
	break;
  case SAI_BRIDGE_ATTR_BROADCAST_FLOOD_CONTROL_TYPE:
	 attr_list[i].value.s32 =  convert_sai_bridge_flood_control_type_t_to_sai(resp.attr().broadcast_flood_control_type());
	break;
  case SAI_BRIDGE_ATTR_BROADCAST_FLOOD_GROUP:
...
sai_status_t l_create_bridge_port(sai_object_id_t *bridge_port_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateBridgePortRequest req = convert_create_bridge_port(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_BRIDGE_PORT_ATTR_TAGGING_MODE:
	req.set_tagging_mode(convert_sai_bridge_port_tagging_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_PORT_ATTR_BRIDGE_ID:
	req.set_bridge_id(attr->value.oid);
	break;
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_MODE:
	req.set_fdb_learning_mode(convert_sai_bridge_port_fdb_learning_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_PORT_ATTR_MAX_LEARNED_ADDRESSES:
	req.set_max_learned_addresses(attr->value.u32);
	break;
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_LIMIT_VIOLATION_PACKET_ACTION:
	req.set_fdb_learning_limit_violation_packet_action(convert_sai_packet_action_t_to_proto(attr->value.s32));
	break;
  case SAI_BRIDGE_PORT_ATTR_ADMIN_STATE:
...
switch (attr_list[i].id) {
  ...
  case SAI_BRIDGE_PORT_ATTR_TYPE:
	 attr_list[i].value.s32 =  convert_sai_bridge_port_type_t_to_sai(resp.attr().type());
	break;
  case SAI_BRIDGE_PORT_ATTR_PORT_ID:
	 attr_list[i].value.oid =   resp.attr().port_id();
	break;
  case SAI_BRIDGE_PORT_ATTR_TAGGING_MODE:
	 attr_list[i].value.s32 =  convert_sai_bridge_port_tagging_mode_t_to_sai(resp.attr().tagging_mode());
	break;
  case SAI_BRIDGE_PORT_ATTR_VLAN_ID:
  ...
  case SAI_BRIDGE_PORT_ATTR_BRIDGE_ID:
	...
	break;
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_MODE:
	 attr_list[i].value.s32 =  convert_sai_bridge_port_fdb_learning_mode_t_to_sai(resp.attr().fdb_learning_mode());
	break;
  case SAI_BRIDGE_PORT_ATTR_MAX_LEARNED_ADDRESSES:
	 attr_list[i].value.u32 =   resp.attr().max_learned_addresses();
	break;
  case SAI_BRIDGE_PORT_ATTR_FDB_LEARNING_LIMIT_VIOLATION_PACKET_ACTION:
	 attr_list[i].value.s32 =  convert_sai_packet_action_t_to_sai(resp.attr().fdb_learning_limit_violation_packet_action());
	break;
  case SAI_BRIDGE_PORT_ATTR_ADMIN_STATE:
...
sai_status_t l_get_bridge_port_stats(sai_object_id_t bridge_port_id, uint32_t number_of_counters, const sai_stat_id_t *counter_ids, uint64_t *counters) {
	...
	for (uint32_t i = 0; i < number_of_counters; i++) {
		req.add_counter_ids(convert_sai_bridge_port_stat_t_to_proto(counter_ids[i]));
	}
