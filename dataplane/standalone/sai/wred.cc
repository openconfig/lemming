...
lemming::dataplane::sai::CreateWredRequest convert_create_wred(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_WRED_ATTR_ECN_MARK_MODE:
	msg.set_ecn_mark_mode(convert_sai_ecn_mark_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MARK_PROBABILITY:
	...
	break;
  case SAI_WRED_ATTR_GREEN_MIN_THRESHOLD_64:
	msg.set_green_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_GREEN_MAX_THRESHOLD_64:
	msg.set_green_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_YELLOW_MIN_THRESHOLD_64:
	msg.set_yellow_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_YELLOW_MAX_THRESHOLD_64:
	msg.set_yellow_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_RED_MIN_THRESHOLD_64:
	msg.set_red_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_RED_MAX_THRESHOLD_64:
	msg.set_red_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MIN_THRESHOLD_64:
	msg.set_ecn_green_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MAX_THRESHOLD_64:
	msg.set_ecn_green_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MIN_THRESHOLD_64:
	msg.set_ecn_yellow_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MAX_THRESHOLD_64:
	msg.set_ecn_yellow_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_RED_MIN_THRESHOLD_64:
	msg.set_ecn_red_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_RED_MAX_THRESHOLD_64:
	msg.set_ecn_red_max_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MIN_THRESHOLD_64:
	msg.set_ecn_color_unaware_min_threshold_64(attr_list[i].value.u64);
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MAX_THRESHOLD_64:
	msg.set_ecn_color_unaware_max_threshold_64(attr_list[i].value.u64);
	break;
}
...
sai_status_t l_create_wred(sai_object_id_t *wred_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateWredRequest req = convert_create_wred(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_WRED_ATTR_WEIGHT:
	...
	break;
  case SAI_WRED_ATTR_ECN_MARK_MODE:
	req.set_ecn_mark_mode(convert_sai_ecn_mark_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MIN_THRESHOLD:
  ...
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MARK_PROBABILITY:
	...
	break;
  case SAI_WRED_ATTR_GREEN_MIN_THRESHOLD_64:
	req.set_green_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_GREEN_MAX_THRESHOLD_64:
	req.set_green_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_YELLOW_MIN_THRESHOLD_64:
	req.set_yellow_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_YELLOW_MAX_THRESHOLD_64:
	req.set_yellow_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_RED_MIN_THRESHOLD_64:
	req.set_red_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_RED_MAX_THRESHOLD_64:
	req.set_red_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MIN_THRESHOLD_64:
	req.set_ecn_green_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MAX_THRESHOLD_64:
	req.set_ecn_green_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MIN_THRESHOLD_64:
	req.set_ecn_yellow_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MAX_THRESHOLD_64:
	req.set_ecn_yellow_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_RED_MIN_THRESHOLD_64:
	req.set_ecn_red_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_RED_MAX_THRESHOLD_64:
	req.set_ecn_red_max_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MIN_THRESHOLD_64:
	req.set_ecn_color_unaware_min_threshold_64(attr->value.u64);
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MAX_THRESHOLD_64:
	req.set_ecn_color_unaware_max_threshold_64(attr->value.u64);
	break;
}
...
switch (attr_list[i].id) {
  ...
  case SAI_WRED_ATTR_WEIGHT:
	...
	break;
  case SAI_WRED_ATTR_ECN_MARK_MODE:
	 attr_list[i].value.s32 =  convert_sai_ecn_mark_mode_t_to_sai(resp.attr().ecn_mark_mode());
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MIN_THRESHOLD:
  ...
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MAX_THRESHOLD:
	...
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MARK_PROBABILITY:
	 attr_list[i].value.u32 =   resp.attr().ecn_color_unaware_mark_probability();
	break;
  case SAI_WRED_ATTR_GREEN_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().green_min_threshold_64();
	break;
  case SAI_WRED_ATTR_GREEN_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().green_max_threshold_64();
	break;
  case SAI_WRED_ATTR_YELLOW_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().yellow_min_threshold_64();
	break;
  case SAI_WRED_ATTR_YELLOW_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().yellow_max_threshold_64();
	break;
  case SAI_WRED_ATTR_RED_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().red_min_threshold_64();
	break;
  case SAI_WRED_ATTR_RED_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().red_max_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_green_min_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_GREEN_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_green_max_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_yellow_min_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_YELLOW_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_yellow_max_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_RED_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_red_min_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_RED_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_red_max_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MIN_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_color_unaware_min_threshold_64();
	break;
  case SAI_WRED_ATTR_ECN_COLOR_UNAWARE_MAX_THRESHOLD_64:
	 attr_list[i].value.u64 =   resp.attr().ecn_color_unaware_max_threshold_64();
	break;
}
