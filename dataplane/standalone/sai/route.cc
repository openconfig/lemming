...
lemming::dataplane::sai::CreateRouteEntryRequest convert_create_route_entry(uint32_t attr_count, const sai_attribute_t *attr_list) {
...
sai_status_t l_create_route_entry(const sai_route_entry_t *route_entry, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreateRouteEntryRequest req = convert_create_route_entry(attr_count, attr_list);
