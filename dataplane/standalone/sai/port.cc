...
lemming::dataplane::sai::CreatePortRequest convert_create_port(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_ATTR_HW_LANE_LIST:
	msg.mutable_hw_lane_list()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  ...
  case SAI_PORT_ATTR_MEDIA_TYPE:
	msg.set_media_type(convert_sai_port_media_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_SPEED:
	msg.mutable_advertised_speed()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE:
	msg.mutable_advertised_fec_mode()->CopyFrom(convert_list_sai_port_fec_mode_t_to_proto(attr_list[i].value.s32list));
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE_EXTENDED:
	msg.mutable_advertised_fec_mode_extended()->CopyFrom(convert_list_sai_port_fec_mode_extended_t_to_proto(attr_list[i].value.s32list));
	break;
  case SAI_PORT_ATTR_ADVERTISED_HALF_DUPLEX_SPEED:
	msg.mutable_advertised_half_duplex_speed()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  ...
  case SAI_PORT_ATTR_ADVERTISED_FLOW_CONTROL_MODE:
	msg.set_advertised_flow_control_mode(convert_sai_port_flow_control_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_ADVERTISED_MEDIA_TYPE:
	msg.set_advertised_media_type(convert_sai_port_media_type_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_INTERNAL_LOOPBACK_MODE:
	msg.set_internal_loopback_mode(convert_sai_port_internal_loopback_mode_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_USE_EXTENDED_FEC:
	msg.set_use_extended_fec(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_FEC_MODE:
	msg.set_fec_mode(convert_sai_port_fec_mode_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_FEC_MODE_EXTENDED:
	msg.set_fec_mode_extended(convert_sai_port_fec_mode_extended_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_GLOBAL_FLOW_CONTROL_MODE:
	msg.set_global_flow_control_mode(convert_sai_port_flow_control_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_INGRESS_MIRROR_SESSION:
	msg.mutable_ingress_mirror_session()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_MIRROR_SESSION:
	msg.mutable_egress_mirror_session()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_PORT_ATTR_INGRESS_SAMPLE_MIRROR_SESSION:
	msg.mutable_ingress_sample_mirror_session()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_SAMPLE_MIRROR_SESSION:
	msg.mutable_egress_sample_mirror_session()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_PORT_ATTR_QOS_INGRESS_BUFFER_PROFILE_LIST:
	msg.mutable_qos_ingress_buffer_profile_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_QOS_EGRESS_BUFFER_PROFILE_LIST:
	msg.mutable_qos_egress_buffer_profile_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL_MODE:
	msg.set_priority_flow_control_mode(convert_sai_port_priority_flow_control_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_EGRESS_BLOCK_PORT_LIST:
	msg.mutable_egress_block_port_list()->Add(attr_list[i].value.objlist.list, attr_list[i].value.objlist.list + attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_PORT_ATTR_SERDES_PREEMPHASIS:
	msg.mutable_serdes_preemphasis()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IDRIVER:
	msg.mutable_serdes_idriver()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IPREDRIVER:
	msg.mutable_serdes_ipredriver()->Add(attr_list[i].value.u32list.list, attr_list[i].value.u32list.list + attr_list[i].value.u32list.count);
	break;
  ...
  case SAI_PORT_ATTR_PTP_MODE:
	msg.set_ptp_mode(convert_sai_port_ptp_mode_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_INTERFACE_TYPE:
	msg.set_interface_type(convert_sai_port_interface_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_INTERFACE_TYPE:
	msg.mutable_advertised_interface_type()->CopyFrom(convert_list_sai_port_interface_type_t_to_proto(attr_list[i].value.s32list));
	break;
  ...
  case SAI_PORT_ATTR_PRBS_CONFIG:
	msg.set_prbs_config(convert_sai_port_prbs_config_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_LOOPBACK_MODE:
	msg.set_loopback_mode(convert_sai_port_loopback_mode_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_MDIX_MODE_CONFIG:
	msg.set_mdix_mode_config(convert_sai_port_mdix_mode_config_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_AUTO_NEG_CONFIG_MODE:
	msg.set_auto_neg_config_mode(convert_sai_port_auto_neg_config_mode_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_MODULE_TYPE:
	msg.set_module_type(convert_sai_port_module_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_DUAL_MEDIA:
	msg.set_dual_media(convert_sai_port_dual_media_t_to_proto(attr_list[i].value.s32));
	break;
  ...
  case SAI_PORT_ATTR_ARS_ENABLE:
	msg.set_ars_enable(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_SCALING_FACTOR:
	msg.set_ars_port_load_scaling_factor(attr_list[i].value.u32);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_ENABLE:
	msg.set_ars_port_load_past_enable(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_FUTURE_ENABLE:
	msg.set_ars_port_load_future_enable(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_ALTERNATE_PATH:
	msg.set_ars_alternate_path(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_ECMP_HASH_ALGORITHM:
	msg.set_ecmp_hash_algorithm(convert_sai_hash_algorithm_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_ECMP_HASH_SEED:
	msg.set_ecmp_hash_seed(attr_list[i].value.u32);
	break;
  case SAI_PORT_ATTR_ECMP_HASH_OFFSET:
	msg.set_ecmp_hash_offset(attr_list[i].value.u8);
	break;
  case SAI_PORT_ATTR_HOST_TX_SIGNAL_ENABLE:
	msg.set_host_tx_signal_enable(attr_list[i].value.booldata);
	break;
  case SAI_PORT_ATTR_PATH_TRACING_INTF:
	msg.set_path_tracing_intf(attr_list[i].value.u16);
	break;
  case SAI_PORT_ATTR_PATH_TRACING_TIMESTAMP_TYPE:
	msg.set_path_tracing_timestamp_type(convert_sai_port_path_tracing_timestamp_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_DATAPATH_ENABLE:
	msg.set_datapath_enable(convert_sai_port_datapath_enable_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_CABLE_TYPE:
	msg.set_cable_type(convert_sai_port_cable_type_t_to_proto(attr_list[i].value.s32));
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_WEIGHT:
	msg.set_ars_port_load_past_weight(attr_list[i].value.u32);
	break;
...
lemming::dataplane::sai::CreatePortPoolRequest convert_create_port_pool(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
lemming::dataplane::sai::CreatePortConnectorRequest convert_create_port_connector(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_CONNECTOR_ATTR_FAILOVER_MODE:
	msg.set_failover_mode(convert_sai_port_connector_failover_mode_t_to_proto(attr_list[i].value.s32));
	break;
}
...
lemming::dataplane::sai::CreatePortSerdesRequest convert_create_port_serdes(sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_SERDES_ATTR_IDRIVER:
	msg.mutable_idriver()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_IPREDRIVER:
	msg.mutable_ipredriver()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE1:
	msg.mutable_tx_fir_pre1()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE2:
	msg.mutable_tx_fir_pre2()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE3:
	msg.mutable_tx_fir_pre3()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_MAIN:
	msg.mutable_tx_fir_main()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_POST1:
	msg.mutable_tx_fir_post1()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_POST2:
	msg.mutable_tx_fir_post2()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  ...
  case SAI_PORT_SERDES_ATTR_TX_FIR_ATTN:
	msg.mutable_tx_fir_attn()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PAM4_RATIO:
	msg.mutable_tx_pam4_ratio()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_OUT_COMMON_MODE:
	...
	break;
  case SAI_PORT_SERDES_ATTR_TX_PMOS_COMMON_MODE:
	msg.mutable_tx_pmos_common_mode()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_NMOS_COMMON_MODE:
	msg.mutable_tx_nmos_common_mode()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PMOS_VLTG_REG:
	msg.mutable_tx_pmos_vltg_reg()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_NMOS_VLTG_REG:
	msg.mutable_tx_nmos_vltg_reg()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PRECODING:
	msg.mutable_tx_precoding()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_RX_PRECODING:
	msg.mutable_rx_precoding()->Add(attr_list[i].value.s32list.list, attr_list[i].value.s32list.list + attr_list[i].value.s32list.count);
	break;
}
...
sai_status_t l_create_port(sai_object_id_t *port_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreatePortRequest req = convert_create_port(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_PORT_ATTR_ADMIN_STATE:
	...
	break;
  case SAI_PORT_ATTR_MEDIA_TYPE:
	req.set_media_type(convert_sai_port_media_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_SPEED:
	req.mutable_advertised_speed()->Add(attr->value.u32list.list, attr->value.u32list.list + attr->value.u32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE:
	req.mutable_advertised_fec_mode()->CopyFrom(convert_list_sai_port_fec_mode_t_to_proto(attr->value.s32list));
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE_EXTENDED:
	req.mutable_advertised_fec_mode_extended()->CopyFrom(convert_list_sai_port_fec_mode_extended_t_to_proto(attr->value.s32list));
	break;
  case SAI_PORT_ATTR_ADVERTISED_HALF_DUPLEX_SPEED:
	req.mutable_advertised_half_duplex_speed()->Add(attr->value.u32list.list, attr->value.u32list.list + attr->value.u32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_AUTO_NEG_MODE:
	req.set_advertised_auto_neg_mode(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ADVERTISED_FLOW_CONTROL_MODE:
	req.set_advertised_flow_control_mode(convert_sai_port_flow_control_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_ASYMMETRIC_PAUSE_MODE:
	req.set_advertised_asymmetric_pause_mode(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ADVERTISED_MEDIA_TYPE:
	req.set_advertised_media_type(convert_sai_port_media_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_OUI_CODE:
  ...
  case SAI_PORT_ATTR_DROP_TAGGED:
	...
	break;
  case SAI_PORT_ATTR_INTERNAL_LOOPBACK_MODE:
	req.set_internal_loopback_mode(convert_sai_port_internal_loopback_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_USE_EXTENDED_FEC:
  ...
  case SAI_PORT_ATTR_FEC_MODE:
	...
	break;
  case SAI_PORT_ATTR_FEC_MODE_EXTENDED:
	req.set_fec_mode_extended(convert_sai_port_fec_mode_extended_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_UPDATE_DSCP:
  ...
  case SAI_PORT_ATTR_MULTICAST_STORM_CONTROL_POLICER_ID:
	...
	break;
  case SAI_PORT_ATTR_GLOBAL_FLOW_CONTROL_MODE:
	req.set_global_flow_control_mode(convert_sai_port_flow_control_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_INGRESS_ACL:
  ...
  case SAI_PORT_ATTR_EGRESS_MACSEC_ACL:
	...
	break;
  case SAI_PORT_ATTR_INGRESS_MIRROR_SESSION:
	req.mutable_ingress_mirror_session()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_MIRROR_SESSION:
	req.mutable_egress_mirror_session()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_INGRESS_SAMPLEPACKET_ENABLE:
  ...
  case SAI_PORT_ATTR_EGRESS_SAMPLEPACKET_ENABLE:
	...
	break;
  case SAI_PORT_ATTR_INGRESS_SAMPLE_MIRROR_SESSION:
	req.mutable_ingress_sample_mirror_session()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_SAMPLE_MIRROR_SESSION:
	req.mutable_egress_sample_mirror_session()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_POLICER_ID:
  ...
  case SAI_PORT_ATTR_QOS_SCHEDULER_PROFILE_ID:
	...
	break;
  case SAI_PORT_ATTR_QOS_INGRESS_BUFFER_PROFILE_LIST:
	req.mutable_qos_ingress_buffer_profile_list()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_QOS_EGRESS_BUFFER_PROFILE_LIST:
	req.mutable_qos_egress_buffer_profile_list()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL_MODE:
	req.set_priority_flow_control_mode(convert_sai_port_priority_flow_control_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL:
  ...
  case SAI_PORT_ATTR_META_DATA:
	...
	break;
  case SAI_PORT_ATTR_EGRESS_BLOCK_PORT_LIST:
	req.mutable_egress_block_port_list()->Add(attr->value.objlist.list, attr->value.objlist.list + attr->value.objlist.count);
	break;
  case SAI_PORT_ATTR_HW_PROFILE_ID:
  ...
  case SAI_PORT_ATTR_TAM_OBJECT:
	...
	break;
  case SAI_PORT_ATTR_SERDES_PREEMPHASIS:
	req.mutable_serdes_preemphasis()->Add(attr->value.u32list.list, attr->value.u32list.list + attr->value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IDRIVER:
	req.mutable_serdes_idriver()->Add(attr->value.u32list.list, attr->value.u32list.list + attr->value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IPREDRIVER:
	req.mutable_serdes_ipredriver()->Add(attr->value.u32list.list, attr->value.u32list.list + attr->value.u32list.count);
	break;
  case SAI_PORT_ATTR_LINK_TRAINING_ENABLE:
  ...
  case SAI_PORT_ATTR_PTP_MODE:
	...
	break;
  case SAI_PORT_ATTR_INTERFACE_TYPE:
	req.set_interface_type(convert_sai_port_interface_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ADVERTISED_INTERFACE_TYPE:
	req.mutable_advertised_interface_type()->CopyFrom(convert_list_sai_port_interface_type_t_to_proto(attr->value.s32list));
	break;
  case SAI_PORT_ATTR_PRBS_POLYNOMIAL:
	req.set_prbs_polynomial(attr->value.u32);
	break;
  case SAI_PORT_ATTR_PRBS_CONFIG:
	req.set_prbs_config(convert_sai_port_prbs_config_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_DISABLE_DECREMENT_TTL:
  ...
  case SAI_PORT_ATTR_AUTO_NEG_FEC_MODE_OVERRIDE:
	...
	break;
  case SAI_PORT_ATTR_LOOPBACK_MODE:
	req.set_loopback_mode(convert_sai_port_loopback_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_MDIX_MODE_CONFIG:
	req.set_mdix_mode_config(convert_sai_port_mdix_mode_config_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_AUTO_NEG_CONFIG_MODE:
	req.set_auto_neg_config_mode(convert_sai_port_auto_neg_config_mode_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_1000X_SGMII_SLAVE_AUTODETECT:
	req.set__1000x_sgmii_slave_autodetect(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_MODULE_TYPE:
	req.set_module_type(convert_sai_port_module_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_DUAL_MEDIA:
	req.set_dual_media(convert_sai_port_dual_media_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_IPG:
  ...
  case SAI_PORT_ATTR_FABRIC_ISOLATE:
	...
	break;
  case SAI_PORT_ATTR_ARS_ENABLE:
	req.set_ars_enable(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_SCALING_FACTOR:
	req.set_ars_port_load_scaling_factor(attr->value.u32);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_ENABLE:
	req.set_ars_port_load_past_enable(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_FUTURE_ENABLE:
	req.set_ars_port_load_future_enable(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ARS_ALTERNATE_PATH:
	req.set_ars_alternate_path(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_ECMP_HASH_ALGORITHM:
	req.set_ecmp_hash_algorithm(convert_sai_hash_algorithm_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ECMP_HASH_SEED:
	req.set_ecmp_hash_seed(attr->value.u32);
	break;
  case SAI_PORT_ATTR_ECMP_HASH_OFFSET:
	req.set_ecmp_hash_offset(attr->value.u8);
	break;
  case SAI_PORT_ATTR_HOST_TX_SIGNAL_ENABLE:
	req.set_host_tx_signal_enable(attr->value.booldata);
	break;
  case SAI_PORT_ATTR_PATH_TRACING_INTF:
	req.set_path_tracing_intf(attr->value.u16);
	break;
  case SAI_PORT_ATTR_PATH_TRACING_TIMESTAMP_TYPE:
	req.set_path_tracing_timestamp_type(convert_sai_port_path_tracing_timestamp_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_DATAPATH_ENABLE:
	req.set_datapath_enable(convert_sai_port_datapath_enable_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_CABLE_TYPE:
	req.set_cable_type(convert_sai_port_cable_type_t_to_proto(attr->value.s32));
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_WEIGHT:
	req.set_ars_port_load_past_weight(attr->value.u32);
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_FUTURE_WEIGHT:
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_ATTR_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_type_t_to_sai(resp.attr().type());
	break;
  case SAI_PORT_ATTR_OPER_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_oper_status_t_to_sai(resp.attr().oper_status());
	break;
  case SAI_PORT_ATTR_SUPPORTED_BREAKOUT_MODE_TYPE:
	convert_list_sai_port_breakout_mode_type_t_to_sai(attr_list[i].value.s32list.list, resp.attr().supported_breakout_mode_type(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_CURRENT_BREAKOUT_MODE_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_breakout_mode_type_t_to_sai(resp.attr().current_breakout_mode_type());
	break;
  case SAI_PORT_ATTR_QOS_NUMBER_OF_QUEUES:
	 attr_list[i].value.u32 =   resp.attr().qos_number_of_queues();
	break;
  case SAI_PORT_ATTR_QOS_QUEUE_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().qos_queue_list(), &attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_PORT_ATTR_QOS_SCHEDULER_GROUP_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().qos_scheduler_group_list(), &attr_list[i].value.objlist.count);
	break;
  ...
  case SAI_PORT_ATTR_SUPPORTED_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().supported_speed(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SUPPORTED_FEC_MODE:
	convert_list_sai_port_fec_mode_t_to_sai(attr_list[i].value.s32list.list, resp.attr().supported_fec_mode(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_SUPPORTED_FEC_MODE_EXTENDED:
	convert_list_sai_port_fec_mode_extended_t_to_sai(attr_list[i].value.s32list.list, resp.attr().supported_fec_mode_extended(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_SUPPORTED_HALF_DUPLEX_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().supported_half_duplex_speed(), &attr_list[i].value.u32list.count);
	break;
  ...
  case SAI_PORT_ATTR_SUPPORTED_FLOW_CONTROL_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_flow_control_mode_t_to_sai(resp.attr().supported_flow_control_mode());
	break;
  case SAI_PORT_ATTR_SUPPORTED_ASYMMETRIC_PAUSE_MODE:
	 attr_list[i].value.booldata =   resp.attr().supported_asymmetric_pause_mode();
	break;
  case SAI_PORT_ATTR_SUPPORTED_MEDIA_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_media_type_t_to_sai(resp.attr().supported_media_type());
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().remote_advertised_speed(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_FEC_MODE:
	convert_list_sai_port_fec_mode_t_to_sai(attr_list[i].value.s32list.list, resp.attr().remote_advertised_fec_mode(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_FEC_MODE_EXTENDED:
	convert_list_sai_port_fec_mode_extended_t_to_sai(attr_list[i].value.s32list.list, resp.attr().remote_advertised_fec_mode_extended(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_HALF_DUPLEX_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().remote_advertised_half_duplex_speed(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_AUTO_NEG_MODE:
	 attr_list[i].value.booldata =   resp.attr().remote_advertised_auto_neg_mode();
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_FLOW_CONTROL_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_flow_control_mode_t_to_sai(resp.attr().remote_advertised_flow_control_mode());
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_ASYMMETRIC_PAUSE_MODE:
	 attr_list[i].value.booldata =   resp.attr().remote_advertised_asymmetric_pause_mode();
	break;
  case SAI_PORT_ATTR_REMOTE_ADVERTISED_MEDIA_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_media_type_t_to_sai(resp.attr().remote_advertised_media_type());
	break;
  ...
  case SAI_PORT_ATTR_NUMBER_OF_INGRESS_PRIORITY_GROUPS:
	 attr_list[i].value.u32 =   resp.attr().number_of_ingress_priority_groups();
	break;
  case SAI_PORT_ATTR_INGRESS_PRIORITY_GROUP_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().ingress_priority_group_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_OPER_SPEED:
	 attr_list[i].value.u32 =   resp.attr().oper_speed();
	break;
  case SAI_PORT_ATTR_HW_LANE_LIST:
	copy_list(attr_list[i].value.u32list.list, resp.attr().hw_lane_list(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SPEED:
  ...
  case SAI_PORT_ATTR_ADMIN_STATE:
	...
	break;
  case SAI_PORT_ATTR_MEDIA_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_media_type_t_to_sai(resp.attr().media_type());
	break;
  case SAI_PORT_ATTR_ADVERTISED_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().advertised_speed(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE:
	convert_list_sai_port_fec_mode_t_to_sai(attr_list[i].value.s32list.list, resp.attr().advertised_fec_mode(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_FEC_MODE_EXTENDED:
	...
	break;
  case SAI_PORT_ATTR_ADVERTISED_HALF_DUPLEX_SPEED:
	copy_list(attr_list[i].value.u32list.list, resp.attr().advertised_half_duplex_speed(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_ADVERTISED_AUTO_NEG_MODE:
	 attr_list[i].value.booldata =   resp.attr().advertised_auto_neg_mode();
	break;
  case SAI_PORT_ATTR_ADVERTISED_FLOW_CONTROL_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_flow_control_mode_t_to_sai(resp.attr().advertised_flow_control_mode());
	break;
  case SAI_PORT_ATTR_ADVERTISED_ASYMMETRIC_PAUSE_MODE:
	 attr_list[i].value.booldata =   resp.attr().advertised_asymmetric_pause_mode();
	break;
  case SAI_PORT_ATTR_ADVERTISED_MEDIA_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_media_type_t_to_sai(resp.attr().advertised_media_type());
	break;
  case SAI_PORT_ATTR_ADVERTISED_OUI_CODE:
  ...
  case SAI_PORT_ATTR_DROP_TAGGED:
	...
	break;
  case SAI_PORT_ATTR_INTERNAL_LOOPBACK_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_internal_loopback_mode_t_to_sai(resp.attr().internal_loopback_mode());
	break;
  case SAI_PORT_ATTR_USE_EXTENDED_FEC:
	 attr_list[i].value.booldata =   resp.attr().use_extended_fec();
	break;
  case SAI_PORT_ATTR_FEC_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_fec_mode_t_to_sai(resp.attr().fec_mode());
	break;
  case SAI_PORT_ATTR_FEC_MODE_EXTENDED:
	 attr_list[i].value.s32 =  convert_sai_port_fec_mode_extended_t_to_sai(resp.attr().fec_mode_extended());
	break;
  case SAI_PORT_ATTR_UPDATE_DSCP:
  ...
  case SAI_PORT_ATTR_FLOOD_STORM_CONTROL_POLICER_ID:
	...
	break;
  case SAI_PORT_ATTR_BROADCAST_STORM_CONTROL_POLICER_ID:
	 attr_list[i].value.oid =   resp.attr().broadcast_storm_control_policer_id();
	break;
  case SAI_PORT_ATTR_MULTICAST_STORM_CONTROL_POLICER_ID:
	 attr_list[i].value.oid =   resp.attr().multicast_storm_control_policer_id();
	break;
  case SAI_PORT_ATTR_GLOBAL_FLOW_CONTROL_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_flow_control_mode_t_to_sai(resp.attr().global_flow_control_mode());
	break;
  case SAI_PORT_ATTR_INGRESS_ACL:
  ...
  case SAI_PORT_ATTR_MACSEC_PORT_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().macsec_port_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_INGRESS_MIRROR_SESSION:
	copy_list(attr_list[i].value.objlist.list, resp.attr().ingress_mirror_session(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_MIRROR_SESSION:
	copy_list(attr_list[i].value.objlist.list, resp.attr().egress_mirror_session(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_INGRESS_SAMPLEPACKET_ENABLE:
  ...
  case SAI_PORT_ATTR_EGRESS_SAMPLEPACKET_ENABLE:
	...
	break;
  case SAI_PORT_ATTR_INGRESS_SAMPLE_MIRROR_SESSION:
	copy_list(attr_list[i].value.objlist.list, resp.attr().ingress_sample_mirror_session(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_EGRESS_SAMPLE_MIRROR_SESSION:
	copy_list(attr_list[i].value.objlist.list, resp.attr().egress_sample_mirror_session(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_POLICER_ID:
  ...
  case SAI_PORT_ATTR_QOS_TC_TO_PRIORITY_GROUP_MAP:
	...
	break;
  case SAI_PORT_ATTR_QOS_PFC_PRIORITY_TO_PRIORITY_GROUP_MAP:
	 attr_list[i].value.oid =   resp.attr().qos_pfc_priority_to_priority_group_map();
	break;
  case SAI_PORT_ATTR_QOS_PFC_PRIORITY_TO_QUEUE_MAP:
  ...
  case SAI_PORT_ATTR_QOS_SCHEDULER_PROFILE_ID:
	...
	break;
  case SAI_PORT_ATTR_QOS_INGRESS_BUFFER_PROFILE_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().qos_ingress_buffer_profile_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_QOS_EGRESS_BUFFER_PROFILE_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().qos_egress_buffer_profile_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_priority_flow_control_mode_t_to_sai(resp.attr().priority_flow_control_mode());
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL:
  ...
  case SAI_PORT_ATTR_META_DATA:
	...
	break;
  case SAI_PORT_ATTR_EGRESS_BLOCK_PORT_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().egress_block_port_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_HW_PROFILE_ID:
  ...
  case SAI_PORT_ATTR_PORT_POOL_LIST:
	copy_list(attr_list[i].value.objlist.list, resp.attr().port_pool_list(), &attr_list[i].value.objlist.count);
	break;
  case SAI_PORT_ATTR_ISOLATION_GROUP:
  ...
  case SAI_PORT_ATTR_TAM_OBJECT:
	...
	break;
  case SAI_PORT_ATTR_SERDES_PREEMPHASIS:
	copy_list(attr_list[i].value.u32list.list, resp.attr().serdes_preemphasis(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IDRIVER:
	copy_list(attr_list[i].value.u32list.list, resp.attr().serdes_idriver(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_SERDES_IPREDRIVER:
	copy_list(attr_list[i].value.u32list.list, resp.attr().serdes_ipredriver(), &attr_list[i].value.u32list.count);
	break;
  case SAI_PORT_ATTR_LINK_TRAINING_ENABLE:
	 attr_list[i].value.booldata =   resp.attr().link_training_enable();
	break;
  case SAI_PORT_ATTR_PTP_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_ptp_mode_t_to_sai(resp.attr().ptp_mode());
	break;
  case SAI_PORT_ATTR_INTERFACE_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_interface_type_t_to_sai(resp.attr().interface_type());
	break;
  case SAI_PORT_ATTR_ADVERTISED_INTERFACE_TYPE:
  ...
  case SAI_PORT_ATTR_LINK_TRAINING_FAILURE_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_link_training_failure_status_t_to_sai(resp.attr().link_training_failure_status());
	break;
  case SAI_PORT_ATTR_LINK_TRAINING_RX_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_link_training_rx_status_t_to_sai(resp.attr().link_training_rx_status());
	break;
  case SAI_PORT_ATTR_PRBS_CONFIG:
	 attr_list[i].value.s32 =  convert_sai_port_prbs_config_t_to_sai(resp.attr().prbs_config());
	break;
  ...
  case SAI_PORT_ATTR_PRBS_RX_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_prbs_rx_status_t_to_sai(resp.attr().prbs_rx_status());
	break;
  ...
  case SAI_PORT_ATTR_FABRIC_ATTACHED_SWITCH_TYPE:
	 attr_list[i].value.s32 =  convert_sai_switch_type_t_to_sai(resp.attr().fabric_attached_switch_type());
	break;
  ...
  case SAI_PORT_ATTR_AUTO_NEG_FEC_MODE_OVERRIDE:
	...
	break;
  case SAI_PORT_ATTR_LOOPBACK_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_loopback_mode_t_to_sai(resp.attr().loopback_mode());
	break;
  case SAI_PORT_ATTR_MDIX_MODE_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_mdix_mode_status_t_to_sai(resp.attr().mdix_mode_status());
	break;
  case SAI_PORT_ATTR_MDIX_MODE_CONFIG:
	 attr_list[i].value.s32 =  convert_sai_port_mdix_mode_config_t_to_sai(resp.attr().mdix_mode_config());
	break;
  case SAI_PORT_ATTR_AUTO_NEG_CONFIG_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_auto_neg_config_mode_t_to_sai(resp.attr().auto_neg_config_mode());
	break;
  case SAI_PORT_ATTR_1000X_SGMII_SLAVE_AUTODETECT:
	 attr_list[i].value.booldata =   resp.attr()._1000x_sgmii_slave_autodetect();
	break;
  case SAI_PORT_ATTR_MODULE_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_module_type_t_to_sai(resp.attr().module_type());
	break;
  case SAI_PORT_ATTR_DUAL_MEDIA:
	 attr_list[i].value.s32 =  convert_sai_port_dual_media_t_to_sai(resp.attr().dual_media());
	break;
  case SAI_PORT_ATTR_AUTO_NEG_FEC_MODE_EXTENDED:
	 attr_list[i].value.s32 =  convert_sai_port_fec_mode_extended_t_to_sai(resp.attr().auto_neg_fec_mode_extended());
	break;
  case SAI_PORT_ATTR_IPG:
  ...
  case SAI_PORT_ATTR_GLOBAL_FLOW_CONTROL_FORWARD:
	...
	break;
  case SAI_PORT_ATTR_PRIORITY_FLOW_CONTROL_FORWARD:
	 attr_list[i].value.booldata =   resp.attr().priority_flow_control_forward();
	break;
  case SAI_PORT_ATTR_QOS_DSCP_TO_FORWARDING_CLASS_MAP:
  ...
  case SAI_PORT_ATTR_MAX_FEC_SYMBOL_ERRORS_DETECTABLE:
	...
	break;
  case SAI_PORT_ATTR_ARS_ENABLE:
	 attr_list[i].value.booldata =   resp.attr().ars_enable();
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_SCALING_FACTOR:
	 attr_list[i].value.u32 =   resp.attr().ars_port_load_scaling_factor();
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_ENABLE:
	 attr_list[i].value.booldata =   resp.attr().ars_port_load_past_enable();
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_FUTURE_ENABLE:
	 attr_list[i].value.booldata =   resp.attr().ars_port_load_future_enable();
	break;
  case SAI_PORT_ATTR_ARS_ALTERNATE_PATH:
	 attr_list[i].value.booldata =   resp.attr().ars_alternate_path();
	break;
  case SAI_PORT_ATTR_JSON_FORMATTED_DEBUG_DATA:
	copy_list(attr_list[i].value.s8list.list, resp.attr().json_formatted_debug_data(), &attr_list[i].value.s8list.count);
	break;
  case SAI_PORT_ATTR_ECMP_HASH_ALGORITHM:
	 attr_list[i].value.s32 =  convert_sai_hash_algorithm_t_to_sai(resp.attr().ecmp_hash_algorithm());
	break;
  case SAI_PORT_ATTR_ECMP_HASH_SEED:
	 attr_list[i].value.u32 =   resp.attr().ecmp_hash_seed();
	break;
  case SAI_PORT_ATTR_ECMP_HASH_OFFSET:
	 attr_list[i].value.u8 =   resp.attr().ecmp_hash_offset();
	break;
  case SAI_PORT_ATTR_OPER_PORT_FEC_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_fec_mode_t_to_sai(resp.attr().oper_port_fec_mode());
	break;
  case SAI_PORT_ATTR_HOST_TX_SIGNAL_ENABLE:
	 attr_list[i].value.booldata =   resp.attr().host_tx_signal_enable();
	break;
  case SAI_PORT_ATTR_HOST_TX_READY_STATUS:
	 attr_list[i].value.s32 =  convert_sai_port_host_tx_ready_status_t_to_sai(resp.attr().host_tx_ready_status());
	break;
  case SAI_PORT_ATTR_PATH_TRACING_INTF:
	 attr_list[i].value.u16 =   resp.attr().path_tracing_intf();
	break;
  case SAI_PORT_ATTR_PATH_TRACING_TIMESTAMP_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_path_tracing_timestamp_type_t_to_sai(resp.attr().path_tracing_timestamp_type());
	break;
  case SAI_PORT_ATTR_DATAPATH_ENABLE:
	 attr_list[i].value.s32 =  convert_sai_port_datapath_enable_t_to_sai(resp.attr().datapath_enable());
	break;
  case SAI_PORT_ATTR_CABLE_PAIR_STATE:
	convert_list_sai_port_cable_pair_state_t_to_sai(attr_list[i].value.s32list.list, resp.attr().cable_pair_state(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_CABLE_PAIR_LENGTH:
	copy_list(attr_list[i].value.s32list.list, resp.attr().cable_pair_length(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_ATTR_CABLE_TYPE:
	 attr_list[i].value.s32 =  convert_sai_port_cable_type_t_to_sai(resp.attr().cable_type());
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_PAST_WEIGHT:
	 attr_list[i].value.u32 =   resp.attr().ars_port_load_past_weight();
	break;
  case SAI_PORT_ATTR_ARS_PORT_LOAD_FUTURE_WEIGHT:
	 attr_list[i].value.u32 =   resp.attr().ars_port_load_future_weight();
	break;
...
sai_status_t l_create_port_pool(sai_object_id_t *port_pool_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreatePortPoolRequest req = convert_create_port_pool(switch_id, attr_count, attr_list);
...
sai_status_t l_create_port_connector(sai_object_id_t *port_connector_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreatePortConnectorRequest req = convert_create_port_connector(switch_id, attr_count, attr_list);
...
switch (attr->id) {
  ...
  case SAI_PORT_CONNECTOR_ATTR_FAILOVER_MODE:
	req.set_failover_mode(convert_sai_port_connector_failover_mode_t_to_proto(attr->value.s32));
	break;
}
...
sai_status_t l_get_port_connector_attribute(sai_object_id_t port_connector_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(convert_sai_port_connector_attr_t_to_proto(attr_list[i].id));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_CONNECTOR_ATTR_LINE_SIDE_FAILOVER_PORT_ID:
	...
	break;
  case SAI_PORT_CONNECTOR_ATTR_FAILOVER_MODE:
	 attr_list[i].value.s32 =  convert_sai_port_connector_failover_mode_t_to_sai(resp.attr().failover_mode());
	break;
}
...
sai_status_t l_create_port_serdes(sai_object_id_t *port_serdes_id, sai_object_id_t switch_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
	...
	lemming::dataplane::sai::CreatePortSerdesRequest req = convert_create_port_serdes(switch_id, attr_count, attr_list);
...
switch (attr_list[i].id) {
  ...
  case SAI_PORT_SERDES_ATTR_PORT_ID:
	...
	break;
  case SAI_PORT_SERDES_ATTR_PREEMPHASIS:
	copy_list(attr_list[i].value.s32list.list, resp.attr().preemphasis(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_IDRIVER:
	copy_list(attr_list[i].value.s32list.list, resp.attr().idriver(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_IPREDRIVER:
	copy_list(attr_list[i].value.s32list.list, resp.attr().ipredriver(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE1:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_pre1(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE2:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_pre2(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_PRE3:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_pre3(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_MAIN:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_main(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_POST1:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_post1(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_POST2:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_post2(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_POST3:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_post3(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_FIR_ATTN:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_fir_attn(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PAM4_RATIO:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_pam4_ratio(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_OUT_COMMON_MODE:
  ...
  case SAI_PORT_SERDES_ATTR_TX_PMOS_COMMON_MODE:
	...
	break;
  case SAI_PORT_SERDES_ATTR_TX_NMOS_COMMON_MODE:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_nmos_common_mode(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PMOS_VLTG_REG:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_pmos_vltg_reg(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_NMOS_VLTG_REG:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_nmos_vltg_reg(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_TX_PRECODING:
	copy_list(attr_list[i].value.s32list.list, resp.attr().tx_precoding(), &attr_list[i].value.s32list.count);
	break;
  case SAI_PORT_SERDES_ATTR_RX_PRECODING:
	copy_list(attr_list[i].value.s32list.list, resp.attr().rx_precoding(), &attr_list[i].value.s32list.count);
	break;
}
...
sai_status_t l_create_ports(sai_object_id_t switch_id, uint32_t object_count, const uint32_t *attr_count, const sai_attribute_t **attr_list, sai_bulk_op_error_mode_t mode, sai_object_id_t *object_id, sai_status_t *object_statuses) {
	LOG(INFO) << "Func: " << __PRETTY_FUNCTION__;
...
sai_status_t l_remove_ports(uint32_t object_count, const sai_object_id_t *object_id, sai_bulk_op_error_mode_t mode, sai_status_t *object_statuses) {
	LOG(INFO) << "Func: " << __PRETTY_FUNCTION__;
...
sai_status_t l_set_ports_attribute(uint32_t object_count, const sai_object_id_t *object_id, const sai_attribute_t *attr_list, sai_bulk_op_error_mode_t mode, sai_status_t *object_statuses) {
	LOG(INFO) << "Func: " << __PRETTY_FUNCTION__;
	return SAI_STATUS_NOT_IMPLEMENTED;
}

sai_status_t l_get_ports_attribute(uint32_t object_count, const sai_object_id_t *object_id, const uint32_t *attr_count, sai_attribute_t **attr_list, sai_bulk_op_error_mode_t mode, sai_status_t *object_statuses) {
	LOG(INFO) << "Func: " << __PRETTY_FUNCTION__;
	return SAI_STATUS_NOT_IMPLEMENTED;
}
