...
switch (attr_list[i].id) {
  ...
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_TTL1_PACKET_ACTION:
	req.set_violation_ttl1_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_IP_OPTIONS_PACKET_ACTION:
	req.set_violation_ip_options_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_UNKNOWN_L3_MULTICAST_PACKET_ACTION:
	req.set_unknown_l3_multicast_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr_list[i].value.s32 + 1));
	break;
...
switch (attr->id) {
  ...
  case SAI_VIRTUAL_ROUTER_ATTR_SRC_MAC_ADDRESS:
	...
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_TTL1_PACKET_ACTION:
	req.set_violation_ttl1_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_IP_OPTIONS_PACKET_ACTION:
	req.set_violation_ip_options_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_UNKNOWN_L3_MULTICAST_PACKET_ACTION:
	req.set_unknown_l3_multicast_packet_action(static_cast<lemming::dataplane::sai::PacketAction>(attr->value.s32 + 1));
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_LABEL:
...
sai_status_t l_get_virtual_router_attribute(sai_object_id_t virtual_router_id, uint32_t attr_count, sai_attribute_t *attr_list) {
	...
	for (uint32_t i = 0; i < attr_count; i++) {
		req.add_attr_type(static_cast<lemming::dataplane::sai::VirtualRouterAttr>(attr_list[i].id + 1));
	}
...
switch (attr_list[i].id) {
  ...
  case SAI_VIRTUAL_ROUTER_ATTR_SRC_MAC_ADDRESS:
	...
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_TTL1_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().violation_ttl1_packet_action() - 1);
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_VIOLATION_IP_OPTIONS_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().violation_ip_options_packet_action() - 1);
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_UNKNOWN_L3_MULTICAST_PACKET_ACTION:
	 attr_list[i].value.s32 =  static_cast<int>(resp.attr().unknown_l3_multicast_packet_action() - 1);
	break;
  case SAI_VIRTUAL_ROUTER_ATTR_LABEL:
