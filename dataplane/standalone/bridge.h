...
#ifndef DATAPLANE_STANDALONE_BRIDGE_H_
#define DATAPLANE_STANDALONE_BRIDGE_H_
...
class Bridge : public APIBase {
 public:
  Bridge(std::string id, std::shared_ptr<AttributeManager> mgr,
...
#endif  // DATAPLANE_STANDALONE_BRIDGE_H_
