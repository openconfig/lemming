...
#ifndef DATAPLANE_STANDALONE_VLAN_H_
#define DATAPLANE_STANDALONE_VLAN_H_
...
class VLAN : public APIBase {
 public:
  VLAN(std::string id, std::shared_ptr<AttributeManager> mgr,
...
#endif  // DATAPLANE_STANDALONE_VLAN_H_
