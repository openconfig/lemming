...
type CreatePolicerRequest struct {
	...
	MeterType                     MeterType          `protobuf:"varint,2,opt,name=meter_type,json=meterType,proto3,enum=lemming.dataplane.sai.MeterType" json:"meter_type,omitempty"`
	Mode                          PolicerMode        `protobuf:"varint,3,opt,name=mode,proto3,enum=lemming.dataplane.sai.PolicerMode" json:"mode,omitempty"`
	ColorSource                   PolicerColorSource `protobuf:"varint,4,opt,name=color_source,json=colorSource,proto3,enum=lemming.dataplane.sai.PolicerColorSource" json:"color_source,omitempty"`
	Cbs                           uint64             `protobuf:"varint,5,opt,name=cbs,proto3" json:"cbs,omitempty"`
	Cir                           uint64             `protobuf:"varint,6,opt,name=cir,proto3" json:"cir,omitempty"`
	Pbs                           uint64             `protobuf:"varint,7,opt,name=pbs,proto3" json:"pbs,omitempty"`
	Pir                           uint64             `protobuf:"varint,8,opt,name=pir,proto3" json:"pir,omitempty"`
	GreenPacketAction             PacketAction       `protobuf:"varint,9,opt,name=green_packet_action,json=greenPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"green_packet_action,omitempty"`
	YellowPacketAction            PacketAction       `protobuf:"varint,10,opt,name=yellow_packet_action,json=yellowPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"yellow_packet_action,omitempty"`
	RedPacketAction               PacketAction       `protobuf:"varint,11,opt,name=red_packet_action,json=redPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"red_packet_action,omitempty"`
...
type SetPolicerAttributeRequest struct {
	...
	//
	//	*SetPolicerAttributeRequest_Cbs
	//	*SetPolicerAttributeRequest_Cir
	//	*SetPolicerAttributeRequest_Pbs
	//	*SetPolicerAttributeRequest_Pir
	//	*SetPolicerAttributeRequest_GreenPacketAction
	//	*SetPolicerAttributeRequest_YellowPacketAction
	//	*SetPolicerAttributeRequest_RedPacketAction
	//	*SetPolicerAttributeRequest_EnableCounterPacketActionList
	Attr isSetPolicerAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetPolicerAttributeRequest) GetAttr() isSetPolicerAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetPolicerAttributeRequest) GetCbs() uint64 {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_Cbs); ok {
		return x.Cbs
	}
	return 0
}
...
func (x *SetPolicerAttributeRequest) GetCir() uint64 {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_Cir); ok {
		return x.Cir
	}
	return 0
}
...
func (x *SetPolicerAttributeRequest) GetPbs() uint64 {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_Pbs); ok {
		return x.Pbs
	}
	return 0
}
...
func (x *SetPolicerAttributeRequest) GetPir() uint64 {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_Pir); ok {
		return x.Pir
	}
	return 0
}
...
func (x *SetPolicerAttributeRequest) GetGreenPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_GreenPacketAction); ok {
		return x.GreenPacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetPolicerAttributeRequest) GetYellowPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_YellowPacketAction); ok {
		return x.YellowPacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetPolicerAttributeRequest) GetRedPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_RedPacketAction); ok {
		return x.RedPacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}

func (x *SetPolicerAttributeRequest) GetEnableCounterPacketActionList() *PacketActionList {
	if x, ok := x.GetAttr().(*SetPolicerAttributeRequest_EnableCounterPacketActionList); ok {
		return x.EnableCounterPacketActionList
	}
	return nil
}

type isSetPolicerAttributeRequest_Attr interface {
	isSetPolicerAttributeRequest_Attr()
}

type SetPolicerAttributeRequest_Cbs struct {
	Cbs uint64 `protobuf:"varint,2,opt,name=cbs,proto3,oneof"`
}

type SetPolicerAttributeRequest_Cir struct {
	Cir uint64 `protobuf:"varint,3,opt,name=cir,proto3,oneof"`
}

type SetPolicerAttributeRequest_Pbs struct {
	Pbs uint64 `protobuf:"varint,4,opt,name=pbs,proto3,oneof"`
}

type SetPolicerAttributeRequest_Pir struct {
	Pir uint64 `protobuf:"varint,5,opt,name=pir,proto3,oneof"`
}

type SetPolicerAttributeRequest_GreenPacketAction struct {
	GreenPacketAction PacketAction `protobuf:"varint,6,opt,name=green_packet_action,json=greenPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetPolicerAttributeRequest_YellowPacketAction struct {
	YellowPacketAction PacketAction `protobuf:"varint,7,opt,name=yellow_packet_action,json=yellowPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetPolicerAttributeRequest_RedPacketAction struct {
	RedPacketAction PacketAction `protobuf:"varint,8,opt,name=red_packet_action,json=redPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetPolicerAttributeRequest_EnableCounterPacketActionList struct {
	EnableCounterPacketActionList *PacketActionList `protobuf:"bytes,9,opt,name=enable_counter_packet_action_list,json=enableCounterPacketActionList,proto3,oneof"`
}

func (*SetPolicerAttributeRequest_Cbs) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_Cir) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_Pbs) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_Pir) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_GreenPacketAction) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_YellowPacketAction) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_RedPacketAction) isSetPolicerAttributeRequest_Attr() {}

func (*SetPolicerAttributeRequest_EnableCounterPacketActionList) isSetPolicerAttributeRequest_Attr() {
}
...
type GetPolicerAttributeResponse struct {
	...
	Attr []*PolicerAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_policer_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x05, 0x0a, 0x14, 0x43,
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x3f, 0x0a, 0x0a, 0x6d,
	...
	0x65, 0x52, 0x09, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x36, 0x0a, 0x04,
	0x6d, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x6c, 0x65, 0x6d,
	0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73,
	0x61, 0x69, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x04,
	0x6d, 0x6f, 0x64, 0x65, 0x12, 0x4c, 0x0a, 0x0c, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x5f, 0x73, 0x6f,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x0b, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x53, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x62, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x03, 0x63, 0x62, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x69, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x03, 0x63, 0x69, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x62, 0x73, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x03, 0x70, 0x62, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x69, 0x72, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x70, 0x69, 0x72, 0x12, 0x53, 0x0a, 0x13, 0x67, 0x72,
	...
	0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x11, 0x67, 0x72,
	0x65, 0x65, 0x6e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x55, 0x0a, 0x14, 0x79, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e,
	...
	0x6f, 0x6e, 0x52, 0x12, 0x79, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4f, 0x0a, 0x11, 0x72, 0x65, 0x64, 0x5f, 0x70, 0x61,
	...
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0f, 0x72, 0x65, 0x64, 0x50, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6d, 0x0a, 0x21, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	...
	0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x1d, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x29, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x10, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69,
	0x64, 0x22, 0x28, 0x0a, 0x14, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	,
	...
	0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73,
	0x61, 0x69, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48,
	0x00, 0x52, 0x12, 0x79, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x51, 0x0a, 0x11, 0x72, 0x65, 0x64, 0x5f, 0x70, 0x61, 0x63,
	0x6b, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0f, 0x72, 0x65, 0x64, 0x50, 0x61, 0x63, 0x6b,
	0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x73, 0x0a, 0x21, 0x65, 0x6e, 0x61, 0x62,
	0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20,
	...
	0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x1d,
	0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x50, 0x61, 0x63,
	0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x06, 0x0a,
	0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x1d, 0x0a, 0x1b, 0x53, 0x65, 0x74, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x65, 0x72, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6f, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x65, 0x72, 0x41, 0x74, 0x74, 0x72, 0x52, 0x08, 0x61, 0x74, 0x74,
	0x72, 0x54, 0x79, 0x70, 0x65, 0x22, 0x5a, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x65, 0x72, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x01, 0x20, 0x03,
	...
	,
...
var file_dataplane_standalone_proto_policer_proto_goTypes = []interface{}{
	...
	(*PacketActionList)(nil),            // 13: lemming.dataplane.sai.PacketActionList
...
var file_dataplane_standalone_proto_policer_proto_depIdxs = []int32{
	...
	12, // 7: lemming.dataplane.sai.SetPolicerAttributeRequest.green_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	12, // 8: lemming.dataplane.sai.SetPolicerAttributeRequest.yellow_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	12, // 9: lemming.dataplane.sai.SetPolicerAttributeRequest.red_packet_action:type_name -> lemming.dataplane.sai.PacketAction
	13, // 10: lemming.dataplane.sai.SetPolicerAttributeRequest.enable_counter_packet_action_list:type_name -> lemming.dataplane.sai.PacketActionList
	0,  // 11: lemming.dataplane.sai.GetPolicerAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.PolicerAttr
	14, // 12: lemming.dataplane.sai.GetPolicerAttributeResponse.attr:type_name -> lemming.dataplane.sai.PolicerAttribute
	1,  // 13: lemming.dataplane.sai.Policer.CreatePolicer:input_type -> lemming.dataplane.sai.CreatePolicerRequest
	3,  // 14: lemming.dataplane.sai.Policer.RemovePolicer:input_type -> lemming.dataplane.sai.RemovePolicerRequest
	5,  // 15: lemming.dataplane.sai.Policer.SetPolicerAttribute:input_type -> lemming.dataplane.sai.SetPolicerAttributeRequest
	7,  // 16: lemming.dataplane.sai.Policer.GetPolicerAttribute:input_type -> lemming.dataplane.sai.GetPolicerAttributeRequest
	2,  // 17: lemming.dataplane.sai.Policer.CreatePolicer:output_type -> lemming.dataplane.sai.CreatePolicerResponse
	4,  // 18: lemming.dataplane.sai.Policer.RemovePolicer:output_type -> lemming.dataplane.sai.RemovePolicerResponse
	6,  // 19: lemming.dataplane.sai.Policer.SetPolicerAttribute:output_type -> lemming.dataplane.sai.SetPolicerAttributeResponse
	8,  // 20: lemming.dataplane.sai.Policer.GetPolicerAttribute:output_type -> lemming.dataplane.sai.GetPolicerAttributeResponse
...
func file_dataplane_standalone_proto_policer_proto_init() {
	...
	file_dataplane_standalone_proto_policer_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetPolicerAttributeRequest_Cbs)(nil),
		(*SetPolicerAttributeRequest_Cir)(nil),
		(*SetPolicerAttributeRequest_Pbs)(nil),
		(*SetPolicerAttributeRequest_Pir)(nil),
		(*SetPolicerAttributeRequest_GreenPacketAction)(nil),
		(*SetPolicerAttributeRequest_YellowPacketAction)(nil),
		(*SetPolicerAttributeRequest_RedPacketAction)(nil),
		(*SetPolicerAttributeRequest_EnableCounterPacketActionList)(nil),
	}
	type x struct{}
