...
type SetVlanAttributeRequest struct {
	...
	//
	//	*SetVlanAttributeRequest_MaxLearnedAddresses
	//	*SetVlanAttributeRequest_StpInstance
	//	*SetVlanAttributeRequest_LearnDisable
	//	*SetVlanAttributeRequest_Ipv4McastLookupKeyType
	//	*SetVlanAttributeRequest_Ipv6McastLookupKeyType
	//	*SetVlanAttributeRequest_UnknownNonIpMcastOutputGroupId
	//	*SetVlanAttributeRequest_UnknownIpv4McastOutputGroupId
	//	*SetVlanAttributeRequest_UnknownIpv6McastOutputGroupId
	//	*SetVlanAttributeRequest_UnknownLinklocalMcastOutputGroupId
	//	*SetVlanAttributeRequest_IngressAcl
	//	*SetVlanAttributeRequest_EgressAcl
	//	*SetVlanAttributeRequest_MetaData
	//	*SetVlanAttributeRequest_UnknownUnicastFloodControlType
	//	*SetVlanAttributeRequest_UnknownUnicastFloodGroup
	//	*SetVlanAttributeRequest_UnknownMulticastFloodControlType
	//	*SetVlanAttributeRequest_UnknownMulticastFloodGroup
	//	*SetVlanAttributeRequest_BroadcastFloodControlType
	//	*SetVlanAttributeRequest_BroadcastFloodGroup
	//	*SetVlanAttributeRequest_CustomIgmpSnoopingEnable
	//	*SetVlanAttributeRequest_TamObject
	Attr isSetVlanAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (x *SetVlanAttributeRequest) GetMaxLearnedAddresses() uint32 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_MaxLearnedAddresses); ok {
		return x.MaxLearnedAddresses
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetStpInstance() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_StpInstance); ok {
		return x.StpInstance
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetLearnDisable() bool {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_LearnDisable); ok {
		return x.LearnDisable
	}
	return false
}
...
func (x *SetVlanAttributeRequest) GetIpv4McastLookupKeyType() VlanMcastLookupKeyType {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_Ipv4McastLookupKeyType); ok {
		return x.Ipv4McastLookupKeyType
	}
	return VlanMcastLookupKeyType_VLAN_MCAST_LOOKUP_KEY_TYPE_UNSPECIFIED
}
...
func (x *SetVlanAttributeRequest) GetIpv6McastLookupKeyType() VlanMcastLookupKeyType {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_Ipv6McastLookupKeyType); ok {
		return x.Ipv6McastLookupKeyType
	}
	return VlanMcastLookupKeyType_VLAN_MCAST_LOOKUP_KEY_TYPE_UNSPECIFIED
}
...
func (x *SetVlanAttributeRequest) GetUnknownNonIpMcastOutputGroupId() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownNonIpMcastOutputGroupId); ok {
		return x.UnknownNonIpMcastOutputGroupId
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetUnknownIpv4McastOutputGroupId() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownIpv4McastOutputGroupId); ok {
		return x.UnknownIpv4McastOutputGroupId
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetUnknownIpv6McastOutputGroupId() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownIpv6McastOutputGroupId); ok {
		return x.UnknownIpv6McastOutputGroupId
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetUnknownLinklocalMcastOutputGroupId() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownLinklocalMcastOutputGroupId); ok {
		return x.UnknownLinklocalMcastOutputGroupId
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetIngressAcl() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_IngressAcl); ok {
		return x.IngressAcl
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetEgressAcl() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_EgressAcl); ok {
		return x.EgressAcl
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetMetaData() uint32 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_MetaData); ok {
		return x.MetaData
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetUnknownUnicastFloodControlType() VlanFloodControlType {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownUnicastFloodControlType); ok {
		return x.UnknownUnicastFloodControlType
	}
	return VlanFloodControlType_VLAN_FLOOD_CONTROL_TYPE_UNSPECIFIED
}
...
func (x *SetVlanAttributeRequest) GetUnknownUnicastFloodGroup() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownUnicastFloodGroup); ok {
		return x.UnknownUnicastFloodGroup
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetUnknownMulticastFloodControlType() VlanFloodControlType {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownMulticastFloodControlType); ok {
		return x.UnknownMulticastFloodControlType
	}
	return VlanFloodControlType_VLAN_FLOOD_CONTROL_TYPE_UNSPECIFIED
}
...
func (x *SetVlanAttributeRequest) GetUnknownMulticastFloodGroup() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_UnknownMulticastFloodGroup); ok {
		return x.UnknownMulticastFloodGroup
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetBroadcastFloodControlType() VlanFloodControlType {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_BroadcastFloodControlType); ok {
		return x.BroadcastFloodControlType
	}
	return VlanFloodControlType_VLAN_FLOOD_CONTROL_TYPE_UNSPECIFIED
}
...
func (x *SetVlanAttributeRequest) GetBroadcastFloodGroup() uint64 {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_BroadcastFloodGroup); ok {
		return x.BroadcastFloodGroup
	}
	return 0
}
...
func (x *SetVlanAttributeRequest) GetCustomIgmpSnoopingEnable() bool {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_CustomIgmpSnoopingEnable); ok {
		return x.CustomIgmpSnoopingEnable
	}
	return false
}

func (x *SetVlanAttributeRequest) GetTamObject() *Uint64List {
	if x, ok := x.GetAttr().(*SetVlanAttributeRequest_TamObject); ok {
		return x.TamObject
	}
	return nil
}

type isSetVlanAttributeRequest_Attr interface {
	isSetVlanAttributeRequest_Attr()
}

type SetVlanAttributeRequest_MaxLearnedAddresses struct {
	MaxLearnedAddresses uint32 `protobuf:"varint,2,opt,name=max_learned_addresses,json=maxLearnedAddresses,proto3,oneof"`
}

type SetVlanAttributeRequest_StpInstance struct {
	StpInstance uint64 `protobuf:"varint,3,opt,name=stp_instance,json=stpInstance,proto3,oneof"`
}

type SetVlanAttributeRequest_LearnDisable struct {
	LearnDisable bool `protobuf:"varint,4,opt,name=learn_disable,json=learnDisable,proto3,oneof"`
}

type SetVlanAttributeRequest_Ipv4McastLookupKeyType struct {
	Ipv4McastLookupKeyType VlanMcastLookupKeyType `protobuf:"varint,5,opt,name=ipv4_mcast_lookup_key_type,json=ipv4McastLookupKeyType,proto3,enum=lemming.dataplane.sai.VlanMcastLookupKeyType,oneof"`
}

type SetVlanAttributeRequest_Ipv6McastLookupKeyType struct {
	Ipv6McastLookupKeyType VlanMcastLookupKeyType `protobuf:"varint,6,opt,name=ipv6_mcast_lookup_key_type,json=ipv6McastLookupKeyType,proto3,enum=lemming.dataplane.sai.VlanMcastLookupKeyType,oneof"`
}

type SetVlanAttributeRequest_UnknownNonIpMcastOutputGroupId struct {
	UnknownNonIpMcastOutputGroupId uint64 `protobuf:"varint,7,opt,name=unknown_non_ip_mcast_output_group_id,json=unknownNonIpMcastOutputGroupId,proto3,oneof"`
}

type SetVlanAttributeRequest_UnknownIpv4McastOutputGroupId struct {
	UnknownIpv4McastOutputGroupId uint64 `protobuf:"varint,8,opt,name=unknown_ipv4_mcast_output_group_id,json=unknownIpv4McastOutputGroupId,proto3,oneof"`
}

type SetVlanAttributeRequest_UnknownIpv6McastOutputGroupId struct {
	UnknownIpv6McastOutputGroupId uint64 `protobuf:"varint,9,opt,name=unknown_ipv6_mcast_output_group_id,json=unknownIpv6McastOutputGroupId,proto3,oneof"`
}

type SetVlanAttributeRequest_UnknownLinklocalMcastOutputGroupId struct {
	UnknownLinklocalMcastOutputGroupId uint64 `protobuf:"varint,10,opt,name=unknown_linklocal_mcast_output_group_id,json=unknownLinklocalMcastOutputGroupId,proto3,oneof"`
}

type SetVlanAttributeRequest_IngressAcl struct {
	IngressAcl uint64 `protobuf:"varint,11,opt,name=ingress_acl,json=ingressAcl,proto3,oneof"`
}

type SetVlanAttributeRequest_EgressAcl struct {
	EgressAcl uint64 `protobuf:"varint,12,opt,name=egress_acl,json=egressAcl,proto3,oneof"`
}

type SetVlanAttributeRequest_MetaData struct {
	MetaData uint32 `protobuf:"varint,13,opt,name=meta_data,json=metaData,proto3,oneof"`
}

type SetVlanAttributeRequest_UnknownUnicastFloodControlType struct {
	UnknownUnicastFloodControlType VlanFloodControlType `protobuf:"varint,14,opt,name=unknown_unicast_flood_control_type,json=unknownUnicastFloodControlType,proto3,enum=lemming.dataplane.sai.VlanFloodControlType,oneof"`
}

type SetVlanAttributeRequest_UnknownUnicastFloodGroup struct {
	UnknownUnicastFloodGroup uint64 `protobuf:"varint,15,opt,name=unknown_unicast_flood_group,json=unknownUnicastFloodGroup,proto3,oneof"`
}

type SetVlanAttributeRequest_UnknownMulticastFloodControlType struct {
	UnknownMulticastFloodControlType VlanFloodControlType `protobuf:"varint,16,opt,name=unknown_multicast_flood_control_type,json=unknownMulticastFloodControlType,proto3,enum=lemming.dataplane.sai.VlanFloodControlType,oneof"`
}

type SetVlanAttributeRequest_UnknownMulticastFloodGroup struct {
	UnknownMulticastFloodGroup uint64 `protobuf:"varint,17,opt,name=unknown_multicast_flood_group,json=unknownMulticastFloodGroup,proto3,oneof"`
}

type SetVlanAttributeRequest_BroadcastFloodControlType struct {
	BroadcastFloodControlType VlanFloodControlType `protobuf:"varint,18,opt,name=broadcast_flood_control_type,json=broadcastFloodControlType,proto3,enum=lemming.dataplane.sai.VlanFloodControlType,oneof"`
}

type SetVlanAttributeRequest_BroadcastFloodGroup struct {
	BroadcastFloodGroup uint64 `protobuf:"varint,19,opt,name=broadcast_flood_group,json=broadcastFloodGroup,proto3,oneof"`
}

type SetVlanAttributeRequest_CustomIgmpSnoopingEnable struct {
	CustomIgmpSnoopingEnable bool `protobuf:"varint,20,opt,name=custom_igmp_snooping_enable,json=customIgmpSnoopingEnable,proto3,oneof"`
}

type SetVlanAttributeRequest_TamObject struct {
	TamObject *Uint64List `protobuf:"bytes,21,opt,name=tam_object,json=tamObject,proto3,oneof"`
}

func (*SetVlanAttributeRequest_MaxLearnedAddresses) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_StpInstance) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_LearnDisable) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_Ipv4McastLookupKeyType) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_Ipv6McastLookupKeyType) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownNonIpMcastOutputGroupId) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownIpv4McastOutputGroupId) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownIpv6McastOutputGroupId) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownLinklocalMcastOutputGroupId) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_IngressAcl) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_EgressAcl) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_MetaData) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownUnicastFloodControlType) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownUnicastFloodGroup) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownMulticastFloodControlType) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_UnknownMulticastFloodGroup) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_BroadcastFloodControlType) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_BroadcastFloodGroup) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_CustomIgmpSnoopingEnable) isSetVlanAttributeRequest_Attr() {}

func (*SetVlanAttributeRequest_TamObject) isSetVlanAttributeRequest_Attr() {}
...
type GetVlanAttributeResponse struct {
	...
	Attr []*VlanAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateVlanMemberRequest struct {
	...
	Switch          uint64          `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	VlanId          uint64          `protobuf:"varint,2,opt,name=vlan_id,json=vlanId,proto3" json:"vlan_id,omitempty"`
	BridgePortId    uint64          `protobuf:"varint,3,opt,name=bridge_port_id,json=bridgePortId,proto3" json:"bridge_port_id,omitempty"`
	VlanTaggingMode VlanTaggingMode `protobuf:"varint,4,opt,name=vlan_tagging_mode,json=vlanTaggingMode,proto3,enum=lemming.dataplane.sai.VlanTaggingMode" json:"vlan_tagging_mode,omitempty"`
}
...
type SetVlanMemberAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetVlanMemberAttributeRequest_VlanTaggingMode
	Attr isSetVlanMemberAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetVlanMemberAttributeRequest) GetAttr() isSetVlanMemberAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetVlanMemberAttributeRequest) GetVlanTaggingMode() VlanTaggingMode {
	if x, ok := x.GetAttr().(*SetVlanMemberAttributeRequest_VlanTaggingMode); ok {
		return x.VlanTaggingMode
	}
	return VlanTaggingMode_VLAN_TAGGING_MODE_UNSPECIFIED
}

type isSetVlanMemberAttributeRequest_Attr interface {
	isSetVlanMemberAttributeRequest_Attr()
}

type SetVlanMemberAttributeRequest_VlanTaggingMode struct {
	VlanTaggingMode VlanTaggingMode `protobuf:"varint,2,opt,name=vlan_tagging_mode,json=vlanTaggingMode,proto3,enum=lemming.dataplane.sai.VlanTaggingMode,oneof"`
}

func (*SetVlanMemberAttributeRequest_VlanTaggingMode) isSetVlanMemberAttributeRequest_Attr() {}
...
type GetVlanMemberAttributeResponse struct {
	...
	Attr []*VlanMemberAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_vlan_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x0b, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
	...
	,
	...
	,
	...
	0x6c, 0x6f, 0x6f, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x52,
	...
	,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0xde, 0x0b, 0x0a, 0x17, 0x53, 0x65, 0x74, 0x56, 0x6c, 0x61, 0x6e, 0x41,
	...
	,
	...
	0x56, 0x6c, 0x61, 0x6e, 0x4d, 0x63, 0x61, 0x73, 0x74, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x4b,
	0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x16, 0x69, 0x70, 0x76, 0x34, 0x4d, 0x63,
	0x61, 0x73, 0x74, 0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x4b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x6b, 0x0a, 0x1a, 0x69, 0x70, 0x76, 0x36, 0x5f, 0x6d, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x6c,
	...
	0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x16, 0x69, 0x70, 0x76, 0x36, 0x4d, 0x63, 0x61, 0x73, 0x74,
	0x4c, 0x6f, 0x6f, 0x6b, 0x75, 0x70, 0x4b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x4e, 0x0a,
	0x24, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x5f, 0x6e, 0x6f, 0x6e, 0x5f, 0x69, 0x70, 0x5f,
	0x6d, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x1e, 0x75,
	0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x4e, 0x6f, 0x6e, 0x49, 0x70, 0x4d, 0x63, 0x61, 0x73, 0x74,
	0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x4b, 0x0a,
	...
	0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x1d, 0x75, 0x6e, 0x6b,
	0x6e, 0x6f, 0x77, 0x6e, 0x49, 0x70, 0x76, 0x34, 0x4d, 0x63, 0x61, 0x73, 0x74, 0x4f, 0x75, 0x74,
	0x70, 0x75, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x4b, 0x0a, 0x22, 0x75, 0x6e,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x1d, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77,
	0x6e, 0x49, 0x70, 0x76, 0x36, 0x4d, 0x63, 0x61, 0x73, 0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x55, 0x0a, 0x27, 0x75, 0x6e, 0x6b, 0x6e, 0x6f,
	...
	0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x22, 0x75, 0x6e, 0x6b, 0x6e,
	0x6f, 0x77, 0x6e, 0x4c, 0x69, 0x6e, 0x6b, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x4d, 0x63, 0x61, 0x73,
	0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x21,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x2a, 0xfa, 0x06, 0x0a,
	...
	0x4e, 0x47, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x10, 0x03, 0x32, 0xc0, 0x07, 0x0a, 0x04, 0x56, 0x6c,
...
var file_dataplane_standalone_proto_vlan_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_dataplane_standalone_proto_vlan_proto_goTypes = []interface{}{
	...
	(VlanMcastLookupKeyType)(0),            // 18: lemming.dataplane.sai.VlanMcastLookupKeyType
	(VlanFloodControlType)(0),              // 19: lemming.dataplane.sai.VlanFloodControlType
	(*Uint64List)(nil),                     // 20: lemming.dataplane.sai.Uint64List
	(*VlanAttribute)(nil),                  // 21: lemming.dataplane.sai.VlanAttribute
	(VlanTaggingMode)(0),                   // 22: lemming.dataplane.sai.VlanTaggingMode
	(*VlanMemberAttribute)(nil),            // 23: lemming.dataplane.sai.VlanMemberAttribute
}
var file_dataplane_standalone_proto_vlan_proto_depIdxs = []int32{
	18, // 0: lemming.dataplane.sai.CreateVlanRequest.ipv4_mcast_lookup_key_type:type_name -> lemming.dataplane.sai.VlanMcastLookupKeyType
	18, // 1: lemming.dataplane.sai.CreateVlanRequest.ipv6_mcast_lookup_key_type:type_name -> lemming.dataplane.sai.VlanMcastLookupKeyType
	19, // 2: lemming.dataplane.sai.CreateVlanRequest.unknown_unicast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	19, // 3: lemming.dataplane.sai.CreateVlanRequest.unknown_multicast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	19, // 4: lemming.dataplane.sai.CreateVlanRequest.broadcast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	18, // 5: lemming.dataplane.sai.SetVlanAttributeRequest.ipv4_mcast_lookup_key_type:type_name -> lemming.dataplane.sai.VlanMcastLookupKeyType
	18, // 6: lemming.dataplane.sai.SetVlanAttributeRequest.ipv6_mcast_lookup_key_type:type_name -> lemming.dataplane.sai.VlanMcastLookupKeyType
	19, // 7: lemming.dataplane.sai.SetVlanAttributeRequest.unknown_unicast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	19, // 8: lemming.dataplane.sai.SetVlanAttributeRequest.unknown_multicast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	19, // 9: lemming.dataplane.sai.SetVlanAttributeRequest.broadcast_flood_control_type:type_name -> lemming.dataplane.sai.VlanFloodControlType
	20, // 10: lemming.dataplane.sai.SetVlanAttributeRequest.tam_object:type_name -> lemming.dataplane.sai.Uint64List
	0,  // 11: lemming.dataplane.sai.GetVlanAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.VlanAttr
	21, // 12: lemming.dataplane.sai.GetVlanAttributeResponse.attr:type_name -> lemming.dataplane.sai.VlanAttribute
	22, // 13: lemming.dataplane.sai.CreateVlanMemberRequest.vlan_tagging_mode:type_name -> lemming.dataplane.sai.VlanTaggingMode
	22, // 14: lemming.dataplane.sai.SetVlanMemberAttributeRequest.vlan_tagging_mode:type_name -> lemming.dataplane.sai.VlanTaggingMode
	1,  // 15: lemming.dataplane.sai.GetVlanMemberAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.VlanMemberAttr
	23, // 16: lemming.dataplane.sai.GetVlanMemberAttributeResponse.attr:type_name -> lemming.dataplane.sai.VlanMemberAttribute
	2,  // 17: lemming.dataplane.sai.Vlan.CreateVlan:input_type -> lemming.dataplane.sai.CreateVlanRequest
	4,  // 18: lemming.dataplane.sai.Vlan.RemoveVlan:input_type -> lemming.dataplane.sai.RemoveVlanRequest
	6,  // 19: lemming.dataplane.sai.Vlan.SetVlanAttribute:input_type -> lemming.dataplane.sai.SetVlanAttributeRequest
	8,  // 20: lemming.dataplane.sai.Vlan.GetVlanAttribute:input_type -> lemming.dataplane.sai.GetVlanAttributeRequest
	10, // 21: lemming.dataplane.sai.Vlan.CreateVlanMember:input_type -> lemming.dataplane.sai.CreateVlanMemberRequest
	12, // 22: lemming.dataplane.sai.Vlan.RemoveVlanMember:input_type -> lemming.dataplane.sai.RemoveVlanMemberRequest
	14, // 23: lemming.dataplane.sai.Vlan.SetVlanMemberAttribute:input_type -> lemming.dataplane.sai.SetVlanMemberAttributeRequest
	16, // 24: lemming.dataplane.sai.Vlan.GetVlanMemberAttribute:input_type -> lemming.dataplane.sai.GetVlanMemberAttributeRequest
	3,  // 25: lemming.dataplane.sai.Vlan.CreateVlan:output_type -> lemming.dataplane.sai.CreateVlanResponse
	5,  // 26: lemming.dataplane.sai.Vlan.RemoveVlan:output_type -> lemming.dataplane.sai.RemoveVlanResponse
	7,  // 27: lemming.dataplane.sai.Vlan.SetVlanAttribute:output_type -> lemming.dataplane.sai.SetVlanAttributeResponse
	9,  // 28: lemming.dataplane.sai.Vlan.GetVlanAttribute:output_type -> lemming.dataplane.sai.GetVlanAttributeResponse
	11, // 29: lemming.dataplane.sai.Vlan.CreateVlanMember:output_type -> lemming.dataplane.sai.CreateVlanMemberResponse
	13, // 30: lemming.dataplane.sai.Vlan.RemoveVlanMember:output_type -> lemming.dataplane.sai.RemoveVlanMemberResponse
	15, // 31: lemming.dataplane.sai.Vlan.SetVlanMemberAttribute:output_type -> lemming.dataplane.sai.SetVlanMemberAttributeResponse
	17, // 32: lemming.dataplane.sai.Vlan.GetVlanMemberAttribute:output_type -> lemming.dataplane.sai.GetVlanMemberAttributeResponse
...
func file_dataplane_standalone_proto_vlan_proto_init() {
	...
	file_dataplane_standalone_proto_vlan_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetVlanAttributeRequest_MaxLearnedAddresses)(nil),
		(*SetVlanAttributeRequest_StpInstance)(nil),
		(*SetVlanAttributeRequest_LearnDisable)(nil),
		(*SetVlanAttributeRequest_Ipv4McastLookupKeyType)(nil),
		(*SetVlanAttributeRequest_Ipv6McastLookupKeyType)(nil),
		(*SetVlanAttributeRequest_UnknownNonIpMcastOutputGroupId)(nil),
		(*SetVlanAttributeRequest_UnknownIpv4McastOutputGroupId)(nil),
		(*SetVlanAttributeRequest_UnknownIpv6McastOutputGroupId)(nil),
		(*SetVlanAttributeRequest_UnknownLinklocalMcastOutputGroupId)(nil),
		(*SetVlanAttributeRequest_IngressAcl)(nil),
		(*SetVlanAttributeRequest_EgressAcl)(nil),
		(*SetVlanAttributeRequest_MetaData)(nil),
		(*SetVlanAttributeRequest_UnknownUnicastFloodControlType)(nil),
		(*SetVlanAttributeRequest_UnknownUnicastFloodGroup)(nil),
		(*SetVlanAttributeRequest_UnknownMulticastFloodControlType)(nil),
		(*SetVlanAttributeRequest_UnknownMulticastFloodGroup)(nil),
		(*SetVlanAttributeRequest_BroadcastFloodControlType)(nil),
		(*SetVlanAttributeRequest_BroadcastFloodGroup)(nil),
		(*SetVlanAttributeRequest_CustomIgmpSnoopingEnable)(nil),
		(*SetVlanAttributeRequest_TamObject)(nil),
	}
	file_dataplane_standalone_proto_vlan_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*SetVlanMemberAttributeRequest_VlanTaggingMode)(nil),
	}
	type x struct{}
