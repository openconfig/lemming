...
type CreateSrv6SidlistRequest struct {
	...
	Type        Srv6SidlistType `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.Srv6SidlistType" json:"type,omitempty"`
...
type SetSrv6SidlistAttributeRequest struct {
	...
	//
	//	*SetSrv6SidlistAttributeRequest_TlvList
	//	*SetSrv6SidlistAttributeRequest_SegmentList
	Attr isSetSrv6SidlistAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetSrv6SidlistAttributeRequest) GetAttr() isSetSrv6SidlistAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetSrv6SidlistAttributeRequest) GetTlvList() *TlvEntryList {
	if x, ok := x.GetAttr().(*SetSrv6SidlistAttributeRequest_TlvList); ok {
		return x.TlvList
	}
	return nil
}

func (x *SetSrv6SidlistAttributeRequest) GetSegmentList() *BytesList {
	if x, ok := x.GetAttr().(*SetSrv6SidlistAttributeRequest_SegmentList); ok {
		return x.SegmentList
	}
	return nil
}

type isSetSrv6SidlistAttributeRequest_Attr interface {
	isSetSrv6SidlistAttributeRequest_Attr()
}

type SetSrv6SidlistAttributeRequest_TlvList struct {
	TlvList *TlvEntryList `protobuf:"bytes,2,opt,name=tlv_list,json=tlvList,proto3,oneof"`
}

type SetSrv6SidlistAttributeRequest_SegmentList struct {
	SegmentList *BytesList `protobuf:"bytes,3,opt,name=segment_list,json=segmentList,proto3,oneof"`
}

func (*SetSrv6SidlistAttributeRequest_TlvList) isSetSrv6SidlistAttributeRequest_Attr() {}

func (*SetSrv6SidlistAttributeRequest_SegmentList) isSetSrv6SidlistAttributeRequest_Attr() {}
...
type GetSrv6SidlistAttributeResponse struct {
	...
	Attr []*Srv6SidlistAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateMySidEntryRequest struct {
	...
	EndpointBehavior       MySidEntryEndpointBehavior       `protobuf:"varint,2,opt,name=endpoint_behavior,json=endpointBehavior,proto3,enum=lemming.dataplane.sai.MySidEntryEndpointBehavior" json:"endpoint_behavior,omitempty"`
	EndpointBehaviorFlavor MySidEntryEndpointBehaviorFlavor `protobuf:"varint,3,opt,name=endpoint_behavior_flavor,json=endpointBehaviorFlavor,proto3,enum=lemming.dataplane.sai.MySidEntryEndpointBehaviorFlavor" json:"endpoint_behavior_flavor,omitempty"`
	PacketAction           PacketAction                     `protobuf:"varint,4,opt,name=packet_action,json=packetAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"packet_action,omitempty"`
	TrapPriority           uint32                           `protobuf:"varint,5,opt,name=trap_priority,json=trapPriority,proto3" json:"trap_priority,omitempty"`
	NextHopId              uint64                           `protobuf:"varint,6,opt,name=next_hop_id,json=nextHopId,proto3" json:"next_hop_id,omitempty"`
	TunnelId               uint64                           `protobuf:"varint,7,opt,name=tunnel_id,json=tunnelId,proto3" json:"tunnel_id,omitempty"`
	Vrf                    uint64                           `protobuf:"varint,8,opt,name=vrf,proto3" json:"vrf,omitempty"`
...
type SetMySidEntryAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetMySidEntryAttributeRequest_EndpointBehavior
	//	*SetMySidEntryAttributeRequest_EndpointBehaviorFlavor
	//	*SetMySidEntryAttributeRequest_PacketAction
	//	*SetMySidEntryAttributeRequest_TrapPriority
	//	*SetMySidEntryAttributeRequest_NextHopId
	//	*SetMySidEntryAttributeRequest_TunnelId
	//	*SetMySidEntryAttributeRequest_Vrf
	//	*SetMySidEntryAttributeRequest_CounterId
	Attr isSetMySidEntryAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetMySidEntryAttributeRequest) GetAttr() isSetMySidEntryAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetMySidEntryAttributeRequest) GetEndpointBehavior() MySidEntryEndpointBehavior {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_EndpointBehavior); ok {
		return x.EndpointBehavior
	}
	return MySidEntryEndpointBehavior_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_UNSPECIFIED
}
...
func (x *SetMySidEntryAttributeRequest) GetEndpointBehaviorFlavor() MySidEntryEndpointBehaviorFlavor {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_EndpointBehaviorFlavor); ok {
		return x.EndpointBehaviorFlavor
	}
	return MySidEntryEndpointBehaviorFlavor_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_FLAVOR_UNSPECIFIED
}
...
func (x *SetMySidEntryAttributeRequest) GetPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_PacketAction); ok {
		return x.PacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetMySidEntryAttributeRequest) GetTrapPriority() uint32 {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_TrapPriority); ok {
		return x.TrapPriority
	}
	return 0
}
...
func (x *SetMySidEntryAttributeRequest) GetNextHopId() uint64 {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_NextHopId); ok {
		return x.NextHopId
	}
	return 0
}
...
func (x *SetMySidEntryAttributeRequest) GetTunnelId() uint64 {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_TunnelId); ok {
		return x.TunnelId
	}
	return 0
}
...
func (x *SetMySidEntryAttributeRequest) GetVrf() uint64 {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_Vrf); ok {
		return x.Vrf
	}
	return 0
}
...
func (x *SetMySidEntryAttributeRequest) GetCounterId() uint64 {
	if x, ok := x.GetAttr().(*SetMySidEntryAttributeRequest_CounterId); ok {
		return x.CounterId
	}
	return 0
}

type isSetMySidEntryAttributeRequest_Attr interface {
	isSetMySidEntryAttributeRequest_Attr()
}

type SetMySidEntryAttributeRequest_EndpointBehavior struct {
	EndpointBehavior MySidEntryEndpointBehavior `protobuf:"varint,2,opt,name=endpoint_behavior,json=endpointBehavior,proto3,enum=lemming.dataplane.sai.MySidEntryEndpointBehavior,oneof"`
}

type SetMySidEntryAttributeRequest_EndpointBehaviorFlavor struct {
	EndpointBehaviorFlavor MySidEntryEndpointBehaviorFlavor `protobuf:"varint,3,opt,name=endpoint_behavior_flavor,json=endpointBehaviorFlavor,proto3,enum=lemming.dataplane.sai.MySidEntryEndpointBehaviorFlavor,oneof"`
}

type SetMySidEntryAttributeRequest_PacketAction struct {
	PacketAction PacketAction `protobuf:"varint,4,opt,name=packet_action,json=packetAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetMySidEntryAttributeRequest_TrapPriority struct {
	TrapPriority uint32 `protobuf:"varint,5,opt,name=trap_priority,json=trapPriority,proto3,oneof"`
}

type SetMySidEntryAttributeRequest_NextHopId struct {
	NextHopId uint64 `protobuf:"varint,6,opt,name=next_hop_id,json=nextHopId,proto3,oneof"`
}

type SetMySidEntryAttributeRequest_TunnelId struct {
	TunnelId uint64 `protobuf:"varint,7,opt,name=tunnel_id,json=tunnelId,proto3,oneof"`
}

type SetMySidEntryAttributeRequest_Vrf struct {
	Vrf uint64 `protobuf:"varint,8,opt,name=vrf,proto3,oneof"`
}

type SetMySidEntryAttributeRequest_CounterId struct {
	CounterId uint64 `protobuf:"varint,9,opt,name=counter_id,json=counterId,proto3,oneof"`
}

func (*SetMySidEntryAttributeRequest_EndpointBehavior) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_EndpointBehaviorFlavor) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_PacketAction) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_TrapPriority) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_NextHopId) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_TunnelId) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_Vrf) isSetMySidEntryAttributeRequest_Attr() {}

func (*SetMySidEntryAttributeRequest_CounterId) isSetMySidEntryAttributeRequest_Attr() {}
...
type GetMySidEntryAttributeResponse struct {
	...
	Attr []*MySidEntryAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_srv6_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcd, 0x01, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x3a, 0x0a, 0x04,
	...
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x74, 0x6c, 0x76, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6c, 0x65, 0x6d,
	0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73,
	0x61, 0x69, 0x2e, 0x54, 0x4c, 0x56, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x74, 0x6c, 0x76,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0b, 0x73, 0x65, 0x67, 0x6d,
	0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x2d, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x65, 0x22, 0xc3, 0x01, 0x0a, 0x1e, 0x53, 0x65, 0x74, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64,
	...
	,
	...
	0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x82, 0x04, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61,
	...
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x5e, 0x0a, 0x11,
	...
	0x6e, 0x74, 0x42, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x52, 0x10, 0x65, 0x6e, 0x64, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x42, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x12, 0x71, 0x0a, 0x18,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x62, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f,
	0x72, 0x5f, 0x66, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x37,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	...
	0x72, 0x46, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x52, 0x16, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x42, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x46, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x12,
	0x48, 0x0a, 0x0d, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x76, 0x65, 0x4d, 0x79, 0x53, 0x69, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74,
	0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x4d, 0x79, 0x53, 0x69, 0x64,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa0, 0x04, 0x0a, 0x1d, 0x53, 0x65, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x00, 0x12, 0x78, 0x0a, 0x11, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x72, 0x76, 0x36,
	0x53, 0x69, 0x64, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x2f, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e,
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64, 0x6c, 0x69, 0x73,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x30, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69,
	...
	0x17, 0x53, 0x65, 0x74, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64, 0x6c, 0x69, 0x73, 0x74, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x35, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69,
	0x2e, 0x53, 0x65, 0x74, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64, 0x6c, 0x69, 0x73, 0x74, 0x41,
	...
	0x74, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64, 0x6c, 0x69, 0x73, 0x74, 0x41, 0x74, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x35, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x47, 0x65,
	0x74, 0x53, 0x72, 0x76, 0x36, 0x53, 0x69, 0x64, 0x6c, 0x69, 0x73, 0x74, 0x41, 0x74, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x36, 0x2e, 0x6c,
	0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x87, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x74, 0x4d, 0x79, 0x53, 0x69,
	...
	0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x53, 0x65, 0x74, 0x4d, 0x79, 0x53, 0x69, 0x64,
	...
	0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4d, 0x79, 0x53, 0x69, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x34, 0x2e, 0x6c, 0x65, 0x6d, 0x6d,
	0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61,
	0x69, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x79, 0x53, 0x69, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
...
var file_dataplane_standalone_proto_srv6_proto_goTypes = []interface{}{
	...
	(*TlvEntryList)(nil),                    // 20: lemming.dataplane.sai.TlvEntryList
	(*BytesList)(nil),                       // 21: lemming.dataplane.sai.BytesList
	(*Srv6SidlistAttribute)(nil),            // 22: lemming.dataplane.sai.Srv6SidlistAttribute
	(*MySidEntry)(nil),                      // 23: lemming.dataplane.sai.MySidEntry
	(MySidEntryEndpointBehavior)(0),         // 24: lemming.dataplane.sai.MySidEntryEndpointBehavior
	(MySidEntryEndpointBehaviorFlavor)(0),   // 25: lemming.dataplane.sai.MySidEntryEndpointBehaviorFlavor
	(PacketAction)(0),                       // 26: lemming.dataplane.sai.PacketAction
	(*MySidEntryAttribute)(nil),             // 27: lemming.dataplane.sai.MySidEntryAttribute
}
var file_dataplane_standalone_proto_srv6_proto_depIdxs = []int32{
	...
	20, // 2: lemming.dataplane.sai.SetSrv6SidlistAttributeRequest.tlv_list:type_name -> lemming.dataplane.sai.TlvEntryList
	21, // 3: lemming.dataplane.sai.SetSrv6SidlistAttributeRequest.segment_list:type_name -> lemming.dataplane.sai.BytesList
	0,  // 4: lemming.dataplane.sai.GetSrv6SidlistAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.Srv6SidlistAttr
	22, // 5: lemming.dataplane.sai.GetSrv6SidlistAttributeResponse.attr:type_name -> lemming.dataplane.sai.Srv6SidlistAttribute
	23, // 6: lemming.dataplane.sai.CreateMySidEntryRequest.entry:type_name -> lemming.dataplane.sai.MySidEntry
	24, // 7: lemming.dataplane.sai.CreateMySidEntryRequest.endpoint_behavior:type_name -> lemming.dataplane.sai.MySidEntryEndpointBehavior
	25, // 8: lemming.dataplane.sai.CreateMySidEntryRequest.endpoint_behavior_flavor:type_name -> lemming.dataplane.sai.MySidEntryEndpointBehaviorFlavor
	26, // 9: lemming.dataplane.sai.CreateMySidEntryRequest.packet_action:type_name -> lemming.dataplane.sai.PacketAction
	23, // 10: lemming.dataplane.sai.RemoveMySidEntryRequest.entry:type_name -> lemming.dataplane.sai.MySidEntry
	23, // 11: lemming.dataplane.sai.SetMySidEntryAttributeRequest.entry:type_name -> lemming.dataplane.sai.MySidEntry
	24, // 12: lemming.dataplane.sai.SetMySidEntryAttributeRequest.endpoint_behavior:type_name -> lemming.dataplane.sai.MySidEntryEndpointBehavior
	25, // 13: lemming.dataplane.sai.SetMySidEntryAttributeRequest.endpoint_behavior_flavor:type_name -> lemming.dataplane.sai.MySidEntryEndpointBehaviorFlavor
	26, // 14: lemming.dataplane.sai.SetMySidEntryAttributeRequest.packet_action:type_name -> lemming.dataplane.sai.PacketAction
	23, // 15: lemming.dataplane.sai.GetMySidEntryAttributeRequest.entry:type_name -> lemming.dataplane.sai.MySidEntry
	1,  // 16: lemming.dataplane.sai.GetMySidEntryAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.MySidEntryAttr
	27, // 17: lemming.dataplane.sai.GetMySidEntryAttributeResponse.attr:type_name -> lemming.dataplane.sai.MySidEntryAttribute
	2,  // 18: lemming.dataplane.sai.Srv6.CreateSrv6Sidlist:input_type -> lemming.dataplane.sai.CreateSrv6SidlistRequest
	4,  // 19: lemming.dataplane.sai.Srv6.RemoveSrv6Sidlist:input_type -> lemming.dataplane.sai.RemoveSrv6SidlistRequest
	6,  // 20: lemming.dataplane.sai.Srv6.SetSrv6SidlistAttribute:input_type -> lemming.dataplane.sai.SetSrv6SidlistAttributeRequest
	8,  // 21: lemming.dataplane.sai.Srv6.GetSrv6SidlistAttribute:input_type -> lemming.dataplane.sai.GetSrv6SidlistAttributeRequest
	10, // 22: lemming.dataplane.sai.Srv6.CreateMySidEntry:input_type -> lemming.dataplane.sai.CreateMySidEntryRequest
	12, // 23: lemming.dataplane.sai.Srv6.RemoveMySidEntry:input_type -> lemming.dataplane.sai.RemoveMySidEntryRequest
	14, // 24: lemming.dataplane.sai.Srv6.SetMySidEntryAttribute:input_type -> lemming.dataplane.sai.SetMySidEntryAttributeRequest
	16, // 25: lemming.dataplane.sai.Srv6.GetMySidEntryAttribute:input_type -> lemming.dataplane.sai.GetMySidEntryAttributeRequest
	3,  // 26: lemming.dataplane.sai.Srv6.CreateSrv6Sidlist:output_type -> lemming.dataplane.sai.CreateSrv6SidlistResponse
	5,  // 27: lemming.dataplane.sai.Srv6.RemoveSrv6Sidlist:output_type -> lemming.dataplane.sai.RemoveSrv6SidlistResponse
	7,  // 28: lemming.dataplane.sai.Srv6.SetSrv6SidlistAttribute:output_type -> lemming.dataplane.sai.SetSrv6SidlistAttributeResponse
	9,  // 29: lemming.dataplane.sai.Srv6.GetSrv6SidlistAttribute:output_type -> lemming.dataplane.sai.GetSrv6SidlistAttributeResponse
	11, // 30: lemming.dataplane.sai.Srv6.CreateMySidEntry:output_type -> lemming.dataplane.sai.CreateMySidEntryResponse
	13, // 31: lemming.dataplane.sai.Srv6.RemoveMySidEntry:output_type -> lemming.dataplane.sai.RemoveMySidEntryResponse
	15, // 32: lemming.dataplane.sai.Srv6.SetMySidEntryAttribute:output_type -> lemming.dataplane.sai.SetMySidEntryAttributeResponse
	17, // 33: lemming.dataplane.sai.Srv6.GetMySidEntryAttribute:output_type -> lemming.dataplane.sai.GetMySidEntryAttributeResponse
...
func file_dataplane_standalone_proto_srv6_proto_init() {
	...
	file_dataplane_standalone_proto_srv6_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetSrv6SidlistAttributeRequest_TlvList)(nil),
		(*SetSrv6SidlistAttributeRequest_SegmentList)(nil),
	}
	file_dataplane_standalone_proto_srv6_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*SetMySidEntryAttributeRequest_EndpointBehavior)(nil),
		(*SetMySidEntryAttributeRequest_EndpointBehaviorFlavor)(nil),
		(*SetMySidEntryAttributeRequest_PacketAction)(nil),
		(*SetMySidEntryAttributeRequest_TrapPriority)(nil),
		(*SetMySidEntryAttributeRequest_NextHopId)(nil),
		(*SetMySidEntryAttributeRequest_TunnelId)(nil),
		(*SetMySidEntryAttributeRequest_Vrf)(nil),
		(*SetMySidEntryAttributeRequest_CounterId)(nil),
	}
	type x struct{}
