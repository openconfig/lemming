...
// 	protoc        v3.21.12
// source: dataplane/standalone/proto/debug_counter.proto
...
func (DebugCounterAttr) Descriptor() protoreflect.EnumDescriptor {
	return file_dataplane_standalone_proto_debug_counter_proto_enumTypes[0].Descriptor()
}

func (DebugCounterAttr) Type() protoreflect.EnumType {
	return &file_dataplane_standalone_proto_debug_counter_proto_enumTypes[0]
}
...
func (DebugCounterAttr) EnumDescriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateDebugCounterRequest) Reset() {
	*x = CreateDebugCounterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[0]
...
func (x *CreateDebugCounterResponse) Reset() {
	*x = CreateDebugCounterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateDebugCounterResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{1}
}
...
func (x *RemoveDebugCounterRequest) Reset() {
	*x = RemoveDebugCounterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemoveDebugCounterRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{2}
}
...
func (x *RemoveDebugCounterResponse) Reset() {
	*x = RemoveDebugCounterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemoveDebugCounterResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{3}
}
...
type SetDebugCounterAttributeRequest struct {
	...
	//
	//	*SetDebugCounterAttributeRequest_InDropReasonList
	//	*SetDebugCounterAttributeRequest_OutDropReasonList
	Attr isSetDebugCounterAttributeRequest_Attr `protobuf_oneof:"attr"`
}

func (x *SetDebugCounterAttributeRequest) Reset() {
	*x = SetDebugCounterAttributeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDebugCounterAttributeRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{4}
}
...
func (m *SetDebugCounterAttributeRequest) GetAttr() isSetDebugCounterAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetDebugCounterAttributeRequest) GetInDropReasonList() *InDropReasonList {
	if x, ok := x.GetAttr().(*SetDebugCounterAttributeRequest_InDropReasonList); ok {
		return x.InDropReasonList
	}
	return nil
}

func (x *SetDebugCounterAttributeRequest) GetOutDropReasonList() *OutDropReasonList {
	if x, ok := x.GetAttr().(*SetDebugCounterAttributeRequest_OutDropReasonList); ok {
		return x.OutDropReasonList
	}
	return nil
}

type isSetDebugCounterAttributeRequest_Attr interface {
	isSetDebugCounterAttributeRequest_Attr()
}

type SetDebugCounterAttributeRequest_InDropReasonList struct {
	InDropReasonList *InDropReasonList `protobuf:"bytes,2,opt,name=in_drop_reason_list,json=inDropReasonList,proto3,oneof"`
}

type SetDebugCounterAttributeRequest_OutDropReasonList struct {
	OutDropReasonList *OutDropReasonList `protobuf:"bytes,3,opt,name=out_drop_reason_list,json=outDropReasonList,proto3,oneof"`
}

func (*SetDebugCounterAttributeRequest_InDropReasonList) isSetDebugCounterAttributeRequest_Attr() {}

func (*SetDebugCounterAttributeRequest_OutDropReasonList) isSetDebugCounterAttributeRequest_Attr() {}
...
func (x *SetDebugCounterAttributeResponse) Reset() {
	*x = SetDebugCounterAttributeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDebugCounterAttributeResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetDebugCounterAttributeRequest) Reset() {
	*x = GetDebugCounterAttributeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetDebugCounterAttributeRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{6}
}
...
type GetDebugCounterAttributeResponse struct {
	...
	Attr []*DebugCounterAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}

func (x *GetDebugCounterAttributeResponse) Reset() {
	*x = GetDebugCounterAttributeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_debug_counter_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetDebugCounterAttributeResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP(), []int{7}
}
...
var File_dataplane_standalone_proto_debug_counter_proto protoreflect.FileDescriptor

var file_dataplane_standalone_proto_debug_counter_proto_rawDesc = []byte{
	0x0a, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2f, 0x73, 0x74, 0x61, 0x6e,
	0x64, 0x61, 0x6c, 0x6f, 0x6e, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x64, 0x65, 0x62,
	0x75, 0x67, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x15, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c,
	0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x1a, 0x27, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	...
	0x22, 0xeb, 0x02, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06,
	0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x3b, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	...
	0x75, 0x67, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x12, 0x4e, 0x0a, 0x0b, 0x62, 0x69, 0x6e, 0x64, 0x5f, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69,
	0x2e, 0x44, 0x65, 0x62, 0x75, 0x67, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x42, 0x69, 0x6e,
	0x64, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x0a, 0x62, 0x69, 0x6e, 0x64, 0x4d, 0x65, 0x74,
	0x68, 0x6f, 0x64, 0x12, 0x52, 0x0a, 0x13, 0x69, 0x6e, 0x5f, 0x64, 0x72, 0x6f, 0x70, 0x5f, 0x72,
	...
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x10, 0x69, 0x6e, 0x44, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x55, 0x0a, 0x14, 0x6f, 0x75, 0x74, 0x5f, 0x64,
	0x72, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18,
	...
	0x74, 0x44, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x11, 0x6f, 0x75, 0x74,
	0x44, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x2e,
	0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67, 0x43, 0x6f, 0x75,
	...
	0x0a, 0x19, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67, 0x43, 0x6f, 0x75,
	...
	0x1a, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x44, 0x65, 0x62, 0x75, 0x67, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xf2, 0x01, 0x0a, 0x1f,
	0x53, 0x65, 0x74, 0x44, 0x65, 0x62, 0x75, 0x67, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x41,
	...
	,
	...
	,
	...
	0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x62, 0x75,
	...
	,
	...
	,
...
var (
	file_dataplane_standalone_proto_debug_counter_proto_rawDescOnce sync.Once
	file_dataplane_standalone_proto_debug_counter_proto_rawDescData = file_dataplane_standalone_proto_debug_counter_proto_rawDesc
)

func file_dataplane_standalone_proto_debug_counter_proto_rawDescGZIP() []byte {
	file_dataplane_standalone_proto_debug_counter_proto_rawDescOnce.Do(func() {
		file_dataplane_standalone_proto_debug_counter_proto_rawDescData = protoimpl.X.CompressGZIP(file_dataplane_standalone_proto_debug_counter_proto_rawDescData)
	})
	return file_dataplane_standalone_proto_debug_counter_proto_rawDescData
}

var file_dataplane_standalone_proto_debug_counter_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dataplane_standalone_proto_debug_counter_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_dataplane_standalone_proto_debug_counter_proto_goTypes = []interface{}{
	...
	(*InDropReasonList)(nil),                 // 13: lemming.dataplane.sai.InDropReasonList
	(*OutDropReasonList)(nil),                // 14: lemming.dataplane.sai.OutDropReasonList
	(*DebugCounterAttribute)(nil),            // 15: lemming.dataplane.sai.DebugCounterAttribute
}
var file_dataplane_standalone_proto_debug_counter_proto_depIdxs = []int32{
	...
	13, // 4: lemming.dataplane.sai.SetDebugCounterAttributeRequest.in_drop_reason_list:type_name -> lemming.dataplane.sai.InDropReasonList
	14, // 5: lemming.dataplane.sai.SetDebugCounterAttributeRequest.out_drop_reason_list:type_name -> lemming.dataplane.sai.OutDropReasonList
	0,  // 6: lemming.dataplane.sai.GetDebugCounterAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.DebugCounterAttr
	15, // 7: lemming.dataplane.sai.GetDebugCounterAttributeResponse.attr:type_name -> lemming.dataplane.sai.DebugCounterAttribute
...
func init() { file_dataplane_standalone_proto_debug_counter_proto_init() }
func file_dataplane_standalone_proto_debug_counter_proto_init() {
	if File_dataplane_standalone_proto_debug_counter_proto != nil {
		return
	}
	file_dataplane_standalone_proto_common_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_debug_counter_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_dataplane_standalone_proto_debug_counter_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetDebugCounterAttributeRequest_InDropReasonList)(nil),
		(*SetDebugCounterAttributeRequest_OutDropReasonList)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_dataplane_standalone_proto_debug_counter_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_dataplane_standalone_proto_debug_counter_proto_goTypes,
		DependencyIndexes: file_dataplane_standalone_proto_debug_counter_proto_depIdxs,
		EnumInfos:         file_dataplane_standalone_proto_debug_counter_proto_enumTypes,
		MessageInfos:      file_dataplane_standalone_proto_debug_counter_proto_msgTypes,
	}.Build()
	File_dataplane_standalone_proto_debug_counter_proto = out.File
	file_dataplane_standalone_proto_debug_counter_proto_rawDesc = nil
	file_dataplane_standalone_proto_debug_counter_proto_goTypes = nil
	file_dataplane_standalone_proto_debug_counter_proto_depIdxs = nil
}
...
var _DebugCounter_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "dataplane/standalone/proto/debug_counter.proto",
}
