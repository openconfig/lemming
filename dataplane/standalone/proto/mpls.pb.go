...
func (x *CreateInsegEntriesRequest) Reset() {
	*x = CreateInsegEntriesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_mpls_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateInsegEntriesRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_mpls_proto_rawDescGZIP(), []int{8}
}
...
func (x *CreateInsegEntriesResponse) Reset() {
	*x = CreateInsegEntriesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_standalone_proto_mpls_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateInsegEntriesResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_standalone_proto_mpls_proto_rawDescGZIP(), []int{9}
}
...
var file_dataplane_standalone_proto_mpls_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_dataplane_standalone_proto_mpls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dataplane_standalone_proto_mpls_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_standalone_proto_mpls_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
