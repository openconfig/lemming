...
// 	protoc        v3.21.12
// source: dataplane/standalone/proto/lag.proto
...
type SetLagAttributeRequest struct {
	...
	//
	//	*SetLagAttributeRequest_IngressAcl
	//	*SetLagAttributeRequest_EgressAcl
	//	*SetLagAttributeRequest_PortVlanId
	//	*SetLagAttributeRequest_DefaultVlanPriority
	//	*SetLagAttributeRequest_DropUntagged
	//	*SetLagAttributeRequest_DropTagged
	//	*SetLagAttributeRequest_Tpid
	//	*SetLagAttributeRequest_Label
	Attr isSetLagAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetLagAttributeRequest) GetAttr() isSetLagAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetLagAttributeRequest) GetIngressAcl() uint64 {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_IngressAcl); ok {
		return x.IngressAcl
	}
	return 0
}
...
func (x *SetLagAttributeRequest) GetEgressAcl() uint64 {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_EgressAcl); ok {
		return x.EgressAcl
	}
	return 0
}
...
func (x *SetLagAttributeRequest) GetPortVlanId() uint32 {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_PortVlanId); ok {
		return x.PortVlanId
	}
	return 0
}
...
func (x *SetLagAttributeRequest) GetDefaultVlanPriority() uint32 {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_DefaultVlanPriority); ok {
		return x.DefaultVlanPriority
	}
	return 0
}
...
func (x *SetLagAttributeRequest) GetDropUntagged() bool {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_DropUntagged); ok {
		return x.DropUntagged
	}
	return false
}
...
func (x *SetLagAttributeRequest) GetDropTagged() bool {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_DropTagged); ok {
		return x.DropTagged
	}
	return false
}
...
func (x *SetLagAttributeRequest) GetTpid() uint32 {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_Tpid); ok {
		return x.Tpid
	}
	return 0
}
...
func (x *SetLagAttributeRequest) GetLabel() []byte {
	if x, ok := x.GetAttr().(*SetLagAttributeRequest_Label); ok {
		return x.Label
	}
	return nil
}

type isSetLagAttributeRequest_Attr interface {
	isSetLagAttributeRequest_Attr()
}

type SetLagAttributeRequest_IngressAcl struct {
	IngressAcl uint64 `protobuf:"varint,2,opt,name=ingress_acl,json=ingressAcl,proto3,oneof"`
}

type SetLagAttributeRequest_EgressAcl struct {
	EgressAcl uint64 `protobuf:"varint,3,opt,name=egress_acl,json=egressAcl,proto3,oneof"`
}

type SetLagAttributeRequest_PortVlanId struct {
	PortVlanId uint32 `protobuf:"varint,4,opt,name=port_vlan_id,json=portVlanId,proto3,oneof"`
}

type SetLagAttributeRequest_DefaultVlanPriority struct {
	DefaultVlanPriority uint32 `protobuf:"varint,5,opt,name=default_vlan_priority,json=defaultVlanPriority,proto3,oneof"`
}

type SetLagAttributeRequest_DropUntagged struct {
	DropUntagged bool `protobuf:"varint,6,opt,name=drop_untagged,json=dropUntagged,proto3,oneof"`
}

type SetLagAttributeRequest_DropTagged struct {
	DropTagged bool `protobuf:"varint,7,opt,name=drop_tagged,json=dropTagged,proto3,oneof"`
}

type SetLagAttributeRequest_Tpid struct {
	Tpid uint32 `protobuf:"varint,8,opt,name=tpid,proto3,oneof"`
}

type SetLagAttributeRequest_Label struct {
	Label []byte `protobuf:"bytes,9,opt,name=label,proto3,oneof"`
}

func (*SetLagAttributeRequest_IngressAcl) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_EgressAcl) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_PortVlanId) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_DefaultVlanPriority) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_DropUntagged) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_DropTagged) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_Tpid) isSetLagAttributeRequest_Attr() {}

func (*SetLagAttributeRequest_Label) isSetLagAttributeRequest_Attr() {}
...
type GetLagAttributeResponse struct {
	...
	Attr []*LagAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateLagMemberRequest struct {
	...
	Switch         uint64 `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	LagId          uint64 `protobuf:"varint,2,opt,name=lag_id,json=lagId,proto3" json:"lag_id,omitempty"`
	PortId         uint64 `protobuf:"varint,3,opt,name=port_id,json=portId,proto3" json:"port_id,omitempty"`
	EgressDisable  bool   `protobuf:"varint,4,opt,name=egress_disable,json=egressDisable,proto3" json:"egress_disable,omitempty"`
	IngressDisable bool   `protobuf:"varint,5,opt,name=ingress_disable,json=ingressDisable,proto3" json:"ingress_disable,omitempty"`
}
...
type SetLagMemberAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetLagMemberAttributeRequest_EgressDisable
	//	*SetLagMemberAttributeRequest_IngressDisable
	Attr isSetLagMemberAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetLagMemberAttributeRequest) GetAttr() isSetLagMemberAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetLagMemberAttributeRequest) GetEgressDisable() bool {
	if x, ok := x.GetAttr().(*SetLagMemberAttributeRequest_EgressDisable); ok {
		return x.EgressDisable
	}
	return false
}
...
func (x *SetLagMemberAttributeRequest) GetIngressDisable() bool {
	if x, ok := x.GetAttr().(*SetLagMemberAttributeRequest_IngressDisable); ok {
		return x.IngressDisable
	}
	return false
}

type isSetLagMemberAttributeRequest_Attr interface {
	isSetLagMemberAttributeRequest_Attr()
}

type SetLagMemberAttributeRequest_EgressDisable struct {
	EgressDisable bool `protobuf:"varint,2,opt,name=egress_disable,json=egressDisable,proto3,oneof"`
}

type SetLagMemberAttributeRequest_IngressDisable struct {
	IngressDisable bool `protobuf:"varint,3,opt,name=ingress_disable,json=ingressDisable,proto3,oneof"`
}

func (*SetLagMemberAttributeRequest_EgressDisable) isSetLagMemberAttributeRequest_Attr() {}

func (*SetLagMemberAttributeRequest_IngressDisable) isSetLagMemberAttributeRequest_Attr() {}
...
type GetLagMemberAttributeResponse struct {
	...
	Attr []*LagMemberAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_lag_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe9, 0x02, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	,
	...
	0x6f, 0x76, 0x65, 0x4c, 0x61, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a,
	0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x22,
	0x13, 0x0a, 0x11, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x4c, 0x61, 0x67, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0xc8, 0x02, 0x0a, 0x16, 0x53, 0x65, 0x74, 0x4c, 0x61, 0x67, 0x41,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x67, 0x41, 0x74, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x72, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x67, 0x4d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x12, 0x2d, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x72, 0x0a, 0x0f, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x4c, 0x61,
	0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2d, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e,
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x4c, 0x61, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52,
	...
	0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x53, 0x65, 0x74, 0x4c, 0x61,
	...
	0x84, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x33, 0x2e, 0x6c, 0x65, 0x6d, 0x6d,
	0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61,
	0x69, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x41, 0x74,
...
func file_dataplane_standalone_proto_lag_proto_init() {
	...
	file_dataplane_standalone_proto_lag_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetLagAttributeRequest_IngressAcl)(nil),
		(*SetLagAttributeRequest_EgressAcl)(nil),
		(*SetLagAttributeRequest_PortVlanId)(nil),
		(*SetLagAttributeRequest_DefaultVlanPriority)(nil),
		(*SetLagAttributeRequest_DropUntagged)(nil),
		(*SetLagAttributeRequest_DropTagged)(nil),
		(*SetLagAttributeRequest_Tpid)(nil),
		(*SetLagAttributeRequest_Label)(nil),
	}
	file_dataplane_standalone_proto_lag_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*SetLagMemberAttributeRequest_EgressDisable)(nil),
		(*SetLagMemberAttributeRequest_IngressDisable)(nil),
	}
	type x struct{}
...
var _Lag_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "dataplane/standalone/proto/lag.proto",
}
