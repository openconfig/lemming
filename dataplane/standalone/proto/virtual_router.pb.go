...
type CreateVirtualRouterRequest struct {
	...
	AdminV4State                   bool         `protobuf:"varint,2,opt,name=admin_v4_state,json=adminV4State,proto3" json:"admin_v4_state,omitempty"`
	AdminV6State                   bool         `protobuf:"varint,3,opt,name=admin_v6_state,json=adminV6State,proto3" json:"admin_v6_state,omitempty"`
	SrcMacAddress                  []byte       `protobuf:"bytes,4,opt,name=src_mac_address,json=srcMacAddress,proto3" json:"src_mac_address,omitempty"`
	ViolationTtl1PacketAction      PacketAction `protobuf:"varint,5,opt,name=violation_ttl1_packet_action,json=violationTtl1PacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"violation_ttl1_packet_action,omitempty"`
	ViolationIpOptionsPacketAction PacketAction `protobuf:"varint,6,opt,name=violation_ip_options_packet_action,json=violationIpOptionsPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"violation_ip_options_packet_action,omitempty"`
	UnknownL3MulticastPacketAction PacketAction `protobuf:"varint,7,opt,name=unknown_l3_multicast_packet_action,json=unknownL3MulticastPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction" json:"unknown_l3_multicast_packet_action,omitempty"`
	Label                          []byte       `protobuf:"bytes,8,opt,name=label,proto3" json:"label,omitempty"`
}
...
type SetVirtualRouterAttributeRequest struct {
	...
	//
	//	*SetVirtualRouterAttributeRequest_AdminV4State
	//	*SetVirtualRouterAttributeRequest_AdminV6State
	//	*SetVirtualRouterAttributeRequest_SrcMacAddress
	//	*SetVirtualRouterAttributeRequest_ViolationTtl1PacketAction
	//	*SetVirtualRouterAttributeRequest_ViolationIpOptionsPacketAction
	//	*SetVirtualRouterAttributeRequest_UnknownL3MulticastPacketAction
	//	*SetVirtualRouterAttributeRequest_Label
	Attr isSetVirtualRouterAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetVirtualRouterAttributeRequest) GetAttr() isSetVirtualRouterAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetVirtualRouterAttributeRequest) GetAdminV4State() bool {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_AdminV4State); ok {
		return x.AdminV4State
	}
	return false
}
...
func (x *SetVirtualRouterAttributeRequest) GetAdminV6State() bool {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_AdminV6State); ok {
		return x.AdminV6State
	}
	return false
}
...
func (x *SetVirtualRouterAttributeRequest) GetSrcMacAddress() []byte {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_SrcMacAddress); ok {
		return x.SrcMacAddress
	}
	return nil
}
...
func (x *SetVirtualRouterAttributeRequest) GetViolationTtl1PacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_ViolationTtl1PacketAction); ok {
		return x.ViolationTtl1PacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetVirtualRouterAttributeRequest) GetViolationIpOptionsPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_ViolationIpOptionsPacketAction); ok {
		return x.ViolationIpOptionsPacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetVirtualRouterAttributeRequest) GetUnknownL3MulticastPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_UnknownL3MulticastPacketAction); ok {
		return x.UnknownL3MulticastPacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetVirtualRouterAttributeRequest) GetLabel() []byte {
	if x, ok := x.GetAttr().(*SetVirtualRouterAttributeRequest_Label); ok {
		return x.Label
	}
	return nil
}

type isSetVirtualRouterAttributeRequest_Attr interface {
	isSetVirtualRouterAttributeRequest_Attr()
}

type SetVirtualRouterAttributeRequest_AdminV4State struct {
	AdminV4State bool `protobuf:"varint,2,opt,name=admin_v4_state,json=adminV4State,proto3,oneof"`
}

type SetVirtualRouterAttributeRequest_AdminV6State struct {
	AdminV6State bool `protobuf:"varint,3,opt,name=admin_v6_state,json=adminV6State,proto3,oneof"`
}

type SetVirtualRouterAttributeRequest_SrcMacAddress struct {
	SrcMacAddress []byte `protobuf:"bytes,4,opt,name=src_mac_address,json=srcMacAddress,proto3,oneof"`
}

type SetVirtualRouterAttributeRequest_ViolationTtl1PacketAction struct {
	ViolationTtl1PacketAction PacketAction `protobuf:"varint,5,opt,name=violation_ttl1_packet_action,json=violationTtl1PacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetVirtualRouterAttributeRequest_ViolationIpOptionsPacketAction struct {
	ViolationIpOptionsPacketAction PacketAction `protobuf:"varint,6,opt,name=violation_ip_options_packet_action,json=violationIpOptionsPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetVirtualRouterAttributeRequest_UnknownL3MulticastPacketAction struct {
	UnknownL3MulticastPacketAction PacketAction `protobuf:"varint,7,opt,name=unknown_l3_multicast_packet_action,json=unknownL3MulticastPacketAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetVirtualRouterAttributeRequest_Label struct {
	Label []byte `protobuf:"bytes,8,opt,name=label,proto3,oneof"`
}

func (*SetVirtualRouterAttributeRequest_AdminV4State) isSetVirtualRouterAttributeRequest_Attr() {}

func (*SetVirtualRouterAttributeRequest_AdminV6State) isSetVirtualRouterAttributeRequest_Attr() {}

func (*SetVirtualRouterAttributeRequest_SrcMacAddress) isSetVirtualRouterAttributeRequest_Attr() {}

func (*SetVirtualRouterAttributeRequest_ViolationTtl1PacketAction) isSetVirtualRouterAttributeRequest_Attr() {
}

func (*SetVirtualRouterAttributeRequest_ViolationIpOptionsPacketAction) isSetVirtualRouterAttributeRequest_Attr() {
}

func (*SetVirtualRouterAttributeRequest_UnknownL3MulticastPacketAction) isSetVirtualRouterAttributeRequest_Attr() {
}

func (*SetVirtualRouterAttributeRequest_Label) isSetVirtualRouterAttributeRequest_Attr() {}
...
type GetVirtualRouterAttributeResponse struct {
	...
	Attr []*VirtualRouterAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_virtual_router_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x86, 0x04, 0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x56, 0x69, 0x72, 0x74,
	...
	,
	...
	0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x19, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x54, 0x74, 0x6c, 0x31, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x6f, 0x0a, 0x22, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x69, 0x70, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x1e, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x70,
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x6f, 0x0a, 0x22, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x5f, 0x6c,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x1e, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x4c, 0x33, 0x4d,
	0x75, 0x6c, 0x74, 0x69, 0x63, 0x61, 0x73, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0x2f, 0x0a, 0x1b, 0x43, 0x72,
	...
	0x65, 0x6d, 0x6f, 0x76, 0x65, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x52, 0x6f, 0x75, 0x74,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9c, 0x04, 0x0a, 0x20, 0x53,
	...
	,
	...
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x19, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x74, 0x6c, 0x31, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x71, 0x0a, 0x22, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x23, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c,
	0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x1e, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x49, 0x70, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x71, 0x0a, 0x22, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77,
	...
	0x28, 0x0e, 0x32, 0x23, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74,
	0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x65,
	0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x1e, 0x75, 0x6e, 0x6b, 0x6e, 0x6f,
	0x77, 0x6e, 0x4c, 0x33, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x63, 0x61, 0x73, 0x74, 0x50, 0x61, 0x63,
	0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a, 0x05, 0x6c, 0x61, 0x62,
	0x65, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65,
	0x6c, 0x42, 0x06, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x23, 0x0a, 0x21, 0x53, 0x65, 0x74,
	...
	0x12, 0x41, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
...
func file_dataplane_standalone_proto_virtual_router_proto_init() {
	...
	file_dataplane_standalone_proto_virtual_router_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetVirtualRouterAttributeRequest_AdminV4State)(nil),
		(*SetVirtualRouterAttributeRequest_AdminV6State)(nil),
		(*SetVirtualRouterAttributeRequest_SrcMacAddress)(nil),
		(*SetVirtualRouterAttributeRequest_ViolationTtl1PacketAction)(nil),
		(*SetVirtualRouterAttributeRequest_ViolationIpOptionsPacketAction)(nil),
		(*SetVirtualRouterAttributeRequest_UnknownL3MulticastPacketAction)(nil),
		(*SetVirtualRouterAttributeRequest_Label)(nil),
	}
	type x struct{}
