...
type CreateHostifRequest struct {
	...
	Type               HostifType    `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.HostifType" json:"type,omitempty"`
	ObjId              uint64        `protobuf:"varint,3,opt,name=obj_id,json=objId,proto3" json:"obj_id,omitempty"`
	Name               []byte        `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`
	OperStatus         bool          `protobuf:"varint,5,opt,name=oper_status,json=operStatus,proto3" json:"oper_status,omitempty"`
	Queue              uint32        `protobuf:"varint,6,opt,name=queue,proto3" json:"queue,omitempty"`
	VlanTag            HostifVlanTag `protobuf:"varint,7,opt,name=vlan_tag,json=vlanTag,proto3,enum=lemming.dataplane.sai.HostifVlanTag" json:"vlan_tag,omitempty"`
	GenetlinkMcgrpName []byte        `protobuf:"bytes,8,opt,name=genetlink_mcgrp_name,json=genetlinkMcgrpName,proto3" json:"genetlink_mcgrp_name,omitempty"`
}
...
type SetHostifAttributeRequest struct {
	...
	//
	//	*SetHostifAttributeRequest_OperStatus
	//	*SetHostifAttributeRequest_Queue
	//	*SetHostifAttributeRequest_VlanTag
	Attr isSetHostifAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (x *SetHostifAttributeRequest) GetOperStatus() bool {
	if x, ok := x.GetAttr().(*SetHostifAttributeRequest_OperStatus); ok {
		return x.OperStatus
	}
	return false
}
...
func (x *SetHostifAttributeRequest) GetQueue() uint32 {
	if x, ok := x.GetAttr().(*SetHostifAttributeRequest_Queue); ok {
		return x.Queue
	}
	return 0
}
...
func (x *SetHostifAttributeRequest) GetVlanTag() HostifVlanTag {
	if x, ok := x.GetAttr().(*SetHostifAttributeRequest_VlanTag); ok {
		return x.VlanTag
	}
	return HostifVlanTag_HOSTIF_VLAN_TAG_UNSPECIFIED
}

type isSetHostifAttributeRequest_Attr interface {
	isSetHostifAttributeRequest_Attr()
}

type SetHostifAttributeRequest_OperStatus struct {
	OperStatus bool `protobuf:"varint,2,opt,name=oper_status,json=operStatus,proto3,oneof"`
}

type SetHostifAttributeRequest_Queue struct {
	Queue uint32 `protobuf:"varint,3,opt,name=queue,proto3,oneof"`
}

type SetHostifAttributeRequest_VlanTag struct {
	VlanTag HostifVlanTag `protobuf:"varint,4,opt,name=vlan_tag,json=vlanTag,proto3,enum=lemming.dataplane.sai.HostifVlanTag,oneof"`
}

func (*SetHostifAttributeRequest_OperStatus) isSetHostifAttributeRequest_Attr() {}

func (*SetHostifAttributeRequest_Queue) isSetHostifAttributeRequest_Attr() {}

func (*SetHostifAttributeRequest_VlanTag) isSetHostifAttributeRequest_Attr() {}
...
type GetHostifAttributeResponse struct {
	...
	Attr []*HostifAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateHostifTableEntryRequest struct {
	...
	Switch      uint64                      `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	Type        HostifTableEntryType        `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.HostifTableEntryType" json:"type,omitempty"`
	ObjId       uint64                      `protobuf:"varint,3,opt,name=obj_id,json=objId,proto3" json:"obj_id,omitempty"`
	TrapId      uint64                      `protobuf:"varint,4,opt,name=trap_id,json=trapId,proto3" json:"trap_id,omitempty"`
	ChannelType HostifTableEntryChannelType `protobuf:"varint,5,opt,name=channel_type,json=channelType,proto3,enum=lemming.dataplane.sai.HostifTableEntryChannelType" json:"channel_type,omitempty"`
	HostIf      uint64                      `protobuf:"varint,6,opt,name=host_if,json=hostIf,proto3" json:"host_if,omitempty"`
}
...
type GetHostifTableEntryAttributeResponse struct {
	...
	Attr []*HostifTableEntryAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateHostifTrapGroupRequest struct {
	...
	Policer    uint64 `protobuf:"varint,4,opt,name=policer,proto3" json:"policer,omitempty"`
}
...
type SetHostifTrapGroupAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetHostifTrapGroupAttributeRequest_AdminState
	//	*SetHostifTrapGroupAttributeRequest_Queue
	//	*SetHostifTrapGroupAttributeRequest_Policer
	Attr isSetHostifTrapGroupAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetHostifTrapGroupAttributeRequest) GetAttr() isSetHostifTrapGroupAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetHostifTrapGroupAttributeRequest) GetAdminState() bool {
	if x, ok := x.GetAttr().(*SetHostifTrapGroupAttributeRequest_AdminState); ok {
		return x.AdminState
	}
	return false
}
...
func (x *SetHostifTrapGroupAttributeRequest) GetQueue() uint32 {
	if x, ok := x.GetAttr().(*SetHostifTrapGroupAttributeRequest_Queue); ok {
		return x.Queue
	}
	return 0
}
...
func (x *SetHostifTrapGroupAttributeRequest) GetPolicer() uint64 {
	if x, ok := x.GetAttr().(*SetHostifTrapGroupAttributeRequest_Policer); ok {
		return x.Policer
	}
	return 0
}

type isSetHostifTrapGroupAttributeRequest_Attr interface {
	isSetHostifTrapGroupAttributeRequest_Attr()
}

type SetHostifTrapGroupAttributeRequest_AdminState struct {
	AdminState bool `protobuf:"varint,2,opt,name=admin_state,json=adminState,proto3,oneof"`
}

type SetHostifTrapGroupAttributeRequest_Queue struct {
	Queue uint32 `protobuf:"varint,3,opt,name=queue,proto3,oneof"`
}

type SetHostifTrapGroupAttributeRequest_Policer struct {
	Policer uint64 `protobuf:"varint,4,opt,name=policer,proto3,oneof"`
}

func (*SetHostifTrapGroupAttributeRequest_AdminState) isSetHostifTrapGroupAttributeRequest_Attr() {}

func (*SetHostifTrapGroupAttributeRequest_Queue) isSetHostifTrapGroupAttributeRequest_Attr() {}

func (*SetHostifTrapGroupAttributeRequest_Policer) isSetHostifTrapGroupAttributeRequest_Attr() {}
...
type GetHostifTrapGroupAttributeResponse struct {
	...
	Attr []*HostifTrapGroupAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateHostifTrapRequest struct {
	...
	Switch          uint64         `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	TrapType        HostifTrapType `protobuf:"varint,2,opt,name=trap_type,json=trapType,proto3,enum=lemming.dataplane.sai.HostifTrapType" json:"trap_type,omitempty"`
	...
	TrapGroup       uint64         `protobuf:"varint,6,opt,name=trap_group,json=trapGroup,proto3" json:"trap_group,omitempty"`
...
type SetHostifTrapAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetHostifTrapAttributeRequest_PacketAction
	//	*SetHostifTrapAttributeRequest_TrapPriority
	//	*SetHostifTrapAttributeRequest_ExcludePortList
	//	*SetHostifTrapAttributeRequest_TrapGroup
	//	*SetHostifTrapAttributeRequest_MirrorSession
	//	*SetHostifTrapAttributeRequest_CounterId
	Attr isSetHostifTrapAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetHostifTrapAttributeRequest) GetAttr() isSetHostifTrapAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetHostifTrapAttributeRequest) GetPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_PacketAction); ok {
		return x.PacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetHostifTrapAttributeRequest) GetTrapPriority() uint32 {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_TrapPriority); ok {
		return x.TrapPriority
	}
	return 0
}

func (x *SetHostifTrapAttributeRequest) GetExcludePortList() *Uint64List {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_ExcludePortList); ok {
		return x.ExcludePortList
	}
	return nil
}
...
func (x *SetHostifTrapAttributeRequest) GetTrapGroup() uint64 {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_TrapGroup); ok {
		return x.TrapGroup
	}
	return 0
}

func (x *SetHostifTrapAttributeRequest) GetMirrorSession() *Uint64List {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_MirrorSession); ok {
		return x.MirrorSession
	}
	return nil
}
...
func (x *SetHostifTrapAttributeRequest) GetCounterId() uint64 {
	if x, ok := x.GetAttr().(*SetHostifTrapAttributeRequest_CounterId); ok {
		return x.CounterId
	}
	return 0
}

type isSetHostifTrapAttributeRequest_Attr interface {
	isSetHostifTrapAttributeRequest_Attr()
}

type SetHostifTrapAttributeRequest_PacketAction struct {
	PacketAction PacketAction `protobuf:"varint,2,opt,name=packet_action,json=packetAction,proto3,enum=lemming.dataplane.sai.PacketAction,oneof"`
}

type SetHostifTrapAttributeRequest_TrapPriority struct {
	TrapPriority uint32 `protobuf:"varint,3,opt,name=trap_priority,json=trapPriority,proto3,oneof"`
}

type SetHostifTrapAttributeRequest_ExcludePortList struct {
	ExcludePortList *Uint64List `protobuf:"bytes,4,opt,name=exclude_port_list,json=excludePortList,proto3,oneof"`
}

type SetHostifTrapAttributeRequest_TrapGroup struct {
	TrapGroup uint64 `protobuf:"varint,5,opt,name=trap_group,json=trapGroup,proto3,oneof"`
}

type SetHostifTrapAttributeRequest_MirrorSession struct {
	MirrorSession *Uint64List `protobuf:"bytes,6,opt,name=mirror_session,json=mirrorSession,proto3,oneof"`
}

type SetHostifTrapAttributeRequest_CounterId struct {
	CounterId uint64 `protobuf:"varint,7,opt,name=counter_id,json=counterId,proto3,oneof"`
}

func (*SetHostifTrapAttributeRequest_PacketAction) isSetHostifTrapAttributeRequest_Attr() {}

func (*SetHostifTrapAttributeRequest_TrapPriority) isSetHostifTrapAttributeRequest_Attr() {}

func (*SetHostifTrapAttributeRequest_ExcludePortList) isSetHostifTrapAttributeRequest_Attr() {}

func (*SetHostifTrapAttributeRequest_TrapGroup) isSetHostifTrapAttributeRequest_Attr() {}

func (*SetHostifTrapAttributeRequest_MirrorSession) isSetHostifTrapAttributeRequest_Attr() {}

func (*SetHostifTrapAttributeRequest_CounterId) isSetHostifTrapAttributeRequest_Attr() {}
...
type GetHostifTrapAttributeResponse struct {
	...
	Attr []*HostifTrapAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateHostifUserDefinedTrapRequest struct {
	...
	Switch       uint64                    `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	Type         HostifUserDefinedTrapType `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.HostifUserDefinedTrapType" json:"type,omitempty"`
	TrapPriority uint32                    `protobuf:"varint,3,opt,name=trap_priority,json=trapPriority,proto3" json:"trap_priority,omitempty"`
	TrapGroup    uint64                    `protobuf:"varint,4,opt,name=trap_group,json=trapGroup,proto3" json:"trap_group,omitempty"`
}
...
type SetHostifUserDefinedTrapAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetHostifUserDefinedTrapAttributeRequest_TrapPriority
	//	*SetHostifUserDefinedTrapAttributeRequest_TrapGroup
	Attr isSetHostifUserDefinedTrapAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetHostifUserDefinedTrapAttributeRequest) GetAttr() isSetHostifUserDefinedTrapAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetHostifUserDefinedTrapAttributeRequest) GetTrapPriority() uint32 {
	if x, ok := x.GetAttr().(*SetHostifUserDefinedTrapAttributeRequest_TrapPriority); ok {
		return x.TrapPriority
	}
	return 0
}
...
func (x *SetHostifUserDefinedTrapAttributeRequest) GetTrapGroup() uint64 {
	if x, ok := x.GetAttr().(*SetHostifUserDefinedTrapAttributeRequest_TrapGroup); ok {
		return x.TrapGroup
	}
	return 0
}

type isSetHostifUserDefinedTrapAttributeRequest_Attr interface {
	isSetHostifUserDefinedTrapAttributeRequest_Attr()
}

type SetHostifUserDefinedTrapAttributeRequest_TrapPriority struct {
	TrapPriority uint32 `protobuf:"varint,2,opt,name=trap_priority,json=trapPriority,proto3,oneof"`
}

type SetHostifUserDefinedTrapAttributeRequest_TrapGroup struct {
	TrapGroup uint64 `protobuf:"varint,3,opt,name=trap_group,json=trapGroup,proto3,oneof"`
}

func (*SetHostifUserDefinedTrapAttributeRequest_TrapPriority) isSetHostifUserDefinedTrapAttributeRequest_Attr() {
}

func (*SetHostifUserDefinedTrapAttributeRequest_TrapGroup) isSetHostifUserDefinedTrapAttributeRequest_Attr() {
}
...
type GetHostifUserDefinedTrapAttributeResponse struct {
	...
	Attr []*HostifUserDefinedTrapAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_hostif_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x02, 0x0a, 0x13, 0x43, 0x72,
	...
	0x12, 0x15, 0x0a, 0x06, 0x6f, 0x62, 0x6a, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x05, 0x6f, 0x62, 0x6a, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x6f,
	0x70, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0a, 0x6f, 0x70, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05,
	0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x12, 0x3f, 0x0a, 0x08, 0x76, 0x6c, 0x61, 0x6e, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x07,
	...
	0x70, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x28, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48,
	...
	0x22, 0xb3, 0x01, 0x0a, 0x19, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x41, 0x74,
	...
	0x12, 0x21, 0x0a, 0x0b, 0x6f, 0x70, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x0a, 0x6f, 0x70, 0x65, 0x72, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0d, 0x48, 0x00, 0x52, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x12, 0x41, 0x0a, 0x08, 0x76,
	0x6c, 0x61, 0x6e, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e,
	...
	0x54, 0x61, 0x67, 0x48, 0x00, 0x52, 0x07, 0x76, 0x6c, 0x61, 0x6e, 0x54, 0x61, 0x67, 0x42, 0x06,
	0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x1c, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73,
	0x74, 0x69, 0x66, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6d, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69,
	0x66, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x6f, 0x73, 0x74, 0x69, 0x66, 0x41, 0x74, 0x74, 0x72, 0x52, 0x08, 0x61, 0x74, 0x74, 0x72, 0x54,
	0x79, 0x70, 0x65, 0x22, 0x58, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66,
	...
	0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x41, 0x74,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x98, 0x02,
	0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x61,
	...
	,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x22, 0x31, 0x0a, 0x1d,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x61, 0x62, 0x6c,
	0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a,
	0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x22,
	0x20, 0x0a, 0x1e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54,
	0x61, 0x62, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x81, 0x01, 0x0a, 0x23, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x12, 0x48, 0x0a, 0x09, 0x61,
	0x74, 0x74, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x2b,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x61, 0x62,
	0x6c, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x41, 0x74, 0x74, 0x72, 0x52, 0x08, 0x61, 0x74, 0x74,
	0x72, 0x54, 0x79, 0x70, 0x65, 0x22, 0x6c, 0x0a, 0x24, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74,
	...
	0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x6c, 0x65,
	...
	0x74, 0x74, 0x72, 0x22, 0x87, 0x01, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f,
	...
	,
	...
	0x69, 0x64, 0x22, 0x1f, 0x0a, 0x1d, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74,
	0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x22, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x12, 0x21, 0x0a, 0x0b,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x08, 0x48, 0x00, 0x52, 0x0a, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x16, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00,
	0x52, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x12, 0x1a, 0x0a, 0x07, 0x70, 0x6f, 0x6c, 0x69, 0x63,
	0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x07, 0x70, 0x6f, 0x6c, 0x69,
	0x63, 0x65, 0x72, 0x42, 0x06, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x25, 0x0a, 0x23, 0x53,
	...
	0x73, 0x65, 0x22, 0x7f, 0x0a, 0x22, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54,
	...
	0x79, 0x70, 0x65, 0x22, 0x6a, 0x0a, 0x23, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66,
	...
	,
	...
	0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69,
	0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x70, 0x50, 0x72,
	0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x2a, 0x0a, 0x11, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64,
	...
	0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x12, 0x25, 0x0a, 0x0e, 0x6d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x73, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0d, 0x6d, 0x69, 0x72, 0x72, 0x6f,
	0x72, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2c, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8b,
	...
	0x12, 0x10, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f,
	0x69, 0x64, 0x12, 0x4a, 0x0a, 0x0d, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x74,
	...
	0x69, 0x2e, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00,
	0x52, 0x0c, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25,
	0x0a, 0x0d, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x70, 0x50, 0x72, 0x69,
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x4f, 0x0a, 0x11, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65,
	0x5f, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0f, 0x65, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x50, 0x6f,
	0x72, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x09, 0x74, 0x72,
	0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x4a, 0x0a, 0x0e, 0x6d, 0x69, 0x72, 0x72, 0x6f,
	0x72, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x73, 0x74, 0x48, 0x00, 0x52, 0x0d, 0x6d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x53, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0a, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x09, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x65, 0x72, 0x49, 0x64, 0x42, 0x06, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x20, 0x0a, 0x1e,
	...
	0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0xc6, 0x01, 0x0a, 0x22, 0x43, 0x72, 0x65, 0x61,
	...
	0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x44, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	...
	0x61, 0x70, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	0x74, 0x72, 0x61, 0x70, 0x5f, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x70, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74,
	0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70,
	0x22, 0x37, 0x0a, 0x23, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x22, 0x36, 0x0a, 0x22, 0x52, 0x65, 0x6d,
	0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66,
	0x69, 0x6e, 0x65, 0x64, 0x54, 0x72, 0x61, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x10, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6f, 0x69,
	0x64, 0x22, 0x25, 0x0a, 0x23, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69,
	0x66, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x54, 0x72, 0x61, 0x70,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8c, 0x01, 0x0a, 0x28, 0x53, 0x65, 0x74,
	...
	0x28, 0x04, 0x52, 0x03, 0x6f, 0x69, 0x64, 0x12, 0x25, 0x0a, 0x0d, 0x74, 0x72, 0x61, 0x70, 0x5f,
	0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00,
	0x52, 0x0c, 0x74, 0x72, 0x61, 0x70, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x1f,
	0x0a, 0x0a, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x04, 0x48, 0x00, 0x52, 0x09, 0x74, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x42,
	0x06, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x2b, 0x0a, 0x29, 0x53, 0x65, 0x74, 0x48, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8b, 0x01, 0x0a, 0x28, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74,
	...
	0x74, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03,
	0x6f, 0x69, 0x64, 0x12, 0x4d, 0x0a, 0x09, 0x61, 0x74, 0x74, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x30, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x48,
	0x6f, 0x73, 0x74, 0x69, 0x66, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64,
	0x54, 0x72, 0x61, 0x70, 0x41, 0x74, 0x74, 0x72, 0x52, 0x08, 0x61, 0x74, 0x74, 0x72, 0x54, 0x79,
	0x70, 0x65, 0x22, 0x76, 0x0a, 0x29, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x55,
	...
	,
	...
	,
	...
	0x10, 0x01, 0x12, 0x20, 0x0a, 0x1c, 0x48, 0x4f, 0x53, 0x54, 0x49, 0x46, 0x5f, 0x54, 0x52, 0x41,
	0x50, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x5f, 0x41, 0x54, 0x54, 0x52, 0x5f, 0x51, 0x55, 0x45,
	0x55, 0x45, 0x10, 0x02, 0x12, 0x22, 0x0a, 0x1e, 0x48, 0x4f, 0x53, 0x54, 0x49, 0x46, 0x5f, 0x54,
	0x52, 0x41, 0x50, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x5f, 0x41, 0x54, 0x54, 0x52, 0x5f, 0x50,
	0x4f, 0x4c, 0x49, 0x43, 0x45, 0x52, 0x10, 0x03, 0x2a, 0xa9, 0x02, 0x0a, 0x0e, 0x48, 0x6f, 0x73,
	0x74, 0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x41, 0x74, 0x74, 0x72, 0x12, 0x20, 0x0a, 0x1c, 0x48,
	...
	,
	...
	0x50, 0x52, 0x49, 0x4f, 0x52, 0x49, 0x54, 0x59, 0x10, 0x02, 0x12, 0x2c, 0x0a, 0x28, 0x48, 0x4f,
	0x53, 0x54, 0x49, 0x46, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x44, 0x45, 0x46, 0x49, 0x4e, 0x45,
	0x44, 0x5f, 0x54, 0x52, 0x41, 0x50, 0x5f, 0x41, 0x54, 0x54, 0x52, 0x5f, 0x54, 0x52, 0x41, 0x50,
	0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x03, 0x32, 0xd2, 0x14, 0x0a, 0x06, 0x48, 0x6f, 0x73,
	0x74, 0x69, 0x66, 0x12, 0x69, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f, 0x73,
	...
	0x74, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x73, 0x74, 0x69, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x69,
	0x0a, 0x0c, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x12, 0x2a,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	...
	0x61, 0x69, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x7b, 0x0a, 0x12, 0x53, 0x65, 0x74,
	0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12,
	...
	0x74, 0x69, 0x66, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x7b, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73,
	...
	0x2e, 0x73, 0x61, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x41, 0x74,
	...
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x12, 0x87, 0x01, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f,
	0x73, 0x74, 0x69, 0x66, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x34,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f, 0x73,
	0x74, 0x69, 0x66, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71,
	...
	,
	...
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x12, 0x84, 0x01, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f,
	0x73, 0x74, 0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x33, 0x2e,
	0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x84, 0x01, 0x0a, 0x15, 0x52,
	...
	0x00, 0x12, 0x96, 0x01, 0x0a, 0x1b, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54,
	0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	...
	0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x39, 0x2e, 0x6c, 0x65, 0x6d,
	0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73,
	...
	0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x12, 0x75, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x48, 0x6f, 0x73,
	0x74, 0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x12, 0x2e, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e,
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	...
	0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x72, 0x61, 0x70, 0x12, 0x2e,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x48, 0x6f, 0x73,
	...
	0x00, 0x12, 0x87, 0x01, 0x0a, 0x16, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54,
	0x72, 0x61, 0x70, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x34, 0x2e, 0x6c,
	0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65,
	0x2e, 0x73, 0x61, 0x69, 0x2e, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x54, 0x72,
	...
	,
	...
	0x22, 0x00, 0x12, 0xa8, 0x01, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66,
	0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x54, 0x72, 0x61, 0x70, 0x41,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x12, 0x3f, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69,
	0x2e, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65,
	...
	0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61,
	0x69, 0x2e, 0x47, 0x65, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x69, 0x66, 0x55, 0x73, 0x65, 0x72, 0x44,
...
var file_dataplane_standalone_proto_hostif_proto_goTypes = []interface{}{
	...
	(*HostifTrapGroupAttribute)(nil),                  // 49: lemming.dataplane.sai.HostifTrapGroupAttribute
	(HostifTrapType)(0),                               // 50: lemming.dataplane.sai.HostifTrapType
	(PacketAction)(0),                                 // 51: lemming.dataplane.sai.PacketAction
	(*Uint64List)(nil),                                // 52: lemming.dataplane.sai.Uint64List
...
var file_dataplane_standalone_proto_hostif_proto_depIdxs = []int32{
	...
	2,  // 9: lemming.dataplane.sai.GetHostifTrapGroupAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.HostifTrapGroupAttr
	49, // 10: lemming.dataplane.sai.GetHostifTrapGroupAttributeResponse.attr:type_name -> lemming.dataplane.sai.HostifTrapGroupAttribute
	50, // 11: lemming.dataplane.sai.CreateHostifTrapRequest.trap_type:type_name -> lemming.dataplane.sai.HostifTrapType
	51, // 12: lemming.dataplane.sai.CreateHostifTrapRequest.packet_action:type_name -> lemming.dataplane.sai.PacketAction
	51, // 13: lemming.dataplane.sai.SetHostifTrapAttributeRequest.packet_action:type_name -> lemming.dataplane.sai.PacketAction
	52, // 14: lemming.dataplane.sai.SetHostifTrapAttributeRequest.exclude_port_list:type_name -> lemming.dataplane.sai.Uint64List
	52, // 15: lemming.dataplane.sai.SetHostifTrapAttributeRequest.mirror_session:type_name -> lemming.dataplane.sai.Uint64List
	3,  // 16: lemming.dataplane.sai.GetHostifTrapAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.HostifTrapAttr
	53, // 17: lemming.dataplane.sai.GetHostifTrapAttributeResponse.attr:type_name -> lemming.dataplane.sai.HostifTrapAttribute
	54, // 18: lemming.dataplane.sai.CreateHostifUserDefinedTrapRequest.type:type_name -> lemming.dataplane.sai.HostifUserDefinedTrapType
	4,  // 19: lemming.dataplane.sai.GetHostifUserDefinedTrapAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.HostifUserDefinedTrapAttr
	55, // 20: lemming.dataplane.sai.GetHostifUserDefinedTrapAttributeResponse.attr:type_name -> lemming.dataplane.sai.HostifUserDefinedTrapAttribute
	5,  // 21: lemming.dataplane.sai.Hostif.CreateHostif:input_type -> lemming.dataplane.sai.CreateHostifRequest
	7,  // 22: lemming.dataplane.sai.Hostif.RemoveHostif:input_type -> lemming.dataplane.sai.RemoveHostifRequest
	9,  // 23: lemming.dataplane.sai.Hostif.SetHostifAttribute:input_type -> lemming.dataplane.sai.SetHostifAttributeRequest
	11, // 24: lemming.dataplane.sai.Hostif.GetHostifAttribute:input_type -> lemming.dataplane.sai.GetHostifAttributeRequest
	13, // 25: lemming.dataplane.sai.Hostif.CreateHostifTableEntry:input_type -> lemming.dataplane.sai.CreateHostifTableEntryRequest
	15, // 26: lemming.dataplane.sai.Hostif.RemoveHostifTableEntry:input_type -> lemming.dataplane.sai.RemoveHostifTableEntryRequest
	17, // 27: lemming.dataplane.sai.Hostif.GetHostifTableEntryAttribute:input_type -> lemming.dataplane.sai.GetHostifTableEntryAttributeRequest
	19, // 28: lemming.dataplane.sai.Hostif.CreateHostifTrapGroup:input_type -> lemming.dataplane.sai.CreateHostifTrapGroupRequest
	21, // 29: lemming.dataplane.sai.Hostif.RemoveHostifTrapGroup:input_type -> lemming.dataplane.sai.RemoveHostifTrapGroupRequest
	23, // 30: lemming.dataplane.sai.Hostif.SetHostifTrapGroupAttribute:input_type -> lemming.dataplane.sai.SetHostifTrapGroupAttributeRequest
	25, // 31: lemming.dataplane.sai.Hostif.GetHostifTrapGroupAttribute:input_type -> lemming.dataplane.sai.GetHostifTrapGroupAttributeRequest
	27, // 32: lemming.dataplane.sai.Hostif.CreateHostifTrap:input_type -> lemming.dataplane.sai.CreateHostifTrapRequest
	29, // 33: lemming.dataplane.sai.Hostif.RemoveHostifTrap:input_type -> lemming.dataplane.sai.RemoveHostifTrapRequest
	31, // 34: lemming.dataplane.sai.Hostif.SetHostifTrapAttribute:input_type -> lemming.dataplane.sai.SetHostifTrapAttributeRequest
	33, // 35: lemming.dataplane.sai.Hostif.GetHostifTrapAttribute:input_type -> lemming.dataplane.sai.GetHostifTrapAttributeRequest
	35, // 36: lemming.dataplane.sai.Hostif.CreateHostifUserDefinedTrap:input_type -> lemming.dataplane.sai.CreateHostifUserDefinedTrapRequest
	37, // 37: lemming.dataplane.sai.Hostif.RemoveHostifUserDefinedTrap:input_type -> lemming.dataplane.sai.RemoveHostifUserDefinedTrapRequest
	39, // 38: lemming.dataplane.sai.Hostif.SetHostifUserDefinedTrapAttribute:input_type -> lemming.dataplane.sai.SetHostifUserDefinedTrapAttributeRequest
	41, // 39: lemming.dataplane.sai.Hostif.GetHostifUserDefinedTrapAttribute:input_type -> lemming.dataplane.sai.GetHostifUserDefinedTrapAttributeRequest
	6,  // 40: lemming.dataplane.sai.Hostif.CreateHostif:output_type -> lemming.dataplane.sai.CreateHostifResponse
	8,  // 41: lemming.dataplane.sai.Hostif.RemoveHostif:output_type -> lemming.dataplane.sai.RemoveHostifResponse
	10, // 42: lemming.dataplane.sai.Hostif.SetHostifAttribute:output_type -> lemming.dataplane.sai.SetHostifAttributeResponse
	12, // 43: lemming.dataplane.sai.Hostif.GetHostifAttribute:output_type -> lemming.dataplane.sai.GetHostifAttributeResponse
	14, // 44: lemming.dataplane.sai.Hostif.CreateHostifTableEntry:output_type -> lemming.dataplane.sai.CreateHostifTableEntryResponse
	16, // 45: lemming.dataplane.sai.Hostif.RemoveHostifTableEntry:output_type -> lemming.dataplane.sai.RemoveHostifTableEntryResponse
	18, // 46: lemming.dataplane.sai.Hostif.GetHostifTableEntryAttribute:output_type -> lemming.dataplane.sai.GetHostifTableEntryAttributeResponse
	20, // 47: lemming.dataplane.sai.Hostif.CreateHostifTrapGroup:output_type -> lemming.dataplane.sai.CreateHostifTrapGroupResponse
	22, // 48: lemming.dataplane.sai.Hostif.RemoveHostifTrapGroup:output_type -> lemming.dataplane.sai.RemoveHostifTrapGroupResponse
	24, // 49: lemming.dataplane.sai.Hostif.SetHostifTrapGroupAttribute:output_type -> lemming.dataplane.sai.SetHostifTrapGroupAttributeResponse
	26, // 50: lemming.dataplane.sai.Hostif.GetHostifTrapGroupAttribute:output_type -> lemming.dataplane.sai.GetHostifTrapGroupAttributeResponse
	28, // 51: lemming.dataplane.sai.Hostif.CreateHostifTrap:output_type -> lemming.dataplane.sai.CreateHostifTrapResponse
	30, // 52: lemming.dataplane.sai.Hostif.RemoveHostifTrap:output_type -> lemming.dataplane.sai.RemoveHostifTrapResponse
	32, // 53: lemming.dataplane.sai.Hostif.SetHostifTrapAttribute:output_type -> lemming.dataplane.sai.SetHostifTrapAttributeResponse
	34, // 54: lemming.dataplane.sai.Hostif.GetHostifTrapAttribute:output_type -> lemming.dataplane.sai.GetHostifTrapAttributeResponse
	36, // 55: lemming.dataplane.sai.Hostif.CreateHostifUserDefinedTrap:output_type -> lemming.dataplane.sai.CreateHostifUserDefinedTrapResponse
	38, // 56: lemming.dataplane.sai.Hostif.RemoveHostifUserDefinedTrap:output_type -> lemming.dataplane.sai.RemoveHostifUserDefinedTrapResponse
	40, // 57: lemming.dataplane.sai.Hostif.SetHostifUserDefinedTrapAttribute:output_type -> lemming.dataplane.sai.SetHostifUserDefinedTrapAttributeResponse
	42, // 58: lemming.dataplane.sai.Hostif.GetHostifUserDefinedTrapAttribute:output_type -> lemming.dataplane.sai.GetHostifUserDefinedTrapAttributeResponse
...
func file_dataplane_standalone_proto_hostif_proto_init() {
	...
	file_dataplane_standalone_proto_hostif_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetHostifAttributeRequest_OperStatus)(nil),
		(*SetHostifAttributeRequest_Queue)(nil),
		(*SetHostifAttributeRequest_VlanTag)(nil),
	}
	file_dataplane_standalone_proto_hostif_proto_msgTypes[18].OneofWrappers = []interface{}{
		(*SetHostifTrapGroupAttributeRequest_AdminState)(nil),
		(*SetHostifTrapGroupAttributeRequest_Queue)(nil),
		(*SetHostifTrapGroupAttributeRequest_Policer)(nil),
	}
	file_dataplane_standalone_proto_hostif_proto_msgTypes[26].OneofWrappers = []interface{}{
		(*SetHostifTrapAttributeRequest_PacketAction)(nil),
		(*SetHostifTrapAttributeRequest_TrapPriority)(nil),
		(*SetHostifTrapAttributeRequest_ExcludePortList)(nil),
		(*SetHostifTrapAttributeRequest_TrapGroup)(nil),
		(*SetHostifTrapAttributeRequest_MirrorSession)(nil),
		(*SetHostifTrapAttributeRequest_CounterId)(nil),
	}
	file_dataplane_standalone_proto_hostif_proto_msgTypes[34].OneofWrappers = []interface{}{
		(*SetHostifUserDefinedTrapAttributeRequest_TrapPriority)(nil),
		(*SetHostifUserDefinedTrapAttributeRequest_TrapGroup)(nil),
	}
	type x struct{}
