...
type CreateIpsecRequest struct {
	...
	WarmBootEnable          bool      `protobuf:"varint,2,opt,name=warm_boot_enable,json=warmBootEnable,proto3" json:"warm_boot_enable,omitempty"`
	ExternalSaIndexEnable   bool      `protobuf:"varint,3,opt,name=external_sa_index_enable,json=externalSaIndexEnable,proto3" json:"external_sa_index_enable,omitempty"`
	CtagTpid                uint32    `protobuf:"varint,4,opt,name=ctag_tpid,json=ctagTpid,proto3" json:"ctag_tpid,omitempty"`
	StagTpid                uint32    `protobuf:"varint,5,opt,name=stag_tpid,json=stagTpid,proto3" json:"stag_tpid,omitempty"`
	MaxVlanTagsParsed       uint32    `protobuf:"varint,6,opt,name=max_vlan_tags_parsed,json=maxVlanTagsParsed,proto3" json:"max_vlan_tags_parsed,omitempty"`
	OctetCountHighWatermark uint64    `protobuf:"varint,7,opt,name=octet_count_high_watermark,json=octetCountHighWatermark,proto3" json:"octet_count_high_watermark,omitempty"`
	OctetCountLowWatermark  uint64    `protobuf:"varint,8,opt,name=octet_count_low_watermark,json=octetCountLowWatermark,proto3" json:"octet_count_low_watermark,omitempty"`
	StatsMode               StatsMode `protobuf:"varint,9,opt,name=stats_mode,json=statsMode,proto3,enum=lemming.dataplane.sai.StatsMode" json:"stats_mode,omitempty"`
}
...
type SetIpsecAttributeRequest struct {
	...
	//
	//	*SetIpsecAttributeRequest_WarmBootEnable
	//	*SetIpsecAttributeRequest_CtagTpid
	//	*SetIpsecAttributeRequest_StagTpid
	//	*SetIpsecAttributeRequest_MaxVlanTagsParsed
	//	*SetIpsecAttributeRequest_OctetCountHighWatermark
	//	*SetIpsecAttributeRequest_OctetCountLowWatermark
	//	*SetIpsecAttributeRequest_StatsMode
	Attr isSetIpsecAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (x *SetIpsecAttributeRequest) GetWarmBootEnable() bool {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_WarmBootEnable); ok {
		return x.WarmBootEnable
	}
	return false
}
...
func (x *SetIpsecAttributeRequest) GetCtagTpid() uint32 {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_CtagTpid); ok {
		return x.CtagTpid
	}
	return 0
}
...
func (x *SetIpsecAttributeRequest) GetStagTpid() uint32 {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_StagTpid); ok {
		return x.StagTpid
	}
	return 0
}
...
func (x *SetIpsecAttributeRequest) GetMaxVlanTagsParsed() uint32 {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_MaxVlanTagsParsed); ok {
		return x.MaxVlanTagsParsed
	}
	return 0
}
...
func (x *SetIpsecAttributeRequest) GetOctetCountHighWatermark() uint64 {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_OctetCountHighWatermark); ok {
		return x.OctetCountHighWatermark
	}
	return 0
}
...
func (x *SetIpsecAttributeRequest) GetOctetCountLowWatermark() uint64 {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_OctetCountLowWatermark); ok {
		return x.OctetCountLowWatermark
	}
	return 0
}
...
func (x *SetIpsecAttributeRequest) GetStatsMode() StatsMode {
	if x, ok := x.GetAttr().(*SetIpsecAttributeRequest_StatsMode); ok {
		return x.StatsMode
	}
	return StatsMode_STATS_MODE_UNSPECIFIED
}

type isSetIpsecAttributeRequest_Attr interface {
	isSetIpsecAttributeRequest_Attr()
}

type SetIpsecAttributeRequest_WarmBootEnable struct {
	WarmBootEnable bool `protobuf:"varint,2,opt,name=warm_boot_enable,json=warmBootEnable,proto3,oneof"`
}

type SetIpsecAttributeRequest_CtagTpid struct {
	CtagTpid uint32 `protobuf:"varint,3,opt,name=ctag_tpid,json=ctagTpid,proto3,oneof"`
}

type SetIpsecAttributeRequest_StagTpid struct {
	StagTpid uint32 `protobuf:"varint,4,opt,name=stag_tpid,json=stagTpid,proto3,oneof"`
}

type SetIpsecAttributeRequest_MaxVlanTagsParsed struct {
	MaxVlanTagsParsed uint32 `protobuf:"varint,5,opt,name=max_vlan_tags_parsed,json=maxVlanTagsParsed,proto3,oneof"`
}

type SetIpsecAttributeRequest_OctetCountHighWatermark struct {
	OctetCountHighWatermark uint64 `protobuf:"varint,6,opt,name=octet_count_high_watermark,json=octetCountHighWatermark,proto3,oneof"`
}

type SetIpsecAttributeRequest_OctetCountLowWatermark struct {
	OctetCountLowWatermark uint64 `protobuf:"varint,7,opt,name=octet_count_low_watermark,json=octetCountLowWatermark,proto3,oneof"`
}

type SetIpsecAttributeRequest_StatsMode struct {
	StatsMode StatsMode `protobuf:"varint,8,opt,name=stats_mode,json=statsMode,proto3,enum=lemming.dataplane.sai.StatsMode,oneof"`
}

func (*SetIpsecAttributeRequest_WarmBootEnable) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_CtagTpid) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_StagTpid) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_MaxVlanTagsParsed) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_OctetCountHighWatermark) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_OctetCountLowWatermark) isSetIpsecAttributeRequest_Attr() {}

func (*SetIpsecAttributeRequest_StatsMode) isSetIpsecAttributeRequest_Attr() {}
...
type GetIpsecAttributeResponse struct {
	...
	Attr []*IpsecAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateIpsecPortRequest struct {
	...
	NativeVlanId            uint32              `protobuf:"varint,5,opt,name=native_vlan_id,json=nativeVlanId,proto3" json:"native_vlan_id,omitempty"`
	VrfFromPacketVlanEnable bool                `protobuf:"varint,6,opt,name=vrf_from_packet_vlan_enable,json=vrfFromPacketVlanEnable,proto3" json:"vrf_from_packet_vlan_enable,omitempty"`
	SwitchSwitchingMode     SwitchSwitchingMode `protobuf:"varint,7,opt,name=switch_switching_mode,json=switchSwitchingMode,proto3,enum=lemming.dataplane.sai.SwitchSwitchingMode" json:"switch_switching_mode,omitempty"`
}
...
type SetIpsecPortAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetIpsecPortAttributeRequest_CtagEnable
	//	*SetIpsecPortAttributeRequest_StagEnable
	//	*SetIpsecPortAttributeRequest_VrfFromPacketVlanEnable
	//	*SetIpsecPortAttributeRequest_SwitchSwitchingMode
	Attr isSetIpsecPortAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (x *SetIpsecPortAttributeRequest) GetCtagEnable() bool {
	if x, ok := x.GetAttr().(*SetIpsecPortAttributeRequest_CtagEnable); ok {
		return x.CtagEnable
	}
	return false
}
...
func (x *SetIpsecPortAttributeRequest) GetStagEnable() bool {
	if x, ok := x.GetAttr().(*SetIpsecPortAttributeRequest_StagEnable); ok {
		return x.StagEnable
	}
	return false
}
...
func (x *SetIpsecPortAttributeRequest) GetVrfFromPacketVlanEnable() bool {
	if x, ok := x.GetAttr().(*SetIpsecPortAttributeRequest_VrfFromPacketVlanEnable); ok {
		return x.VrfFromPacketVlanEnable
	}
	return false
}
...
func (x *SetIpsecPortAttributeRequest) GetSwitchSwitchingMode() SwitchSwitchingMode {
	if x, ok := x.GetAttr().(*SetIpsecPortAttributeRequest_SwitchSwitchingMode); ok {
		return x.SwitchSwitchingMode
	}
	return SwitchSwitchingMode_SWITCH_SWITCHING_MODE_UNSPECIFIED
}

type isSetIpsecPortAttributeRequest_Attr interface {
	isSetIpsecPortAttributeRequest_Attr()
}

type SetIpsecPortAttributeRequest_CtagEnable struct {
	CtagEnable bool `protobuf:"varint,2,opt,name=ctag_enable,json=ctagEnable,proto3,oneof"`
}

type SetIpsecPortAttributeRequest_StagEnable struct {
	StagEnable bool `protobuf:"varint,3,opt,name=stag_enable,json=stagEnable,proto3,oneof"`
}

type SetIpsecPortAttributeRequest_VrfFromPacketVlanEnable struct {
	VrfFromPacketVlanEnable bool `protobuf:"varint,4,opt,name=vrf_from_packet_vlan_enable,json=vrfFromPacketVlanEnable,proto3,oneof"`
}

type SetIpsecPortAttributeRequest_SwitchSwitchingMode struct {
	SwitchSwitchingMode SwitchSwitchingMode `protobuf:"varint,5,opt,name=switch_switching_mode,json=switchSwitchingMode,proto3,enum=lemming.dataplane.sai.SwitchSwitchingMode,oneof"`
}

func (*SetIpsecPortAttributeRequest_CtagEnable) isSetIpsecPortAttributeRequest_Attr() {}

func (*SetIpsecPortAttributeRequest_StagEnable) isSetIpsecPortAttributeRequest_Attr() {}

func (*SetIpsecPortAttributeRequest_VrfFromPacketVlanEnable) isSetIpsecPortAttributeRequest_Attr() {}

func (*SetIpsecPortAttributeRequest_SwitchSwitchingMode) isSetIpsecPortAttributeRequest_Attr() {}
...
type GetIpsecPortAttributeResponse struct {
	...
	Attr []*IpsecPortAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
type CreateIpsecSaRequest struct {
	...
	Switch                      uint64         `protobuf:"varint,1,opt,name=switch,proto3" json:"switch,omitempty"`
	IpsecDirection              IpsecDirection `protobuf:"varint,2,opt,name=ipsec_direction,json=ipsecDirection,proto3,enum=lemming.dataplane.sai.IpsecDirection" json:"ipsec_direction,omitempty"`
	IpsecId                     uint64         `protobuf:"varint,3,opt,name=ipsec_id,json=ipsecId,proto3" json:"ipsec_id,omitempty"`
	...
	IpsecSpi                    uint32         `protobuf:"varint,6,opt,name=ipsec_spi,json=ipsecSpi,proto3" json:"ipsec_spi,omitempty"`
	IpsecEsnEnable              bool           `protobuf:"varint,7,opt,name=ipsec_esn_enable,json=ipsecEsnEnable,proto3" json:"ipsec_esn_enable,omitempty"`
	IpsecCipher                 IpsecCipher    `protobuf:"varint,8,opt,name=ipsec_cipher,json=ipsecCipher,proto3,enum=lemming.dataplane.sai.IpsecCipher" json:"ipsec_cipher,omitempty"`
	EncryptKey                  []byte         `protobuf:"bytes,9,opt,name=encrypt_key,json=encryptKey,proto3" json:"encrypt_key,omitempty"`
	Salt                        uint32         `protobuf:"varint,10,opt,name=salt,proto3" json:"salt,omitempty"`
	AuthKey                     []byte         `protobuf:"bytes,11,opt,name=auth_key,json=authKey,proto3" json:"auth_key,omitempty"`
	IpsecReplayProtectionEnable bool           `protobuf:"varint,12,opt,name=ipsec_replay_protection_enable,json=ipsecReplayProtectionEnable,proto3" json:"ipsec_replay_protection_enable,omitempty"`
	IpsecReplayProtectionWindow uint32         `protobuf:"varint,13,opt,name=ipsec_replay_protection_window,json=ipsecReplayProtectionWindow,proto3" json:"ipsec_replay_protection_window,omitempty"`
	TermDstIp                   []byte         `protobuf:"bytes,14,opt,name=term_dst_ip,json=termDstIp,proto3" json:"term_dst_ip,omitempty"`
	TermVlanIdEnable            bool           `protobuf:"varint,15,opt,name=term_vlan_id_enable,json=termVlanIdEnable,proto3" json:"term_vlan_id_enable,omitempty"`
	TermVlanId                  uint32         `protobuf:"varint,16,opt,name=term_vlan_id,json=termVlanId,proto3" json:"term_vlan_id,omitempty"`
	TermSrcIpEnable             bool           `protobuf:"varint,17,opt,name=term_src_ip_enable,json=termSrcIpEnable,proto3" json:"term_src_ip_enable,omitempty"`
	TermSrcIp                   []byte         `protobuf:"bytes,18,opt,name=term_src_ip,json=termSrcIp,proto3" json:"term_src_ip,omitempty"`
	EgressEsn                   uint64         `protobuf:"varint,19,opt,name=egress_esn,json=egressEsn,proto3" json:"egress_esn,omitempty"`
	MinimumIngressEsn           uint64         `protobuf:"varint,20,opt,name=minimum_ingress_esn,json=minimumIngressEsn,proto3" json:"minimum_ingress_esn,omitempty"`
}
...
type SetIpsecSaAttributeRequest struct {
	...
	// Types that are assignable to Attr:
	//
	//	*SetIpsecSaAttributeRequest_ExternalSaIndex
	//	*SetIpsecSaAttributeRequest_IpsecPortList
	//	*SetIpsecSaAttributeRequest_IpsecReplayProtectionEnable
	//	*SetIpsecSaAttributeRequest_IpsecReplayProtectionWindow
	//	*SetIpsecSaAttributeRequest_EgressEsn
	//	*SetIpsecSaAttributeRequest_MinimumIngressEsn
	Attr isSetIpsecSaAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (x *SetIpsecSaAttributeRequest) GetExternalSaIndex() uint32 {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_ExternalSaIndex); ok {
		return x.ExternalSaIndex
	}
	return 0
}

func (x *SetIpsecSaAttributeRequest) GetIpsecPortList() *Uint64List {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_IpsecPortList); ok {
		return x.IpsecPortList
	}
	return nil
}
...
func (x *SetIpsecSaAttributeRequest) GetIpsecReplayProtectionEnable() bool {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_IpsecReplayProtectionEnable); ok {
		return x.IpsecReplayProtectionEnable
	}
	return false
}
...
func (x *SetIpsecSaAttributeRequest) GetIpsecReplayProtectionWindow() uint32 {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_IpsecReplayProtectionWindow); ok {
		return x.IpsecReplayProtectionWindow
	}
	return 0
}
...
func (x *SetIpsecSaAttributeRequest) GetEgressEsn() uint64 {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_EgressEsn); ok {
		return x.EgressEsn
	}
	return 0
}
...
func (x *SetIpsecSaAttributeRequest) GetMinimumIngressEsn() uint64 {
	if x, ok := x.GetAttr().(*SetIpsecSaAttributeRequest_MinimumIngressEsn); ok {
		return x.MinimumIngressEsn
	}
	return 0
}

type isSetIpsecSaAttributeRequest_Attr interface {
	isSetIpsecSaAttributeRequest_Attr()
}

type SetIpsecSaAttributeRequest_ExternalSaIndex struct {
	ExternalSaIndex uint32 `protobuf:"varint,2,opt,name=external_sa_index,json=externalSaIndex,proto3,oneof"`
}

type SetIpsecSaAttributeRequest_IpsecPortList struct {
	IpsecPortList *Uint64List `protobuf:"bytes,3,opt,name=ipsec_port_list,json=ipsecPortList,proto3,oneof"`
}

type SetIpsecSaAttributeRequest_IpsecReplayProtectionEnable struct {
	IpsecReplayProtectionEnable bool `protobuf:"varint,4,opt,name=ipsec_replay_protection_enable,json=ipsecReplayProtectionEnable,proto3,oneof"`
}

type SetIpsecSaAttributeRequest_IpsecReplayProtectionWindow struct {
	IpsecReplayProtectionWindow uint32 `protobuf:"varint,5,opt,name=ipsec_replay_protection_window,json=ipsecReplayProtectionWindow,proto3,oneof"`
}

type SetIpsecSaAttributeRequest_EgressEsn struct {
	EgressEsn uint64 `protobuf:"varint,6,opt,name=egress_esn,json=egressEsn,proto3,oneof"`
}

type SetIpsecSaAttributeRequest_MinimumIngressEsn struct {
	MinimumIngressEsn uint64 `protobuf:"varint,7,opt,name=minimum_ingress_esn,json=minimumIngressEsn,proto3,oneof"`
}

func (*SetIpsecSaAttributeRequest_ExternalSaIndex) isSetIpsecSaAttributeRequest_Attr() {}

func (*SetIpsecSaAttributeRequest_IpsecPortList) isSetIpsecSaAttributeRequest_Attr() {}

func (*SetIpsecSaAttributeRequest_IpsecReplayProtectionEnable) isSetIpsecSaAttributeRequest_Attr() {}

func (*SetIpsecSaAttributeRequest_IpsecReplayProtectionWindow) isSetIpsecSaAttributeRequest_Attr() {}

func (*SetIpsecSaAttributeRequest_EgressEsn) isSetIpsecSaAttributeRequest_Attr() {}

func (*SetIpsecSaAttributeRequest_MinimumIngressEsn) isSetIpsecSaAttributeRequest_Attr() {}
...
type GetIpsecSaAttributeResponse struct {
	...
	Attr []*IpsecSaAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_ipsec_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x03, 0x0a, 0x12, 0x43, 0x72, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x4d, 0x6f, 0x64, 0x65, 0x48, 0x00, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x73, 0x4d, 0x6f, 0x64,
	0x65, 0x42, 0x06, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x1b, 0x0a, 0x19, 0x53, 0x65, 0x74,
	...
	0x12, 0x39, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25,
	...
	0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0xcf, 0x02, 0x0a, 0x16,
	...
	,
	...
	,
	...
	0x67, 0x4d, 0x6f, 0x64, 0x65, 0x48, 0x00, 0x52, 0x13, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x53,
	0x77, 0x69, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x42, 0x06, 0x0a, 0x04,
	0x61, 0x74, 0x74, 0x72, 0x22, 0x1f, 0x0a, 0x1d, 0x53, 0x65, 0x74, 0x49, 0x70, 0x73, 0x65, 0x63,
	0x50, 0x6f, 0x72, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x73, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x49, 0x70, 0x73, 0x65,
	...
	0x61, 0x69, 0x2e, 0x49, 0x70, 0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x41, 0x74, 0x74, 0x72,
	...
	0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61,
	0x69, 0x2e, 0x49, 0x70, 0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x41, 0x74, 0x74, 0x72, 0x69,
	0x62, 0x75, 0x74, 0x65, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0xe2, 0x06, 0x0a, 0x14, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x70, 0x73, 0x65, 0x63, 0x53, 0x61, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x4e, 0x0a, 0x0f, 0x69,
	0x70, 0x73, 0x65, 0x63, 0x5f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x03, 0x6f, 0x69, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x49, 0x70,
	0x73, 0x65, 0x63, 0x53, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x92, 0x03,
	0x0a, 0x1a, 0x53, 0x65, 0x74, 0x49, 0x70, 0x73, 0x65, 0x63, 0x53, 0x61, 0x41, 0x74, 0x74, 0x72,
	...
	0x0a, 0x11, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x73, 0x61, 0x5f, 0x69, 0x6e,
	0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x0f, 0x65, 0x78, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x61, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x4b, 0x0a, 0x0f,
	...
	0x6e, 0x74, 0x36, 0x34, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0d, 0x69, 0x70, 0x73, 0x65,
	0x63, 0x50, 0x6f, 0x72, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x45, 0x0a, 0x1e, 0x69, 0x70, 0x73,
	...
	,
	...
	,
	...
	0x5f, 0x53, 0x55, 0x50, 0x50, 0x4f, 0x52, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x39, 0x0a, 0x35,
	0x49, 0x50, 0x53, 0x45, 0x43, 0x5f, 0x41, 0x54, 0x54, 0x52, 0x5f, 0x53, 0x57, 0x49, 0x54, 0x43,
	0x48, 0x49, 0x4e, 0x47, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x5f,
	0x41, 0x4e, 0x44, 0x5f, 0x46, 0x4f, 0x52, 0x57, 0x41, 0x52, 0x44, 0x5f, 0x53, 0x55, 0x50, 0x50,
	0x4f, 0x52, 0x54, 0x45, 0x44, 0x10, 0x03, 0x12, 0x28, 0x0a, 0x24, 0x49, 0x50, 0x53, 0x45, 0x43,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x53, 0x65, 0x74, 0x49, 0x70, 0x73,
	0x65, 0x63, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x74, 0x65, 0x49, 0x70, 0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x72, 0x0a, 0x0f, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x49, 0x70,
	0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x2d, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e,
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x49, 0x70, 0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x52,
	...
	0x65, 0x6d, 0x6f, 0x76, 0x65, 0x49, 0x70, 0x73, 0x65, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x65,
	...
	,
...
var file_dataplane_standalone_proto_ipsec_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_dataplane_standalone_proto_ipsec_proto_goTypes = []interface{}{
	...
	(*CreateIpsecSaRequest)(nil),          // 19: lemming.dataplane.sai.CreateIpsecSaRequest
	(*CreateIpsecSaResponse)(nil),         // 20: lemming.dataplane.sai.CreateIpsecSaResponse
	(*RemoveIpsecSaRequest)(nil),          // 21: lemming.dataplane.sai.RemoveIpsecSaRequest
	(*RemoveIpsecSaResponse)(nil),         // 22: lemming.dataplane.sai.RemoveIpsecSaResponse
	(*SetIpsecSaAttributeRequest)(nil),    // 23: lemming.dataplane.sai.SetIpsecSaAttributeRequest
	(*SetIpsecSaAttributeResponse)(nil),   // 24: lemming.dataplane.sai.SetIpsecSaAttributeResponse
	(*GetIpsecSaAttributeRequest)(nil),    // 25: lemming.dataplane.sai.GetIpsecSaAttributeRequest
	(*GetIpsecSaAttributeResponse)(nil),   // 26: lemming.dataplane.sai.GetIpsecSaAttributeResponse
	(StatsMode)(0),                        // 27: lemming.dataplane.sai.StatsMode
	(*IpsecAttribute)(nil),                // 28: lemming.dataplane.sai.IpsecAttribute
	(SwitchSwitchingMode)(0),              // 29: lemming.dataplane.sai.SwitchSwitchingMode
	(*IpsecPortAttribute)(nil),            // 30: lemming.dataplane.sai.IpsecPortAttribute
	(IpsecDirection)(0),                   // 31: lemming.dataplane.sai.IpsecDirection
	(IpsecCipher)(0),                      // 32: lemming.dataplane.sai.IpsecCipher
	(*Uint64List)(nil),                    // 33: lemming.dataplane.sai.Uint64List
	(*IpsecSaAttribute)(nil),              // 34: lemming.dataplane.sai.IpsecSaAttribute
}
var file_dataplane_standalone_proto_ipsec_proto_depIdxs = []int32{
	27, // 0: lemming.dataplane.sai.CreateIpsecRequest.stats_mode:type_name -> lemming.dataplane.sai.StatsMode
	27, // 1: lemming.dataplane.sai.SetIpsecAttributeRequest.stats_mode:type_name -> lemming.dataplane.sai.StatsMode
	0,  // 2: lemming.dataplane.sai.GetIpsecAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.IpsecAttr
	28, // 3: lemming.dataplane.sai.GetIpsecAttributeResponse.attr:type_name -> lemming.dataplane.sai.IpsecAttribute
	29, // 4: lemming.dataplane.sai.CreateIpsecPortRequest.switch_switching_mode:type_name -> lemming.dataplane.sai.SwitchSwitchingMode
	29, // 5: lemming.dataplane.sai.SetIpsecPortAttributeRequest.switch_switching_mode:type_name -> lemming.dataplane.sai.SwitchSwitchingMode
	1,  // 6: lemming.dataplane.sai.GetIpsecPortAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.IpsecPortAttr
	30, // 7: lemming.dataplane.sai.GetIpsecPortAttributeResponse.attr:type_name -> lemming.dataplane.sai.IpsecPortAttribute
	31, // 8: lemming.dataplane.sai.CreateIpsecSaRequest.ipsec_direction:type_name -> lemming.dataplane.sai.IpsecDirection
	32, // 9: lemming.dataplane.sai.CreateIpsecSaRequest.ipsec_cipher:type_name -> lemming.dataplane.sai.IpsecCipher
	33, // 10: lemming.dataplane.sai.SetIpsecSaAttributeRequest.ipsec_port_list:type_name -> lemming.dataplane.sai.Uint64List
	2,  // 11: lemming.dataplane.sai.GetIpsecSaAttributeRequest.attr_type:type_name -> lemming.dataplane.sai.IpsecSaAttr
	34, // 12: lemming.dataplane.sai.GetIpsecSaAttributeResponse.attr:type_name -> lemming.dataplane.sai.IpsecSaAttribute
	3,  // 13: lemming.dataplane.sai.Ipsec.CreateIpsec:input_type -> lemming.dataplane.sai.CreateIpsecRequest
	5,  // 14: lemming.dataplane.sai.Ipsec.RemoveIpsec:input_type -> lemming.dataplane.sai.RemoveIpsecRequest
	7,  // 15: lemming.dataplane.sai.Ipsec.SetIpsecAttribute:input_type -> lemming.dataplane.sai.SetIpsecAttributeRequest
	9,  // 16: lemming.dataplane.sai.Ipsec.GetIpsecAttribute:input_type -> lemming.dataplane.sai.GetIpsecAttributeRequest
	11, // 17: lemming.dataplane.sai.Ipsec.CreateIpsecPort:input_type -> lemming.dataplane.sai.CreateIpsecPortRequest
	13, // 18: lemming.dataplane.sai.Ipsec.RemoveIpsecPort:input_type -> lemming.dataplane.sai.RemoveIpsecPortRequest
	15, // 19: lemming.dataplane.sai.Ipsec.SetIpsecPortAttribute:input_type -> lemming.dataplane.sai.SetIpsecPortAttributeRequest
	17, // 20: lemming.dataplane.sai.Ipsec.GetIpsecPortAttribute:input_type -> lemming.dataplane.sai.GetIpsecPortAttributeRequest
	19, // 21: lemming.dataplane.sai.Ipsec.CreateIpsecSa:input_type -> lemming.dataplane.sai.CreateIpsecSaRequest
	21, // 22: lemming.dataplane.sai.Ipsec.RemoveIpsecSa:input_type -> lemming.dataplane.sai.RemoveIpsecSaRequest
	23, // 23: lemming.dataplane.sai.Ipsec.SetIpsecSaAttribute:input_type -> lemming.dataplane.sai.SetIpsecSaAttributeRequest
	25, // 24: lemming.dataplane.sai.Ipsec.GetIpsecSaAttribute:input_type -> lemming.dataplane.sai.GetIpsecSaAttributeRequest
	4,  // 25: lemming.dataplane.sai.Ipsec.CreateIpsec:output_type -> lemming.dataplane.sai.CreateIpsecResponse
	6,  // 26: lemming.dataplane.sai.Ipsec.RemoveIpsec:output_type -> lemming.dataplane.sai.RemoveIpsecResponse
	8,  // 27: lemming.dataplane.sai.Ipsec.SetIpsecAttribute:output_type -> lemming.dataplane.sai.SetIpsecAttributeResponse
	10, // 28: lemming.dataplane.sai.Ipsec.GetIpsecAttribute:output_type -> lemming.dataplane.sai.GetIpsecAttributeResponse
	12, // 29: lemming.dataplane.sai.Ipsec.CreateIpsecPort:output_type -> lemming.dataplane.sai.CreateIpsecPortResponse
	14, // 30: lemming.dataplane.sai.Ipsec.RemoveIpsecPort:output_type -> lemming.dataplane.sai.RemoveIpsecPortResponse
	16, // 31: lemming.dataplane.sai.Ipsec.SetIpsecPortAttribute:output_type -> lemming.dataplane.sai.SetIpsecPortAttributeResponse
	18, // 32: lemming.dataplane.sai.Ipsec.GetIpsecPortAttribute:output_type -> lemming.dataplane.sai.GetIpsecPortAttributeResponse
	20, // 33: lemming.dataplane.sai.Ipsec.CreateIpsecSa:output_type -> lemming.dataplane.sai.CreateIpsecSaResponse
	22, // 34: lemming.dataplane.sai.Ipsec.RemoveIpsecSa:output_type -> lemming.dataplane.sai.RemoveIpsecSaResponse
	24, // 35: lemming.dataplane.sai.Ipsec.SetIpsecSaAttribute:output_type -> lemming.dataplane.sai.SetIpsecSaAttributeResponse
	26, // 36: lemming.dataplane.sai.Ipsec.GetIpsecSaAttribute:output_type -> lemming.dataplane.sai.GetIpsecSaAttributeResponse
...
func file_dataplane_standalone_proto_ipsec_proto_init() {
	...
	file_dataplane_standalone_proto_ipsec_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetIpsecAttributeRequest_WarmBootEnable)(nil),
		(*SetIpsecAttributeRequest_CtagTpid)(nil),
		(*SetIpsecAttributeRequest_StagTpid)(nil),
		(*SetIpsecAttributeRequest_MaxVlanTagsParsed)(nil),
		(*SetIpsecAttributeRequest_OctetCountHighWatermark)(nil),
		(*SetIpsecAttributeRequest_OctetCountLowWatermark)(nil),
		(*SetIpsecAttributeRequest_StatsMode)(nil),
	}
	file_dataplane_standalone_proto_ipsec_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*SetIpsecPortAttributeRequest_CtagEnable)(nil),
		(*SetIpsecPortAttributeRequest_StagEnable)(nil),
		(*SetIpsecPortAttributeRequest_VrfFromPacketVlanEnable)(nil),
		(*SetIpsecPortAttributeRequest_SwitchSwitchingMode)(nil),
	}
	file_dataplane_standalone_proto_ipsec_proto_msgTypes[20].OneofWrappers = []interface{}{
		(*SetIpsecSaAttributeRequest_ExternalSaIndex)(nil),
		(*SetIpsecSaAttributeRequest_IpsecPortList)(nil),
		(*SetIpsecSaAttributeRequest_IpsecReplayProtectionEnable)(nil),
		(*SetIpsecSaAttributeRequest_IpsecReplayProtectionWindow)(nil),
		(*SetIpsecSaAttributeRequest_EgressEsn)(nil),
		(*SetIpsecSaAttributeRequest_MinimumIngressEsn)(nil),
	}
	type x struct{}
