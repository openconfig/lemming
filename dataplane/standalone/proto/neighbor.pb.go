...
type CreateNeighborEntryRequest struct {
	...
	DstMacAddress    []byte         `protobuf:"bytes,2,opt,name=dst_mac_address,json=dstMacAddress,proto3" json:"dst_mac_address,omitempty"`
	...
	NoHostRoute      bool           `protobuf:"varint,5,opt,name=no_host_route,json=noHostRoute,proto3" json:"no_host_route,omitempty"`
	...
	EncapIndex       uint32         `protobuf:"varint,8,opt,name=encap_index,json=encapIndex,proto3" json:"encap_index,omitempty"`
	EncapImposeIndex bool           `protobuf:"varint,9,opt,name=encap_impose_index,json=encapImposeIndex,proto3" json:"encap_impose_index,omitempty"`
...
type SetNeighborEntryAttributeRequest struct {
	...
	//
	//	*SetNeighborEntryAttributeRequest_DstMacAddress
	//	*SetNeighborEntryAttributeRequest_PacketAction
	//	*SetNeighborEntryAttributeRequest_UserTrapId
	//	*SetNeighborEntryAttributeRequest_NoHostRoute
	//	*SetNeighborEntryAttributeRequest_MetaData
	//	*SetNeighborEntryAttributeRequest_CounterId
	//	*SetNeighborEntryAttributeRequest_EncapIndex
	//	*SetNeighborEntryAttributeRequest_EncapImposeIndex
	//	*SetNeighborEntryAttributeRequest_IsLocal
	Attr isSetNeighborEntryAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetNeighborEntryAttributeRequest) GetAttr() isSetNeighborEntryAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetNeighborEntryAttributeRequest) GetDstMacAddress() []byte {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_DstMacAddress); ok {
		return x.DstMacAddress
	}
	return nil
}
...
func (x *SetNeighborEntryAttributeRequest) GetPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_PacketAction); ok {
		return x.PacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetNeighborEntryAttributeRequest) GetUserTrapId() uint64 {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_UserTrapId); ok {
		return x.UserTrapId
	}
	return 0
}
...
func (x *SetNeighborEntryAttributeRequest) GetNoHostRoute() bool {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_NoHostRoute); ok {
		return x.NoHostRoute
	}
	return false
}
...
func (x *SetNeighborEntryAttributeRequest) GetMetaData() uint32 {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_MetaData); ok {
		return x.MetaData
	}
	return 0
}
...
func (x *SetNeighborEntryAttributeRequest) GetCounterId() uint64 {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_CounterId); ok {
		return x.CounterId
	}
	return 0
}
...
func (x *SetNeighborEntryAttributeRequest) GetEncapIndex() uint32 {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_EncapIndex); ok {
		return x.EncapIndex
	}
	return 0
}
...
func (x *SetNeighborEntryAttributeRequest) GetEncapImposeIndex() bool {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_EncapImposeIndex); ok {
		return x.EncapImposeIndex
	}
	return false
}
...
func (x *SetNeighborEntryAttributeRequest) GetIsLocal() bool {
	if x, ok := x.GetAttr().(*SetNeighborEntryAttributeRequest_IsLocal); ok {
		return x.IsLocal
	}
	return false
}

type isSetNeighborEntryAttributeRequest_Attr interface {
	isSetNeighborEntryAttributeRequest_Attr()
}

type SetNeighborEntryAttributeRequest_DstMacAddress struct {
	DstMacAddress []byte `protobuf:"bytes,2,opt,name=dst_mac_address,json=dstMacAddress,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_PacketAction struct {
...
type SetNeighborEntryAttributeRequest_UserTrapId struct {
	UserTrapId uint64 `protobuf:"varint,4,opt,name=user_trap_id,json=userTrapId,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_NoHostRoute struct {
	NoHostRoute bool `protobuf:"varint,5,opt,name=no_host_route,json=noHostRoute,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_MetaData struct {
	MetaData uint32 `protobuf:"varint,6,opt,name=meta_data,json=metaData,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_CounterId struct {
	CounterId uint64 `protobuf:"varint,7,opt,name=counter_id,json=counterId,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_EncapIndex struct {
	EncapIndex uint32 `protobuf:"varint,8,opt,name=encap_index,json=encapIndex,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_EncapImposeIndex struct {
	EncapImposeIndex bool `protobuf:"varint,9,opt,name=encap_impose_index,json=encapImposeIndex,proto3,oneof"`
}

type SetNeighborEntryAttributeRequest_IsLocal struct {
	IsLocal bool `protobuf:"varint,10,opt,name=is_local,json=isLocal,proto3,oneof"`
}

func (*SetNeighborEntryAttributeRequest_DstMacAddress) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_PacketAction) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_UserTrapId) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_NoHostRoute) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_MetaData) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_CounterId) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_EncapIndex) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_EncapImposeIndex) isSetNeighborEntryAttributeRequest_Attr() {}

func (*SetNeighborEntryAttributeRequest_IsLocal) isSetNeighborEntryAttributeRequest_Attr() {}
...
type GetNeighborEntryAttributeResponse struct {
	...
	Attr []*NeighborEntryAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_neighbor_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb6, 0x03, 0x0a, 0x1a,
	...
	0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x26, 0x0a, 0x0f, 0x64, 0x73, 0x74, 0x5f, 0x6d, 0x61,
	0x63, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0d, 0x64, 0x73, 0x74, 0x4d, 0x61, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x48,
	...
	,
	...
	,
...
func file_dataplane_standalone_proto_neighbor_proto_init() {
	...
	file_dataplane_standalone_proto_neighbor_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetNeighborEntryAttributeRequest_DstMacAddress)(nil),
		(*SetNeighborEntryAttributeRequest_PacketAction)(nil),
		(*SetNeighborEntryAttributeRequest_UserTrapId)(nil),
		(*SetNeighborEntryAttributeRequest_NoHostRoute)(nil),
		(*SetNeighborEntryAttributeRequest_MetaData)(nil),
		(*SetNeighborEntryAttributeRequest_CounterId)(nil),
		(*SetNeighborEntryAttributeRequest_EncapIndex)(nil),
		(*SetNeighborEntryAttributeRequest_EncapImposeIndex)(nil),
		(*SetNeighborEntryAttributeRequest_IsLocal)(nil),
	}
	type x struct{}
