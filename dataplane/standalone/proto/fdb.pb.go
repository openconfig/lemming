...
type CreateFdbEntryRequest struct {
	...
	Type         FdbEntryType `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.FdbEntryType" json:"type,omitempty"`
	...
	UserTrapId   uint64       `protobuf:"varint,4,opt,name=user_trap_id,json=userTrapId,proto3" json:"user_trap_id,omitempty"`
	BridgePortId uint64       `protobuf:"varint,5,opt,name=bridge_port_id,json=bridgePortId,proto3" json:"bridge_port_id,omitempty"`
	MetaData     uint32       `protobuf:"varint,6,opt,name=meta_data,json=metaData,proto3" json:"meta_data,omitempty"`
	EndpointIp   []byte       `protobuf:"bytes,7,opt,name=endpoint_ip,json=endpointIp,proto3" json:"endpoint_ip,omitempty"`
	CounterId    uint64       `protobuf:"varint,8,opt,name=counter_id,json=counterId,proto3" json:"counter_id,omitempty"`
	AllowMacMove bool         `protobuf:"varint,9,opt,name=allow_mac_move,json=allowMacMove,proto3" json:"allow_mac_move,omitempty"`
}
...
type SetFdbEntryAttributeRequest struct {
	...
	//
	//	*SetFdbEntryAttributeRequest_Type
	//	*SetFdbEntryAttributeRequest_PacketAction
	//	*SetFdbEntryAttributeRequest_UserTrapId
	//	*SetFdbEntryAttributeRequest_BridgePortId
	//	*SetFdbEntryAttributeRequest_MetaData
	//	*SetFdbEntryAttributeRequest_EndpointIp
	//	*SetFdbEntryAttributeRequest_CounterId
	//	*SetFdbEntryAttributeRequest_AllowMacMove
	Attr isSetFdbEntryAttributeRequest_Attr `protobuf_oneof:"attr"`
}
...
func (m *SetFdbEntryAttributeRequest) GetAttr() isSetFdbEntryAttributeRequest_Attr {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (x *SetFdbEntryAttributeRequest) GetType() FdbEntryType {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_Type); ok {
		return x.Type
	}
	return FdbEntryType_FDB_ENTRY_TYPE_UNSPECIFIED
}
...
func (x *SetFdbEntryAttributeRequest) GetPacketAction() PacketAction {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_PacketAction); ok {
		return x.PacketAction
	}
	return PacketAction_PACKET_ACTION_UNSPECIFIED
}
...
func (x *SetFdbEntryAttributeRequest) GetUserTrapId() uint64 {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_UserTrapId); ok {
		return x.UserTrapId
	}
	return 0
}
...
func (x *SetFdbEntryAttributeRequest) GetBridgePortId() uint64 {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_BridgePortId); ok {
		return x.BridgePortId
	}
	return 0
}
...
func (x *SetFdbEntryAttributeRequest) GetMetaData() uint32 {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_MetaData); ok {
		return x.MetaData
	}
	return 0
}
...
func (x *SetFdbEntryAttributeRequest) GetEndpointIp() []byte {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_EndpointIp); ok {
		return x.EndpointIp
	}
	return nil
}
...
func (x *SetFdbEntryAttributeRequest) GetCounterId() uint64 {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_CounterId); ok {
		return x.CounterId
	}
	return 0
}
...
func (x *SetFdbEntryAttributeRequest) GetAllowMacMove() bool {
	if x, ok := x.GetAttr().(*SetFdbEntryAttributeRequest_AllowMacMove); ok {
		return x.AllowMacMove
	}
	return false
}

type isSetFdbEntryAttributeRequest_Attr interface {
	isSetFdbEntryAttributeRequest_Attr()
}

type SetFdbEntryAttributeRequest_Type struct {
	Type FdbEntryType `protobuf:"varint,2,opt,name=type,proto3,enum=lemming.dataplane.sai.FdbEntryType,oneof"`
}

type SetFdbEntryAttributeRequest_PacketAction struct {
...
type SetFdbEntryAttributeRequest_UserTrapId struct {
	UserTrapId uint64 `protobuf:"varint,4,opt,name=user_trap_id,json=userTrapId,proto3,oneof"`
}

type SetFdbEntryAttributeRequest_BridgePortId struct {
	BridgePortId uint64 `protobuf:"varint,5,opt,name=bridge_port_id,json=bridgePortId,proto3,oneof"`
}

type SetFdbEntryAttributeRequest_MetaData struct {
	MetaData uint32 `protobuf:"varint,6,opt,name=meta_data,json=metaData,proto3,oneof"`
}

type SetFdbEntryAttributeRequest_EndpointIp struct {
	EndpointIp []byte `protobuf:"bytes,7,opt,name=endpoint_ip,json=endpointIp,proto3,oneof"`
}

type SetFdbEntryAttributeRequest_CounterId struct {
	CounterId uint64 `protobuf:"varint,8,opt,name=counter_id,json=counterId,proto3,oneof"`
}

type SetFdbEntryAttributeRequest_AllowMacMove struct {
	AllowMacMove bool `protobuf:"varint,9,opt,name=allow_mac_move,json=allowMacMove,proto3,oneof"`
}

func (*SetFdbEntryAttributeRequest_Type) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_PacketAction) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_UserTrapId) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_BridgePortId) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_MetaData) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_EndpointIp) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_CounterId) isSetFdbEntryAttributeRequest_Attr() {}

func (*SetFdbEntryAttributeRequest_AllowMacMove) isSetFdbEntryAttributeRequest_Attr() {}
...
type GetFdbEntryAttributeResponse struct {
	...
	Attr []*FdbEntryAttribute `protobuf:"bytes,1,rep,name=attr,proto3" json:"attr,omitempty"`
}
...
var file_dataplane_standalone_proto_fdb_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x03, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x37, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	...
	0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x12, 0x48, 0x0a, 0x0d, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	,
	...
	0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e,
	0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22,
	0x18, 0x0a, 0x16, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xba, 0x03, 0x0a, 0x1b, 0x53, 0x65,
	0x74, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75,
	0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x35, 0x0a, 0x05, 0x65, 0x6e, 0x74,
	...
	0x12, 0x39, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23,
	0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69, 0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61,
	0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69, 0x2e, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x54,
	0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x4a, 0x0a, 0x0d, 0x70,
	...
	,
	...
	,
	...
	0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x2c, 0x2e, 0x6c, 0x65, 0x6d, 0x6d, 0x69,
	0x6e, 0x67, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x73, 0x61, 0x69,
	0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	...
	0x65, 0x6d, 0x6f, 0x76, 0x65, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x81, 0x01, 0x0a, 0x14, 0x53, 0x65, 0x74, 0x46,
	...
	0x47, 0x65, 0x74, 0x46, 0x64, 0x62, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x41, 0x74, 0x74, 0x72, 0x69,
...
func file_dataplane_standalone_proto_fdb_proto_init() {
	...
	file_dataplane_standalone_proto_fdb_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*SetFdbEntryAttributeRequest_Type)(nil),
		(*SetFdbEntryAttributeRequest_PacketAction)(nil),
		(*SetFdbEntryAttributeRequest_UserTrapId)(nil),
		(*SetFdbEntryAttributeRequest_BridgePortId)(nil),
		(*SetFdbEntryAttributeRequest_MetaData)(nil),
		(*SetFdbEntryAttributeRequest_EndpointIp)(nil),
		(*SetFdbEntryAttributeRequest_CounterId)(nil),
		(*SetFdbEntryAttributeRequest_AllowMacMove)(nil),
	}
	type x struct{}
