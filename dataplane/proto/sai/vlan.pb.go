...
var file_dataplane_proto_sai_vlan_proto_rawDesc = []byte{
...
var (
	...
	file_dataplane_proto_sai_vlan_proto_rawDescData = file_dataplane_proto_sai_vlan_proto_rawDesc
)

func file_dataplane_proto_sai_vlan_proto_rawDescGZIP() []byte {
	file_dataplane_proto_sai_vlan_proto_rawDescOnce.Do(func() {
		file_dataplane_proto_sai_vlan_proto_rawDescData = protoimpl.X.CompressGZIP(file_dataplane_proto_sai_vlan_proto_rawDescData)
	})
...
var file_dataplane_proto_sai_vlan_proto_goTypes = []interface{}{
...
func file_dataplane_proto_sai_vlan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dataplane_proto_sai_vlan_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoveVlanMembersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoveVlanMembersResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_sai_vlan_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
	...
	file_dataplane_proto_sai_vlan_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_dataplane_proto_sai_vlan_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_dataplane_proto_sai_vlan_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_dataplane_proto_sai_vlan_proto_msgTypes[12].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_dataplane_proto_sai_vlan_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_dataplane_proto_sai_vlan_proto_rawDesc = nil
...
func (c *vlanClient) RemoveVlanMembers(ctx context.Context, in *RemoveVlanMembersRequest, opts ...grpc.CallOption) (*RemoveVlanMembersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lemming.dataplane.sai.Vlan/RemoveVlanMembers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Vlan_RemoveVlanMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lemming.dataplane.sai.Vlan/RemoveVlanMembers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
