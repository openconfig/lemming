...
const (
	...
	Fdb_FlushFdbEntries_FullMethodName      = "/lemming.dataplane.sai.Fdb/FlushFdbEntries"
...
type FdbClient interface {
	...
	FlushFdbEntries(ctx context.Context, in *FlushFdbEntriesRequest, opts ...grpc.CallOption) (*FlushFdbEntriesResponse, error)
...
func (c *fdbClient) FlushFdbEntries(ctx context.Context, in *FlushFdbEntriesRequest, opts ...grpc.CallOption) (*FlushFdbEntriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FlushFdbEntriesResponse)
	err := c.cc.Invoke(ctx, Fdb_FlushFdbEntries_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FdbServer interface {
	...
	FlushFdbEntries(context.Context, *FlushFdbEntriesRequest) (*FlushFdbEntriesResponse, error)
...
func (UnimplementedFdbServer) FlushFdbEntries(context.Context, *FlushFdbEntriesRequest) (*FlushFdbEntriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FlushFdbEntries not implemented")
}
...
func _Fdb_FlushFdbEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlushFdbEntriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FdbServer).FlushFdbEntries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Fdb_FlushFdbEntries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FdbServer).FlushFdbEntries(ctx, req.(*FlushFdbEntriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Fdb_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FlushFdbEntries",
			Handler:    _Fdb_FlushFdbEntries_Handler,
		},
		{
