...
var file_dataplane_proto_sai_tunnel_proto_rawDesc = []byte{
...
var (
	...
	file_dataplane_proto_sai_tunnel_proto_rawDescData = file_dataplane_proto_sai_tunnel_proto_rawDesc
)

func file_dataplane_proto_sai_tunnel_proto_rawDescGZIP() []byte {
	file_dataplane_proto_sai_tunnel_proto_rawDescOnce.Do(func() {
		file_dataplane_proto_sai_tunnel_proto_rawDescData = protoimpl.X.CompressGZIP(file_dataplane_proto_sai_tunnel_proto_rawDescData)
	})
...
func file_dataplane_proto_sai_tunnel_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dataplane_proto_sai_tunnel_proto_rawDesc,
			NumEnums:      4,
			NumMessages:   34,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_dataplane_proto_sai_tunnel_proto_rawDesc = nil
...
func (c *tunnelClient) RemoveTunnels(ctx context.Context, in *RemoveTunnelsRequest, opts ...grpc.CallOption) (*RemoveTunnelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lemming.dataplane.sai.Tunnel/RemoveTunnels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Tunnel_RemoveTunnels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lemming.dataplane.sai.Tunnel/RemoveTunnels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
