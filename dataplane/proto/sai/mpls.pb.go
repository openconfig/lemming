...
func file_dataplane_proto_sai_mpls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dataplane_proto_sai_mpls_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoveInsegEntriesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dataplane_proto_sai_mpls_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoveInsegEntriesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
func (c *mplsClient) RemoveInsegEntries(ctx context.Context, in *RemoveInsegEntriesRequest, opts ...grpc.CallOption) (*RemoveInsegEntriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lemming.dataplane.sai.Mpls/RemoveInsegEntries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Mpls_RemoveInsegEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lemming.dataplane.sai.Mpls/RemoveInsegEntries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
