...
// 	protoc        v3.21.12
// source: dataplane/proto/counter.proto
...
func (CounterAttr) Descriptor() protoreflect.EnumDescriptor {
	return file_dataplane_proto_counter_proto_enumTypes[0].Descriptor()
}

func (CounterAttr) Type() protoreflect.EnumType {
	return &file_dataplane_proto_counter_proto_enumTypes[0]
}
...
func (CounterAttr) EnumDescriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateCounterRequest) Reset() {
	*x = CreateCounterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[0]
...
func (x *CreateCounterResponse) Reset() {
	*x = CreateCounterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateCounterResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{1}
}
...
func (x *RemoveCounterRequest) Reset() {
	*x = RemoveCounterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemoveCounterRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{2}
}
...
func (x *RemoveCounterResponse) Reset() {
	*x = RemoveCounterResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemoveCounterResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{3}
}
...
func (x *SetCounterAttributeRequest) Reset() {
	*x = SetCounterAttributeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetCounterAttributeRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{4}
}
...
func (x *SetCounterAttributeResponse) Reset() {
	*x = SetCounterAttributeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetCounterAttributeResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetCounterAttributeRequest) Reset() {
	*x = GetCounterAttributeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCounterAttributeRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{6}
}
...
func (x *GetCounterAttributeResponse) Reset() {
	*x = GetCounterAttributeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCounterAttributeResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{7}
}
...
func (x *GetCounterStatsRequest) Reset() {
	*x = GetCounterStatsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCounterStatsRequest) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetCounterStatsResponse) Reset() {
	*x = GetCounterStatsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dataplane_proto_counter_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCounterStatsResponse) Descriptor() ([]byte, []int) {
	return file_dataplane_proto_counter_proto_rawDescGZIP(), []int{9}
}
...
var File_dataplane_proto_counter_proto protoreflect.FileDescriptor

var file_dataplane_proto_counter_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x64, 0x61, 0x74, 0x61, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43,
	...
	0x77, 0x69, 0x74, 0x63, 0x68, 0x12, 0x41, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20,
	...
	0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x42, 0x04, 0x80, 0xb5, 0x18, 0x01, 0x48, 0x00, 0x52,
	0x04, 0x74, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65,
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x04, 0x80, 0xb5, 0x18, 0x02, 0x48, 0x01, 0x52,
	0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x88, 0x01, 0x01, 0x3a, 0x04, 0x88, 0xb5, 0x18, 0x55, 0x42,
	0x07, 0x0a, 0x05, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6c, 0x61, 0x62,
	0x65, 0x6c, 0x22, 0x29, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e,
	...
	0x22, 0x59, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x41, 0x74,
	...
	0x12, 0x1f, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42,
	0x04, 0x80, 0xb5, 0x18, 0x02, 0x48, 0x00, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x88, 0x01,
...
var (
	file_dataplane_proto_counter_proto_rawDescOnce sync.Once
	file_dataplane_proto_counter_proto_rawDescData = file_dataplane_proto_counter_proto_rawDesc
)

func file_dataplane_proto_counter_proto_rawDescGZIP() []byte {
	file_dataplane_proto_counter_proto_rawDescOnce.Do(func() {
		file_dataplane_proto_counter_proto_rawDescData = protoimpl.X.CompressGZIP(file_dataplane_proto_counter_proto_rawDescData)
	})
	return file_dataplane_proto_counter_proto_rawDescData
}

var file_dataplane_proto_counter_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dataplane_proto_counter_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_dataplane_proto_counter_proto_goTypes = []interface{}{
...
var file_dataplane_proto_counter_proto_depIdxs = []int32{
...
func init() { file_dataplane_proto_counter_proto_init() }
func file_dataplane_proto_counter_proto_init() {
	if File_dataplane_proto_counter_proto != nil {
		return
	}
	file_dataplane_proto_common_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_dataplane_proto_counter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dataplane_proto_counter_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_dataplane_proto_counter_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_dataplane_proto_counter_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_dataplane_proto_counter_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_dataplane_proto_counter_proto_goTypes,
		DependencyIndexes: file_dataplane_proto_counter_proto_depIdxs,
		EnumInfos:         file_dataplane_proto_counter_proto_enumTypes,
		MessageInfos:      file_dataplane_proto_counter_proto_msgTypes,
	}.Build()
	File_dataplane_proto_counter_proto = out.File
	file_dataplane_proto_counter_proto_rawDesc = nil
	file_dataplane_proto_counter_proto_goTypes = nil
	file_dataplane_proto_counter_proto_depIdxs = nil
}
...
var _Counter_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "dataplane/proto/counter.proto",
}
