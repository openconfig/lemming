	...
	tests := []packettestutil.PacketFieldTest{
		// TCP over IP4.
		{
			...
			Final: [][]byte{
				ethernetIP4,
				ip4tcp,
				{0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x51, 0x21, 0x00, 0x20, 0x5a, 0x42, 0x00, 0x00, 0x0a, 0x0b, 0x0c, 0x0d},
			},
		},
		// TCP over IP6.
		{
			...
			Final: [][]byte{
				ethernetIP6,
				ip6tcp,
				{0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x51, 0x21, 0x00, 0x20, 0x2c, 0x18, 0x00, 0x00, 0x0a, 0x0b, 0x0c, 0x0d},
			},
		},
	}
